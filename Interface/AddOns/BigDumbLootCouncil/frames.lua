...
function bdlc:fetchUserGear(unit, itemLink)
	...
	local isRelic = subclass == "Artifact Relic" and true or false
...
for i = 1, 10 do
	...
	roll.buttons.submit = function(wantLevel)
		...
		if (string.len(notes) > 0) then
			SendAddonMessage(bdlc.message_prefix, "addUserNotes><"..itemUID.."><"..bdlc.local_player.."><"..notes, bdlc.sendTo, UnitName("player"));
		end
