...
function bdlc:startSession(itemLink,num)
	...
	local itemType, itemID, enchant, gem1, gem2, gem3, gem4, suffixID, uniqueID, level, upgradeId, instanceDifficultyID, numBonusIDs, bonusID1, bonusID2, upgradeValue, un1, un2, un3  = string.split(":", itemString)
	...
	local itemUID = itemID..":"..gem1..":"..bonusID1..":"..bonusID2
	...
	if (GetItemInfo(itemLink)) then
		...
		local isRelic = select(7, GetItemInfo(itemLink)) == "Artifact Relic" and true or false
		...
		if (not bdlc.loot_sessions[itemLink] and ((equipSlot and string.len(equipSlot) > 0) or found_tier or isRelic)) then
