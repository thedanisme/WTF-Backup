...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "Netherwing (Neutral-Honored Daily)", "Netherwing (Revered-Exalted Daily)", "Alliance", nil, "D", nil, function()
return [[
