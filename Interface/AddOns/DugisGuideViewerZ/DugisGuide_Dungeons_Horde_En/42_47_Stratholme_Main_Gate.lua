local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Horde_En_42_47_Stratholme_Main_Gate")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Azeroth|r ", "765(42-47 Main Gate)", "686(44-49)", "Horde", nil, "I", nil, function()
return [[

A Annals of the Silver Hand |N|(npc:49856) (76.1, 51)| |QID|28755| |O| |Z|23| |NPC|49856|
R Stratholme Main Gate |N|Queue/Zone into {Stratholme} {Main Gate} in {Eastern Plaguelands} (66.29, 86.75)| |I| |Z|765 1| |F|765 1|
