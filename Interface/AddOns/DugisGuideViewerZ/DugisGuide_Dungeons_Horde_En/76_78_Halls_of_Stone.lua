local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Horde_En_76_78_Halls_of_Stone")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Northrend|r ", "526(76-78)", "525(77-80)", "Horde", nil, "I", nil, function()
return [[

R Halls of Stone Instance |N|Queue for {Halls of Stone} with your dungeon finder or enter the instance from {The Storm Peaks} (35.70, 35.05)| |QID|13207| |I| |Z|526| |F|526|
