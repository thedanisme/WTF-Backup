...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "725(59-63)", "728(62-65)", "Horde", nil, "I", nil, function()
return [[

R The Blood Furnace |N|Use the dungeon finder to queue for {The Blood Furnace} or enter the instance from {Hellfire Peninsula} (51.32, 90.04)| |I| |Z|725| |F|725|
