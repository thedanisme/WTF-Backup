...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Azeroth|r ", "704(47-52 Detention Block)", "687(50-54)", "Horde", nil, "I", nil, function()
return [[

R Blackrock Depths Detention Block |N|Queue/Zone into {Blackrock Depths} {Detention Block} in {Searing Gorge} (36, 77.4)| |I| |QID|27581| |F|704 1| |WR|
