...
function GA:Initialize()
    ...
    if Storyline_NPCFrameRewardsItem then
		...
		local scoring = {
	        ...
	        ["WARRIOR:3"] =               "ARMOR_SPECIALIZATION_STAT,STA:LE_ITEM_CLASS_WEAPON,0,4,7,13,15:LE_ITEM_CLASS_ARMOR,0,1,2,3,4,6:XP_BONUS,1000:DPS,0.46:STA,1.13:MASTERY_RATING,2.45:STR,4.25:AVOIDANCE_RATING,0.83:ARMOR,4.73:MELEE_HASTE_RATING,0.80:MELEE_CRIT_RATING,0.78:AP,0.1:LEECH_RATING,2.01:VERSATILITY_RATING,3.29:AGI,0:INT,0:SPELL_DMG,0",
