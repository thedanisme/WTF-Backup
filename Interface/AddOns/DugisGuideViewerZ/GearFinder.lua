...
function DGF:GetItemInfoById(itemId)
    ...
    if DGF.itemsCache[itemlink] then
   ...
   -- DGF:Print(reqlevelByQuest)
    ...
    DGF.itemsCache[itemlink] = item

    return item
end


function DGF:GetAllOwnedItems(onlyBelowPlayerLevel, yields)
    local result = {}
...
local function UpdateDynamicDataForGearFinder()
    ...
    LuaUtils:CreateThread("UpdateDynamicDataForGearFinder", function()
        ...
        local allOwnedItems_ = DGF:GetAllOwnedItems(nil, 500)
    ...
    LuaUtils:CreateThread("WaitForCacheItemsForGearFinderEnd", function()
        ...
        LuaUtils:CreateThread("CacheItemsForGearFinder", function()
            ...
            while #allGearIds ~= 0 do
                i = i + 1
                if math.fmod(#allGearIds, 10) == 0 then
                    coroutine.yield()
                end
