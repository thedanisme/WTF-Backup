...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r ", "28(46-49)#28(47-51)#28(48-52)", "29(49-51)#29(50-53)#29(51-54)", "Alliance", nil, "L", nil, function()
return [[

R Dragon's Mouth |N|Travel to {Dragon's Mouth} (20.78, 55.77)| |QID|28512| |Z|17|
N Abandon (qid:28582) |N|Abandon (qid:28582) to accept (qid:28512)| |O| |QID|28582| |OID|28512|
A To the Aid of the Thorium Brotherhood |QID|28512| |N|(npc:46930) (20.78, 55.77) in {Dragon's Mouth}| |Z|17| |NPC|46930|
...
A Lunk's Adventure: Spider Rider |QID|27959| |N|Kill the spiders and (npc:47269) will appear in {The Sea of Cinders} (55.62, 60.89)| |NPC|5856, 47269|
N As you go... |AYG|27959| |N|Keep a look out for 8 (item:62934) in {The Sea of Cinders}| |QID|27961|
...
T Lunk's Adventure: Spider Rider |QID|27959| |N|(npc:47269) in {The Sea of Cinders} (59.79, 67.84)|
...
C Out of Place |QID|27961| |N|Collect 8 (item:62934) in {Searing Gorge} (61.77, 66.86) (59.39, 58.43)|
...
C Dig-Boss Dinwhisker |QID|27964| |N|Kill (npc:47276) and (npc:47275) within {The Cauldron} until (npc:47271) appears. Kill him and collect his (item:62806) (66.85, 42.76) (65.32, 37.81) (62.81, 38.79) (53.46, 44.91)| |NPC|47276, 47275, 47271|
...
f Thorium Point |N|Grab the flight path for {Thorium Point} from (npc:2941) (37.8, 30.6)| |QID|27983| |NPC|2941| |PL|47|
...
A Lunk's Adventure: Cranky Little Dwarfs |QID|27983| |N|Kill the Dwarves and (npc:47332) will appear (37.63, 39.50)| |NPC|5840, 47332|
C Recon Essentials |QID|27977| |N|Collect a (item:18959) and (item:18960). They randomly drop from (npc:5840) in {Pyrox Flats} (43.79, 52.36) (40.18, 49.17) (43.79, 52.36)| |NPC|5840|
...
T Lunk's Adventure: Cranky Little Dwarfs |QID|27983| |N|Field Turn-In| |U|62826|
...
K Minister Finister |N|Kill (npc:47311) and collect (item:62824) in {Firewatch Ridge} (24.23, 33.21) (24.68, 26.22)| |L|62824| |QID|27979| |NPC|47311|
...
T Prayer to Elune |QID|27985| |N|Field Turn-In|
K Minister Letherio |N|Kill (npc:47310) and collect (item:62823) inside the cave in {Firewatch Ridge} (22.53, 36.53) (15, 35.8)| |L|62823| |QID|27979| |NPC|47310|
K Minister Kiyuubi |N|Kill (npc:47309) and collect (item:62825) inside the cave in {Firewatch Ridge} (17.77, 42.58)| |L|62825| |QID|27979| |NPC|47309|
...
f Iron Summit |N|Grab the flight path for {Iron Summit} from (npc:47927) (41.09, 68.75)| |QID|28028| |NPC|47927| |PL|47|
...
h Iron Summit |N|Speak to (npc:47942) and set your hearth to {Iron Summit} (39.86, 66.04)| |QID|28028| |NPC|47942|

N As you go... |AYG|28029| |N|<b>Kill (npc:9318) for 6 (item:62914) for (qid:28032)<br/><b>Kill 9 Dark Iron Marksmen for (qid:28028)<br/><b>Collect 200 (item:62916) also found in crates around the tower for (qid:28030)| |QID|28030| |NPC|9318, 8338| |OBJ|1868|
N Set Southwestern Tower Ablaze! |QID|28029.2| |N|Use the (item:10515) on the brazier atop the Southwestern tower in {The Cauldron} (35.67, 60.63)| |U|10515| |OBJ|524|
N Set Western Tower Ablaze! |QID|28029.1| |N|Use the (item:10515) on the brazier atop the Western tower in {The Cauldron} (32.17, 55.52) (33.35, 54.48)| |U|10515| |OBJ|524|
N Set Southeastern Tower Ablaze! |QID|28029.3| |N|Use the (item:10515) on the brazier atop the Southeastern tower in {The Cauldron} (32.17, 55.52)(43.98, 60.93)| |U|10515| |OBJ|524|
N Set Eastern Tower Ablaze! |QID|28029.4| |N|Use the (item:10515) on the brazier atop the Eastern tower in {The Cauldron} (52.46, 57.94) (51.26, 55.39) (49.99, 54.79)| |U|10515| |OBJ|524|
R The Cauldron |QID|28029| |N|Travel to {The Cauldron} (52.46, 57.94)|
C They Build a Better Bullet |QID|28030| |N|Collect 200 (item:62916) in {The Sea of Cinders}. Find the crates filled with them. They also drop from (npc:8338) and (npc:8566), but will only drop one at a time (50.61, 69.60)| |OBJ|1868| |NPC|8338, 8566|
...
F The Cauldron |N|Fly to {The Cauldron}, talk to (npc:2941) for free flight (37.8, 30.6)| |QID|28052| |NPC|2941| |V|
C Operation: Stir the Cauldron |QID|28052| |N|When you are near the landing point use the guns to kill (npc:47470) until the area is safe for entry to {The Cauldron} (41.44, 55.72)| |NPC|47470|
...
N As you go... |AYG|28056| |N|Speak to 12 (npc:5843) to free them for (qid:28055). If they resist, kill them.| |QID|28055| |NPC|5843|
...
R The Slag Pit |QID|28056| |N|Travel to {The Slag Pit} (38.15, 49.48)|
...
T Minions of Calcinder |QID|28061| |N|Field Turn-In|
T From Whence He Came |QID|28062| |N|Field Turn-In|
A Welcome to the Brotherhood |QID|28064| |N|Auto Quest|

H Iron Summit |N|Hearth to {Iron Summit} (39.86, 66.04)| |QID|28064| |U|6948|
...
N Guide Complete |N|Tick to continue to (guide:"29(49-51)#29(50-53)#29(51-54)")|
