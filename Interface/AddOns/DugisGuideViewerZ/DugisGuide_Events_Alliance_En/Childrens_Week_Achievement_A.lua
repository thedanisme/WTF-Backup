...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Children's Week|r ", "Children's Week (80+ Achievement)", nil, "Alliance", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_ChildrensWeek]])|", function()
return [[

R Stormwind City |N|Travel to {Stormwind City} (56.3, 54.0)| |Z|301|
N (item:18598) |T| |N|Collect 1 Human Orphan Whistle from (npc:14450) (56.3, 54.0)| |L|18598| |Z|301| |NPC|14450|

B (item:7228) |N|Buy (item:7228) from (npc:14481) (61.3, 75.0) for achievement| |L|7228| |AID|1788| |Z|301| |NPC|14481|

B (item:43490) |N|Purchase the follow items from the Auction House, or use your Cooking ability to create them| |L|43490| |AID|1788| |Z|301|
B (item:33924) |N|Purchase the follow items from the Auction House, or use your Cooking ability to create them| |L|33924| |AID|1788| |Z|301|
...
U (item:18598) |T| |N|Use (item:18598) make sure your orphan is standing next to you before you begin eating| |U|18598|
...
N Hail To The King, Baby |N|You should be able to do this solo at level 85, Go to {Utgarde Pinnacle} dungeon in {Howling Fjord}, and defeat (npc:26861) (40.8, 53.6), Make sure your Orphan is standing next to you when you defeat (npc:26861), or else you won't get credit for the achievement.| |AID|1790| |Z|524 2| |NPC|26861|
