...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Quests|r ", "Veteran of the Molten Front (85+)", nil, "Horde", nil, "A", nil, function()
return [[
...
N Death From Above |N|Bomb one of the named Firelords during the Fire in the Skies daily. You just need to bomb the mob, not kill it. The Firelords are random.| |AID|5879| |AC|13| |QID|29290| |O|
