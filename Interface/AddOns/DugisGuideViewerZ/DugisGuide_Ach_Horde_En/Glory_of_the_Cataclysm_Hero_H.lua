local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Ach_Horde_En_Glory_of_the_Cataclysm_Hero_H")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Dungeons & Raids|r ", "Glory of the Cataclysm Hero (85+)", nil, "Horde", nil, "A", nil, function()
return [[
