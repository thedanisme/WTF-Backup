local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Ach_Horde_En_Glory_of_the_Dragon_Soul_Raider_H")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Dungeons & Raids|r ", "Glory of the Dragon Soul Raider (85+)", nil, "Horde", nil, "A", nil, function()
return [[
