...
N (fac:1681) QuarterMaster |N|(npc:85115) (47.0,21.4) in {Warspear}| |NPC|85115| |Z|1011| --Dazzerian

N Guide Complete
]]
end, {description = [[This guide covers the requirements to earn Exalted with (fac:1681) <br/><br/>Exalted status gives access to (item:116775) <br/><br/>(fac:1681) involves completing quests and completing PvP objectives on (map:978).]]})
	end
