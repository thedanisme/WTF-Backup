...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "261(54-58)#261(55-59)#261(55-60)", "465(58-60)#465(59-62)#465(60-64)", "Alliance", nil, "L", nil, function()
return [[
...
f Cenarion Hold |QID| |N|Grab {Cenarion Hold} flight path (54.39, 32.72)| |NPC|15177| |PL|55|
...
C Vyral the Vile |QID|8321| |N|Kill (npc:15202) in the cave and collect (item:20466) (58.6, 81.81) {Twilight's Run}| |NPC|15202| |Z|261 13|
...
A Scouring the Desert |QID|9419| |N|(npc:17080) (39.56, 46.85) in {Hive'Zora}| |NPC|17080|
...
C Scouring the Desert |QID|9419| |N|Find a little geyser marked "Silithyst Geyser" found around the desert. Then take it back to camp and put it into the extractor machine (39.07, 46.91), it can be found anywhere in {Silithus} but try to find them close to the camp as you can't mount when you pick them up| |OBJ|6862|
T Scouring the Desert |QID|9419| |N|(npc:17080) (39.57, 46.90) in {Hive'Zora}| |NPC|17080|

R Blasted Lands |N|Take the portal here to {Blasted Lands} (53.56, 33.28)| |WR|
T Nethergarde Needs You! |QID|28867| |N|(npc:5393) (60.09, 13.51) in {Cenarion Hold}| |Z|19| |NPC|5393|
