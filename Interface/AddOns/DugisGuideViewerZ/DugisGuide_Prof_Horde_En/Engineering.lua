local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Horde_En_Engineering")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Leveling|r", "Engineering 1-600", nil, "Horde", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Engineering]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Trainers |N|The trainers listed are the ones in {Orgrimmar}. Obviously you can use others as you see fit.| |P|Engineering 2|
...
B (item:5956) [ENG] |N|(npc:3413) {Engineering Supplies} (56.9, 56.5)| |Z|321| |L|5956| |P|Engineering 31| |NPC|3413|
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|225| 
...
R Tanaris |N|Travel to {Tanaris} (50.7, 28.5)| |Z|161| |P|Engineering 210|
B (item:18650) |ENG| |N|(npc:8131) (50.7, 28.5)| |L|18650| |Z|161| |P|Engineering 210| |NPC|8131|
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|300| 
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|375| 
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|450| 
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|525| 
...
R Orgrimmar |N|Travel to {Orgrimmar} (76.4, 34.6)| |Z|321| |PM|Engineering|600| 
N Train Zen Master Engineering |N|(npc:11017) (56.9, 56.5)| |Z|321| |PM|Engineering|600| |NPC|11017|
