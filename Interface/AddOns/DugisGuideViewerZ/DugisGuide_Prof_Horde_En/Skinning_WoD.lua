local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Horde_En_Skinning_WoD")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Warlords Leveling|r", "Warlords Skinning 1-700", nil, "Horde", nil, "P", nil, function()
return [[
