local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Horde_En_First_Aid_WoD")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Warlords Leveling|r", "Warlords First Aid 1-700", nil, "Horde", nil, "P", nil, function()
return [[
...
N 600-700 (item:109223) |FA| |N|Create (item:109223) with; <br/><b>10 (item:109142)| |P|First Aid 700|
