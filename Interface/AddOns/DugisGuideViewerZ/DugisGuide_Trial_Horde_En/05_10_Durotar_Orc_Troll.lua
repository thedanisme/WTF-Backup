...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "4(4-9 Orc & Troll)#4(5-11 Orc & Troll)#4(5-12 Orc & Troll)", "11(9-20)#11(10-21)#11(11-22)", "Horde", nil, "L", nil, function()
return [[
...
T Ride to Orgrimmar |QID|6384| |N|Use the elevator to go down at the waypoint (51.17, 63.05) and then bring (item:16306) to (npc:6929) (53.57, 78.80)| |Z|321| |NPC|6929| |R|Orc, Tauren, Troll|
A Doras the Wind Rider Master |QID|6385| |N|(npc:6929) (53.57, 78.80) in {Orgrimmar}'s {Valley of Strength}| |Z|321| |NPC|6929| |R|Orc, Tauren, Troll|
T Doras the Wind Rider Master |QID|6385| |N|Go up to the elevator (51.18, 63.12) and speak to (npc:3310) (49.63, 59.20) in {Orgrimmar}| |Z|321| |NPC|3310| |R|Orc, Tauren, Troll|
A Return to Razor Hill |QID|6386| |N|(npc:3310) (49.63, 59.20) in {Orgrimmar}'s {Valley of Strength}| |Z|321| |NPC|3310| |R|Orc, Tauren, Troll|
...
K Lieutenant Palliter |QID|25173.3| |N|Kill (npc:39269). He's at the top floor of the fort (52.7, 52.8)| |NPC|39269| |Z|4 11|
C Exploiting the Situation |QID|25176| |N|Collect 6 pieces of (item:52558) found inside the lockboxes (52.1, 48.7)| |OBJ|5743| |Z|4 10|
R Razor Hill |QID|25176| |N|Travel to {Razor Hill} (58.7, 58.3)|
C From Bad to Worse |QID|25173| |N|Kill 6 (npc:39268) and 6 (npc:39267) (58.0,56.3)| |NPC|39267, 39268| |Z|4 11|
...
C The Burning Blade |QID|25232.1| |N|Collect 6 (item:52564) from members of the Burning Blade from inside {Dustwind Cave} (50.4, 57.7)| |NPC|3196, 3199, 3195| |Z|4 19|
...
R Orgrimmar |QID|25263| |N|Travel to {Orgrimmar}'s {Valley of Strength} (52.30, 86.04)| |Z|321|
T Arnak Fireblade |QID|25263| |N|Enter the {Cleft of Shadow}s and find (npc:3216) (58.34, 58.71)| |Z|321 2| |NPC|3216|
A Ak'Zeloth |QID|25264| |N|(npc:3216) in {Cleft of Shadow} (58.34, 58.71)| |Z|321 2| |NPC|3216|
