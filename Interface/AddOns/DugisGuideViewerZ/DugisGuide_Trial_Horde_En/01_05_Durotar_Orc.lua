...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "4(1-4 Orc)#4(1-6 Orc)#4(1-7 Orc)", "4(4-9 Orc & Troll)#4(5-11 Orc & Troll)#4(5-12 Orc & Troll)", "Horde", nil, "L", nil, function()
return [[
...
R Burning Blade Coven |N|Travel to {Burning Blade Coven} (45.35, 56.27)|
C Thazz'ril's Pick |QID|25135| |N|Find (item:16332) inside the cave on top of the waterfall (40.76, 52.52)| |OBJ|4992| |Z|4 8|
K (npc:3183) |QID|25132.2| |N|Kill (npc:3183) and Felstalkers inside the cave and collect the (item:4859) (13.35, 44.82)| |NPC|3183| |Z|4 8|
C Burning Blade Medallion |QID|25132| |N|Kill 7 (npc:3102) in {Burning Blade Coven} (42.85, 52.34)| |NPC|3102| |Z|4 8|
...
N Guide Complete |N|Tick to continue to continue to (guide:"4(4-9 Orc & Troll)#4(5-11 Orc & Troll)#4(5-12 Orc & Troll)")| 
