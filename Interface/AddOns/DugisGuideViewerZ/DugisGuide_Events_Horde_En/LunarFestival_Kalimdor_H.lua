local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Events_Horde_En_LunarFestival_Kalimdor_H")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Lunar Festival|r ", "The Lunar Festival: Elders of Kalimdor (60+)", nil, "Horde", nil, "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_LunarFestival]])|", function() 
return [[
...
R Mount Hyjal |N|Travel to {Mount Hyjal} (62.5, 22.8)| |Z|606|
