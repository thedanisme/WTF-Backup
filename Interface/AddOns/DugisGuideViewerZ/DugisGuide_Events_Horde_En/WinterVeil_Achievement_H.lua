...
N 10 (item:34191) |T| |N|Kiss a Winter Reveler (54.5, 77.8) every hour by targeting them and type /kiss, You can only use this once per hour and the items you get are random.| |L|34191 10| |Z|321|
N 3 (item:21519) |T| |N|Kiss a Winter Reveler (54.5, 77.8) every hour by targeting them and type /kiss, You can only use this once per hour and the items you get are random.| |L|21519 3| |Z|321|
N (item:21213) |T| |N|Kiss a Winter Reveler (54.5, 77.8) every hour by targeting them and type /kiss, You can only use this once per hour and the items you get are random.| |L|21213| |Z|321|
...
N (item:34087) |T| |N|Use the Tailoring profession or buy from the Auction House a (item:34087) You can get the recipe for these items from Penney Copperpinch (52.5, 76.8)| |L|34087| |AID|277| |Z|321|
N (item:34086) |T| |N|Use the Leatherworking profession or buy from the Auction House a (item:34086) You can get the recipe for these items from Penney Copperpinch (52.5, 76.8)| |L|34086| |AID|277| |Z|321|
...
N Brother Malach |N|Use your (item:21519) on (npc:5661) (50.8, 21.7)| |U|21519| |AID|1685| |AC|1| |NPC|5661| |Z|382|
...
N (item:17198) |CO| |N|Use the Cooking profession to create (item:17198), You can get the recipe for these items from Penney Copperpinch (52.5, 76.8)| |AID|1688| |AC|2| |Z|321|
N (item:34411) |CO| |N|Use the Cooking profession to create (item:34411), You can get the recipe for these items from Penney Copperpinch (52.5, 76.8)| |AID|1688| |AC|3| |Z|321|
