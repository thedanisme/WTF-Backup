local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Ach_Alliance_En_Glory_of_the_Raider_10_A")
function Guide:Initialize()
 function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Dungeons & Raids|r ", "Glory of the Raider 10 (80+)", nil, "Alliance", nil, "A", nil, function()
return [[
