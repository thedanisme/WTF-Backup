local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Ach_Horde_En_Ravenholdt_A")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Classic Reputation|r ", "Ravenholdt (60+)", nil, "Alliance", nil, "A", nil, function()
return [[
