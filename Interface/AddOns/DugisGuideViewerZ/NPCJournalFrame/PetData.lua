...
|PID|49590| |SID|283| |GUIDE|Sold by (npc:46602) (64.6, 76.8, 301, "Shay Pressler") in (map:301), 500<g>.<br/><br/>Must be Honored with your guild and the guild must have the achievement (aid:5201).<br/><br/><horde> version.| |NAME|Guild Herald| |FAC|Horde|
|PID|49587| |SID|282| |GUIDE|Sold by (npc:46572) (48.2, 75.6, 321, "Goram") in (map:321), 300<g>.<br/><br/>Must be Friendly with your guild and the guild must have the achievement (aid:5031).<br/><br/><alliance> version.| |NAME|Guild Herald| |FAC|Alliance|
|PID|49588| |SID|281| |GUIDE|Sold by (npc:46602) (64.6, 76.8, 301, "Shay Pressler") in (map:301), 300<g>.<br/><br/>Must be Friendly with your guild and the guild must have the achievement (aid:5031).<br/><br/><horde> version.| |NAME|Guild Page| |FAC|Horde|
|PID|49586| |SID|280| |GUIDE|Sold by (npc:46572) (48.2, 75.6, 321, "Goram ") in (map:321), 500<g>.<br/><br/>Must be Honored with your guild and the guild must have the achievement (aid:5201).<br/><br/><alliance> version.| |NAME|Guild Page| |FAC|Alliance|
