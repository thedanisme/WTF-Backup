local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dailies_Horde_En_Sholazar_Basin_Pre")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Northrend|r ", "Frenzyheart / The Oracles (Pre-Quest)", nil, "Horde", nil, "D", nil, function()
return [[
