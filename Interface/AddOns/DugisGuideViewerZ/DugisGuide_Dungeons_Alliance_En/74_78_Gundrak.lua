local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Alliance_En_74_78_Gundrak")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Northrend|r ", "530(74-78)", "536(75-77)", "Alliance", nil, "I", nil, function()
return [[

R Gundrak Instance |N|Queue for {Gundrak} with your dungeon finder or enter the instance in {Zul'Drak} (57.34, 34.49)| |Z|530| |I| |F|530| |WR|
