local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Alliance_En_68_70_Shadow_Labyrinth")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "724(68-70)", nil, "Alliance", nil, "I", nil, function()
return [[

R Shadow Labyrinth |N|Queue for {Shadow Labyrinth} using the dungeon finder or enter the instance from {Terokkar Forest} (22.62, 12.45)| |I| |Z|724| |F|724|
