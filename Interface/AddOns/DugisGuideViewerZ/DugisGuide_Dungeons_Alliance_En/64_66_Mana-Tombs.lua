...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "732(64-66)", "722(64-67)", "Alliance", nil, "I", nil, function()
return [[

R Mana-Tombs |N|Queue for {Mana-Tombs} using the dungeon finder or enter the instance from {Terokkar Forest} (34.29, 19.49)| |I| |Z|732| |F|732|
