...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "726(63-65)", "732(64-66)", "Alliance", nil, "I", nil, function()
return [[

R Underbog |N|Queue for Underbog with your Dungeon Finder or enter from {Coilfang Reservoir} in {Zangarmarsh}. You need to swim down and through the Reservoir to reach the entrance (30.84, 65.26)| |I| |Z|726| |F|726|
