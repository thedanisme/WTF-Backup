...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "797(59-62)", "725(59-63)", "Alliance", nil, "I", nil, function()
return [[

R Hellfire Ramparts |N|Use your dungeon finder to queue for {Hellfire Ramparts} or enter the instance from {Hellfire Peninsula} (48.51, 68.18)| |I| |Z|797| |F|797|
