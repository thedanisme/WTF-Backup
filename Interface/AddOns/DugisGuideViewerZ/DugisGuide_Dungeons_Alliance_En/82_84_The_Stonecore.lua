local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Alliance_En_82_84_The_Stonecore")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Cataclysm|r ", "768(82-84)", nil, "Alliance", nil, "I", nil, function()
return [[

R The Stonecore |N|Queue/Zone into {The Stonecore} (53.8, 94.6)| |I| |F|768| |Z|768| |F|768|
