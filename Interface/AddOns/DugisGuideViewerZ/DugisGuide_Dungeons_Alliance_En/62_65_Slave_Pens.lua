local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Alliance_En_62_65_Slave_Pens")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Outland|r ", "728(62-65)", "726(63-65)", "Alliance", nil, "I", nil, function()
return [[

R The Slave Pens |N|Use your dungeon finder to queue for Steamvault or enter from {Coilfang Reservoir} in {Zangarmarsh}. You need to swim down and through the Reservoir to reach the entrance (18.84, 11.34| |I| |Z|728| |F|728|
