...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Cataclysm|r ", "757(85)", nil, "Alliance", nil, "I", nil, function()
return [[

R Grim Batol |N|Queue/Zone into {Grim Batol} (19.6, 53.2)| |I| |QID|28854| |F|757|
