local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Dungeons_Alliance_En_30_35_Razorfen_Kraul")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Azeroth|r ", "761(30-35)", "750(32-36 Foulspore Cavern)", "Alliance", nil, "I", nil, function()
return [[

R Razorfen Kraul Instance |N|Queue/Zone into {Razorfen Kraul} in {Northern Barrens} (40.80, 94.49)| |I| |QID|26903| |Z|761 1| |F|761| |WR|
