...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Azeroth|r ", "749(17-20)", "764(16-21)", "Alliance", nil, "I", nil, function()
return [[

R Wailing Caverns |N|Queue/Zone into {The Wailing Caverns} in {Southern Barrens} (46.5, 58.8)| |I| |QID|26874| |WR| |F|749|
