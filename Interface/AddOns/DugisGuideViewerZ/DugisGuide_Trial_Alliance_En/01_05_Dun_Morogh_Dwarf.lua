...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Starting Zones|r ", "27(1-5 Dwarf)#27(1-6 Dwarf)#27(1-7 Dwarf)", "27(5-10 Dwarf & Gnome)#27(5-11 Dwarf & Gnome)#27(5-12 Dwarf & Gnome)", "Alliance", nil, "L", nil, function()
return [[
...
C Make Hay While the Sun Shines |QID|24486.1| |N|Get 5 (item:49751) from (npc:37105) found around in {Coldridge Valley} (33.19, 70.68)| |NPC|37105|
...
K Wayward Fire Elemental |QID|218.2| |N|Kill the (npc:37112) inside the cave in {Frostmane Hovel} (66.7, 29.2)| |NPC|37112| |Z|866 9|
K Grik'nir the Cold |QID|218.1| |N|Kill (npc:808) inside the cave in {Frostmane Hovel} (76.1, 30.8)| |NPC|808| |Z|866 9|
C Ice and Fire |QID|218| |N|Kill 6 (npc:37507) and 3 (npc:946) inside the cave in {Frostmane Hovel} (76.1, 30.8)| |NPC|37507, 946| |Z|866 9|
