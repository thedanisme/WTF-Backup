...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r ", "39(9-14)#39(10-16)#39(11-17)", "36(14-20)#36(15-21)#36(15-22)", "Alliance", nil, "L", nil, function()
return [[

R City of Ironforge |QID|26378| |N|Travel to {City of Ironforge} (76.4, 51.2)| |Z|341| |R|Dwarf, Gnome| |PL|15|
R Deeprun Tram |QID|26378| |N|Travel to {Deeprun Tram} (76.4, 51.2)| |Z|341| |R|Dwarf, Gnome| |PL|15|
...
K Murlocs |QID|26353| |N|Kill (npc:515) in {Longshore} until you find (item:1357) to begin a new quest (56.82, 10.44)| |L|1357| |NPC|515|
...
C Livin' the Life |QID|26228.1| |N|Use (item:57761) at the back of the {Jangolode Mine} (64.8, 28.0)| |U|57761| |Z|39 5|
...
N Collect 6 (item:57788) |QID|26241.2| |N|Collect 6 (item:57788) from (npc:157) around {Saldean's Farm} (55.70, 27.61)| |NPC|157|
N Collect 6 (item:57786) |QID|26241.3| |N|Collect 6 (item:57786) from (npc:1109) in {The Molsen Farm} (48.58, 30.98)| |NPC|1109|
...
C A Vision of the Past |QID|26320| |N|Enter the {Defias Hideout} and follow the trail of homeless to the {Deadmines} dungeon. Use the (item:58147) inside the dungeon near the entrance to see into the past. {The Deadmines} (26.0, 51.1)| |U|58147| |Z|39 17|
...
N Guide Complete |N|Tick to continue to (guide:"36(14-20)#36(15-21)#36(15-22)")|
