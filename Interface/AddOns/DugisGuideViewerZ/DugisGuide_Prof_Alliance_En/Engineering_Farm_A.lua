...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Leveling With Farming|r", "Engineering w/Farming 1-600", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Engineering]], nil, 600, [[Mining]])|", function()
return [[
...
N Train Apprentice Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|75| |NPC|5518|
B (item:5956) |N|(npc:5519) {Engineering Supplies} (63.4, 31.4)| |Z|301| |L|5956| |P|Engineering 31| |NPC|5519|
B 2 (item:4399) |N|(npc:5519) {Engineering Supplies} (63.2, 31.8)| |L|4399 2| |Z|301| |P|Engineering 75| |NPC|5519|
...
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 20 (item:2835)<br/><b>160 (item:2770) (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2835 20| |Z|30| |P|Engineering 75| |OBJ|310|
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 20 (item:2835)<br/><b>160 (item:2770) (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2770 160| |Z|30| |P|Engineering 75| |OBJ|310|
N Farm (item:2589) |ENG| |N|Kill (npc:94) mobs (38.0, 58.6)(43.8, 55.2) for 30 (item:2589)| |L|2589 30| |Z|30| |P|Engineering 95| |NPC|94|

R Stormwind City |N|Travel to {Stormwind City} (63, 71)| |Z|301| |P|Engineering 51|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2770) into bars. Tick this step.| |Z|301| |P|Engineering 100|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 75| |NPC|5518|
...
N Train Journeyman Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|150| |NPC|5518|
...
B 4x(item:3857) |N|(npc:5512) {Blacksmithing Supplies} (63.2, 37.6)| |L|3857 4| |Z|301| |P|Engineering 176| |NPC|5512|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2771) into bars. Tick this step.| |Z|301| |P|Engineering 160|
N Create 138 (item:2841) |ENG| |N|<b>69 (item:2840)<br/><b>69 (item:3576)<br/><b>Use the forge (63.7, 37.0)| |L|2841 138| |Z|301| |P|Engineering 150|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2772) into bars. Tick this step.| |Z|301| |P|Engineering 176|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:2776) into bars. Tick this step.| |Z|301| |P|Engineering 175|
N Smelt (item:3859) |SM| |N|Go to a forge (63.7, 37.0) and smelt (item:3859). Tick this step.| |L|3859 4| |Z|301| |P|Engineering 176|
...
N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 200| |NPC|5518|
...
N Train Expert Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|225| |NPC|5518|
...
N Farm 50 (item:4338) |ENG| |N|Kill {Jaedenar} (39, 57), Jadefire (38, 67), and/or Deadwood (49, 86) Mobs for 50 (item:4338)| |L|4338 50| |Z|182| |P|Engineering 250|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:3858) into bars. Tick this step.| |Z|301| |P|Engineering 250|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:10620) into bars. Tick this step.| |Z|301| |P|Engineering 300|
...
N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 300| |NPC|5518|
...
N Train Artisan Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|300| |NPC|5518|
...
N Train Master Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|375| |NPC|5518|
B 5 (item:4400) |N|(npc:5519) (63.2, 31.8)| |L|4400 5| |P|Engineering 325| |NPC|5519|
...
N Smelt Ore |SM| |N|Go to a forge (56.8, 63.8) and smelt all the (item:23424) into bars. Tick this step.| |Z|465| |P|Engineering 350|

N Train New Recipes.. |N|as needed from (npc:18775) (55.7, 65.5), in {Honor Hold}. Tick this step.| |Z|465| |P|Engineering 350| |NPC|18775|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:23425) into bars. Tick this step.| |Z|301| |P|Engineering 350|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 350| |NPC|5518|
...
N Train Grand Master Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|450| |NPC|5518|

R Zul'Drak |N|Travel to {Zul'Drak} (12.6, 68.3)| |Z|496| |P|Engineering 425|

N Farm Zul'Drak |MI| |LOOP| |N|Farm 320 (item:36909)<br/><b>10 (item:37701)<br/><b>keep all (item:37705) (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|37701 10| |Z|496| |P|Engineering 425| |OBJ|7881|
N Farm Zul'Drak |MI| |LOOP| |N|Farm 320 (item:36909)<br/><b>10 (item:37701)<br/><b>keep all (item:37705) (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|36909 320| |Z|496| |P|Engineering 425| |OBJ|7881|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:36909) into bars. Tick this step.| |Z|301| |P|Engineering 425|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:36912) into bars. Tick this step.| |Z|301| |P|Engineering 425|
B 10 (item:33470) |N|Buy 10 (item:33470) from Auction House or Trade chat.| |L|33470 10| |P|Engineering 425|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 425| |NPC|5518|
...
N Train Illustrious Grand Master Engineering |N|(npc:5518) (62.2, 30.4)| |Z|301| |PM|Engineering|525| |NPC|5518|
...
N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 450| |NPC|5518|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the (item:52185) into bars. Tick this step.| |Z|301| |P|Engineering 500|
N (item:53039) |SM| |N|Go to a forge (63.7, 37.0) and create 5 (item:53039). Tick this step.| |Z|321| |P|Engineering 500|

N Train New Recipes.. |N|as needed from (npc:5518) (62.2, 30.4), in {Stormwind City}. Tick this step.| |Z|301| |P|Engineering 500| |NPC|5518|
...
N Note |N|You will need 100 (item:89112). These are Bind on Pickup and are random drops off all npc's in {Pandaria}. Tick this step.| |P|Engineering 575|
