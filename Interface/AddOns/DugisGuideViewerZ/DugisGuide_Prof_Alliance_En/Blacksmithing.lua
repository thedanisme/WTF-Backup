local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Alliance_En_Blacksmithing")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Leveling|r", "Blacksmithing 1-600", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Blacksmithing]], nil, 600) and UnitLevel([[player]])>=85|", function()
return [[
...
N Trainers |N|The trainers listed are the ones in {Stormwind City}. Obviously you can use others as you see fit.| |P|Blacksmithing 2|

R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|75|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|150|
N Train Journeyman Blacksmithing |N|(npc:5511) (63.7, 37.0), in {Stormwind City}| |Z|301| |PM|Blacksmithing|150| |NPC|5511|

N Materials List 75-150 |N|<b>100 (item:2840)<br/><b>52 (item:2836)<br/><b>245 (item:2841)<br/><b>105 (item:2838)| |P|Blacksmithing 150|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|225|
N Train Expert Blacksmithing |N|(npc:5511) (63.7, 37.0), in {Stormwind City}| |Z|301| |PM|Blacksmithing|225| |NPC|5511|

N Materials List 150-200 |N|<b>5 (item:3577)<br/><b>35 (item:2605)<br/><b>105 (item:2838)<br/><b>230 (item:3575)<br/><b>50 (item:3859)| |P|Blacksmithing 200|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|300|
N Train Artisan Blacksmithing |N|(npc:5511) (63.7, 37.0), in {Stormwind City}| |Z|301| |PM|Blacksmithing|300| |NPC|5511|

N Materials List 200-300 |N|<b>30 (item:2838)<br/><b>25 (item:3859)<br/><b>350 (item:3860)<br/><b>40 (item:12365)<br/><b>170 (item:4338)<br/><b>432 (item:12359)<br/><b>5 (item:7910)| |P|Blacksmithing 300|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|375|
...
R Shadowmoon Valley |BL| |N|Travel to {Shadowmoon Valley} (36.8, 55.1)| |Z|473| |P|Blacksmithing 350|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|450|
...
R Stormwind City |N|Travel to {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Blacksmithing|525|
