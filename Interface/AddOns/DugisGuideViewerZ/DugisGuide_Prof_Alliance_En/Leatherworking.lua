local Guide = DugisGuideViewer:RegisterModule("DugisGuide_Prof_Alliance_En_Leatherworking")
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Leveling|r", "Leatherworking 1-600", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Leatherworking]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Trainers |N|The trainers listed are the ones in {Stormwind City}, {Hellfire Peninsula} and {Dalaran}. Obviously you can use others as you see fit.| |P|Leatherworking 2|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|150|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|225|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|300|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|375|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|450|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|525|
...
R Stormwind City |N|Start in {Stormwind City} (60.4, 75.3)| |Z|301| |PM|Leatherworking|600|
N Train Illustrious Grand Master Leatherworking |N|(npc:5564) (71.7, 63.0)| |Z|301| |PM|Leatherworking|600| |NPC|5564|
