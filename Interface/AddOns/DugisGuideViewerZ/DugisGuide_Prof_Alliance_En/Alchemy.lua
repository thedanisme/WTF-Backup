...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Leveling|r", "Alchemy 1-600", nil, "Alliance", nil, "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Alchemy]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Train Apprentice Alchemy |N|(npc:5499) (55.6, 85.9), in {Stormwind City}| |Z|301| |PM|Alchemy|75| |NPC|5499|
...
N Materials List 60-150 |N|<b>100 (item:2450)<br/><b>30 (item:785)<br/><b>30 (item:2453)<br/><b>10 (item:3820)<br/><b>60 (item:3371)| |P|Alchemy 150|
...
N Train Expert Alchemy |N|(npc:5499) (55.6, 85.9), in {Stormwind City}| |Z|301| |PM|Alchemy|225| |NPC|5499|
...
N Train Artisan Alchemy |N|(npc:5499) (55.6, 85.9), in {Stormwind City}| |Z|301| |PM|Alchemy|300| |NPC|5499|
...
N Train Master Alchemy |N|(npc:5499) (55.6, 85.9), in {Stormwind City}| |PM|Alchemy|450| |NPC|5499|
...
N Note... |N|Several recipes are discovered by making alchemy items. If the recipe you need has not been discovered, continue making (item:76094) OR (item:76097) until it is, then move on the next recipes<br/><br/>Tick this step.|
