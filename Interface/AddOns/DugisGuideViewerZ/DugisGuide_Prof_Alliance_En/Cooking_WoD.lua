...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Warlords Leveling|r", "Warlords Cooking 1-700", nil, "Alliance", nil, "P", nil, function()
return [[
...
N (item:111387) |N|Drops from NPC's in Draenor| |L|111387| |PM|Cooking|700|
U (item:111387) |N|Train Draenor Cooking| |U|111387| |PM|Cooking|700|

N 600-625 (item:111456) |CO| |N|Created with; <br/><b>5 (item:109137)| |P|Cooking 625| --Crescent Saberfish Flesh
