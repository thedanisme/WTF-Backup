...
function Astrolabe:GetUnitPosition( unit, noMapChange )
	...
	if ( x <= 0 and y <= 0 ) then
		...
		if ( M ~= lastMapID or F ~= lastFloor ) then
			...
			LuaUtils:DugiSetMapByID(lastMapID);
...
local HARVESTED_DATA_VERSION = 4; -- increment this when the format of the harvested data has to change
local function harvestMapData( HarvestedMapData )
	local mapData = {}
	local mapName = GetMapInfo();
	local mapID = GetCurrentMapAreaID();
	local numFloors, firstFloor
	if IsLegion then
		numFloors = #{ GetNumDungeonMapLevels() }
	else
		numFloors, firstFloor = GetNumDungeonMapLevels();
	end	
	...
	if not ( oldInstance and oldInstance.HarvestedMapData.VERSION == HARVESTED_DATA_VERSION ) then
		...
		for _, id in ipairs(GetAreaMaps()) do
			if not ( HarvestedMapData[id] ) then
				if ( LuaUtils:DugiSetMapByID(id) ) then
...
WorldMapSize = {
	...
	[1007] = {
		["numFloors"] = 0,
		["system"] = 1220,
		["yOffset"] = -7262.1298828125,
		["height"] = 12558.8198242188,
		["originSystem"] = 1220,
		["xOffset"] = -13100.099609375,
		["width"] = 18838.1796875,
	},
	[1024] = {
		["numFloors"] = 0,
		["width"] = 7070.8330078125,
		["xOffset"] = -7689.5830078125,
		["height"] = 4712.5,
		["originSystem"] = 1220,
		["yOffset"] = -6962.5,
		["system"] = 1220,
	...
	[1018] = {
		["numFloors"] = 0,
		["width"] = 5510.4169921875,
		["xOffset"] = -9606.25,
		["height"] = 3672.916015625,
		["originSystem"] = 1220,
		["yOffset"] = -4964.5830078125,
		["system"] = 1220,
	},
	[1033] = {
		["numFloors"] = 0,
		["width"] = 5552.080078125,
		["xOffset"] = -6658.330078125,
		["height"] = 3702.080078125,
		["originSystem"] = 1220,
		["yOffset"] = -3445.830078125,
		["system"] = 1220,
	},
	[1015] = {
		["numFloors"] = 0,
	...
	[1080] = {
		...
		["originSystem"] = 1220,
		["xOffset"] = -4800,
		["yOffset"] = -4397.919921875,
		["system"] = 1220,
	},
	[1028] = {
		["width"] = 3743.7509756625,
		["height"] = 2495.8330078125,			
		["xOffset"] = -4029.1669921875,
		["yOffset"] = -2572.9169921875,		
		[1] = {
			["height"] = 250,
...
--[[	[32] = {
		...
		["width"] = 2499.9999389648,
		["height"] = 1666.6669921875,
		["xOffset"] = 833.33331298828,			
		["yOffset"] = 9866.66015625,
		["originSystem"] = 0,
		["system"] = 0,
	},]]	
	[1021] = { -- Broken Shore
...
for mapID, harvestedData in pairs(Astrolabe.HarvestedMapData) do
    ...
    if harvestedData.numFloors == nil then
        harvestedData.numFloors = 0
    end
