...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "181(9-20)#181(10-21)#181(10-22)", "43(19-24)#43(20-26)#43(21-27)", "Horde", nil, "L", nil, function()
return [[

R Orgrimmar |N|Travel to {Orgrimmar} (48.13, 70.48)| |Z|321| |QID|25275| |R|Goblin|
N Abandon (qid:28496) |QID|28496| |N|Abandon (qid:28496) to accept (qid:25275)| |O| |R|Goblin| |OID|25275|
A Report to the Labor Captain |QID|25275| |N|(npc:14720) in {Grommash Hold} (48.28, 71.01)| |Z|321| |R|Goblin| |NPC|14720|
...
T Runaway Shredder! |QID|14129| |N|(npc:35086) (27.38, 73.95) in {Orgrimmar Rear Gate}| |NPC|35086|
...
T The Captain's Logs |QID|14134| |N|(npc:35086) (25.69, 74.14) in {Orgrimmar Rear Gate}| |NPC|35086|
...
T Up a Tree |QID|14135| |N|(npc:35086) (22.85, 74.18) in {The Ancient Grove}| |NPC|35086|
...
A Arborcide |QID|14155| |N|(npc:35086) (26.79, 76.80) in {Orgrimmar Rear Gate}| |NPC|35086|
...
N Carry a Stonified (npc:35257) |N|Collect a stonified (npc:35257) from the mine. Many of the statues aren't targetable, but just keep mousing over each miner until the name appears green for you to pick up the statue.<br/><br/>This should give you a (spell:67032) buff. Tick this step (24.81, 71.76)| |QID|14165| |NPC|35257|
...
C Stone Cold |QID|14165| |N|Collect a stonified (npc:35257) from the mine. Many of the statues aren't targetable, but just keep mousing over each miner until the name appears green for you to pick up the statue (29.16, 66.64) in {Orgrimmar Rocketway Exchange}| |NPC|35257|
...
R Rocketway Exchange |N|Travel to Rocketway Exchange (29.51, 66.83)| |QID|14202|
...
N Collect 5 Experimental Raptors |N|Collect 5 (npc:36509) then tick this step (43.69, 74.92)| |U|49132| |QID|14422| |NPC|36509|
...
N Collect a (item:49230) |QID|14385.2| |N|Go up the {Elevator} (39.86, 84.75) and collect a (item:49230) from the gnomish tower (39.86, 84.75) in {The Ruined Reaches}| |L|49230| |OBJ|9118|
...
N Collect (item:49639) as you travel |N|Collect 12 (item:49639) from within the ruins, tick this step| |QID|14486| |OBJ|2651|
...
N Guide Complete |N|Tick to continue to (guide:"43(19-24)#43(20-26)#43(21-27)")|
