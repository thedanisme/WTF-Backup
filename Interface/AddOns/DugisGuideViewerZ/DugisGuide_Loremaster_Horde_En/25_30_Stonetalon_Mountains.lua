...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "81(24-29)#81(25-31)#81(26-32)", "607(29-34)#607(30-36)#607(31-37)", "Horde", nil, "L", nil, function()
return [[

R Silverwind Refuge |N|Travel to {Silverwind Refuge} (49.83, 65.77) {Ashenvale}| |QID|25999| |Z|43|
A We're Here to Do One Thing, Maybe Two... |QID|25945| |N|(npc:41678) (49.83, 65.77) in {Silverwind Refuge}| |Z|43| |NPC|41678|
