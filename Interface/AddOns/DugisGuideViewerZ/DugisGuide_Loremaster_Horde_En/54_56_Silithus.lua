...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Kalimdor|r ", "261(54-58)#261(54-59)#261(55-60)", "465(58-60)#465(59-62)#465(60-64)", "Horde", nil, "L", nil, function()
return [[
...
T Warchief's Command: Silithus! |QID|28527| |N|(npc:15191) (54.95, 35.87) in {Cenarion Hold}| |O| |NPC|15191|
...
A Report to General Kirika |QID|9416| |N|(npc:17081) (52.98, 34.86) in {Cenarion Hold}| |NPC|17081|
A Twilight Geolords |QID|8320| |N|(npc:15270) (53.25, 35.17) in {Cenarion Hold}| |NPC|15270|
A Secret Communication |QID|8318| |N|(npc:15306) (53.25, 35.17) in {Cenarion Hold}| |NPC|15306|
f Cenarion Hold |N|Grab {Cenarion Hold} flight path (52.79, 34.64)| |QID|8277| |NPC|15177| |PL|55|

N Abandon (qid:28858) |QID|28858| |N|Abandon (qid:28858) to accept (qid:28865)| |O| |OID|28865|
N Abandon (qid:28671) |QID|28671| |N|Abandon (qid:28671) to accept (qid:28865)| |O| |OID|28865|
N Abandon (qid:28553) |QID|28553| |N|Abandon (qid:28553) to accept (qid:28865)| |O| |OID|28865|
A Call of the Warmatron |QID|28865| |N|(npc:50587) (53.33, 33.51), this quest won't be available if you already have any other {Blasted Lands} quest such as (qid:28858) (qid:28553) and (qid:28671), drop those quests to accept this one| |NPC|50587|
...
C Securing the Supply Lines |QID|8280| |N|Kill 15 (npc:11740) (giant snakes) (62.45, 19.00)| |NPC|11740|
...
T Twilight Geolords |QID|8320| |N|(npc:15270) (53.25, 35.17) in {Cenarion Hold}| |NPC|15270|
A Vyral the Vile |QID|8321| |N|(npc:15270) (53.25, 35.17) in {Cenarion Hold}| |NPC|15270|

R Twilight's Run |N|Travel to {Twilight's Run} (69.88, 16.43)| |QID|8321|
C Vyral the Vile |QID|8321.1| |N|Kill (npc:15202) in the cave and collect (item:20466) (58.6, 81.9) {Twilight's Run}| |NPC|15202| |Z|261 13|
C Secret Communication |QID|8318.1| |N|Collect 10 (item:20404) from the Twilight's Hammer cultists (69.88, 16.43) (32.96, 30.39) in {Twilight Post} and {Twilight's Run}.| |NPC|11880, 11881, 15308|

R Cenarion Hold |N|Travel to {Cenarion Hold} (55.48, 36.67)| |QID|8278|
T Vyral the Vile |QID|8321| |N|(npc:15270) (53.25, 35.17) in {Cenarion Hold}| |NPC|15270|
T Secret Communication |QID|8318| |N|(npc:15306) (53.25, 35.17) in {Cenarion Hold}| |NPC|15306|
...
C The Twilight Mystery |QID|8284.1| |N|Collect 8 (item:20378), it's a stone on the ground with a purple glow (32.55, 11.56) scattered around {The Crystal Vale}| |OBJ|6419|
...
N As you go... |AYG|8323| |N|Kill 20 (npc:11741) for (qid:8281). This will take you a while so always kill them as you travel.| |QID|8281| |NPC|11741|
K (npc:11736) |QID|8278.2| |N|Collect 3 (item:20374) from (npc:11736) (60.15, 55.36)| |NPC|11736|
...
C Noggle's Last Hope |QID|8278| |N|Collect 3 (item:20375) from (npc:11737) and 3 (item:20377) from (npc:11739) (67.13, 67.30) (65.73, 62.16)(51.6, 64.3)| |NPC|11737, 11739|
C Scouring the Desert |QID|9422.1| |N|Look out for a little geyser marked "Silithyst Geyser" found around the desert. Then take it back to camp and put it into the extractor machine (54.86, 63.40)| |OBJ|6862|

T Report to General Kirika |QID|9416| |N|(npc:17079) (54.65, 62.86)| |NPC|17079|
A Scouring the Desert |QID|9422| |N|(npc:17079) (54.60, 62.95) in {Silithus}| |NPC|17079|
T Scouring the Desert |QID|9422| |N|(npc:17079) (54.60, 62.95) in {Silithus}| |NPC|17079|
...
K (npc:11804) |QID|8279.3| |N|Kill (npc:11804) and collect the (item:20396) (45.55, 39.30) {Twilight Base Camp}| |NPC|11804|
...
T Dearest Natalia |QID|8304| |N|(npc:15181), Auto Turn-in| |NPC|15181|
A Into The Maw of Madness |QID|8306| |N|(npc:15181), Auto Accept| |NPC|15181|
...
C Into The Maw of Madness |QID|8306.1| |N|Enter the cave and head south through the tunnels and Natalia is in the last room (58.5, 78.25) (55.45, 90.36) in {Hive'Regal}| |NPC|15215|
N (item:20456) |QID|8309.3| |N|Collect the (item:20456) from the crystal in the hive (55.51, 90.52) in {Hive'Regal}| |U|20453| |T| |OBJ|6414|
...
R Ortell's Hideout |N|Travel to {Ortell's Hideout} (68.54, 63.01)| |QID|8323|
C Stepping Up Security |QID|8281.1| |N|Kill 20 (npc:11741) (36.29, 38.30) (44.6, 51.9)| |NPC|11741|
T True Believers |QID|8323| |N|(npc:15194) (68.65, 63.01) in {Ortell's Hideout}| |NPC|15194|
...
R Bronzebeard Encampment |N|Travel to {Bronzebeard Encampment} (46.36, 79.09)| |QID|8314|
...
R Cenarion Hold |N|Travel to {Cenarion Hold} (55.48, 36.67)| |QID|8314|
...
T Call of the Warmatron |QID|28865| |N|(npc:41124) (40.52, 11.78) {Dreadmaul Hold}| |Z|19| |NPC|41124|
