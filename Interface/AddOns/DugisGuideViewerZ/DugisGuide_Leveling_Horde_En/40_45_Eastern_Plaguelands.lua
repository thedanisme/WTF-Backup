...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r ", "23(39-44)#23(40-46)#23(41-47)", "17(44-46)#17(45-48)#17(46-49)", "Horde", nil, "L", nil, function()
return [[

R Shrine of the Ox |QID|31835| |N|Travel to {Shrine of the Ox} (48.60, 42.71)| |C|Monk| |Z|809|
A Continue Your Training: Master Kistane |QID|31835| |N|(npc:66260) (48.59, 42.70) in {Shrine of the Ox}| |NPC|66260| |C|Monk| |Z|809|
C Continue Your Training: Master Kistane |QID|31835| |N|Speak with (npc:65899) in the {Peak of Serenity} and complete your training with her at the {Training Grounds} (48.04, 39.02)| |NPC|65899| |C|Monk| |Z|809|
T Continue Your Training: Master Kistane |QID|31835| |N|(npc:66260) (48.60, 42.72) in {Shrine of the Ox}| |NPC|66260| |C|Monk| |Z|809|

R The Menders' Stead |N|Travel to {Western Plaguelands}, {The Menders' Stead} (48.86, 54.73)| |Z|22| |QID|27683|
N Abandon (qid:28577) |N|Abandon (qid:28577) to accept (qid:27683)| |O| |QID|28577|
A Into the Woods |QID|27683| |N|(npc:44456) (48.86, 54.73) {The Menders' Stead}| |Z|22| |NPC|44456|
...
C Just Encased |QID|27368| |N|Collect 8 vials of (item:60983) from the spiders in the tunnel. {Terrorweb Tunnel} (7.33, 30.43)| |NPC|8557|
...
C Greasing the Wheel |QID|27369| |N|Collect 10 (item:60984) that grow along the shore of the river. {Thondroril River} (3.82, 44.93) (3.96, 48.09)| |OBJ|9889|
T Greasing the Wheel |QID|27369| |N|(npc:45417) (9.02, 66.47) in {Thondroril River}| |NPC|45417|
T Tarenar Sunstrike |QID|27370| |N|(npc:45429) (18.38, 74.87) {Death's Step}| |NPC|45429|
A What I Do Best |QID|27371| |N|(npc:45429) (18.38, 74.87) {Death's Step}| |NPC|45429|
C What I Do Best |QID|27371| |N|Kill 5 (npc:45444). {Death's Step} (17.98, 79.35)| |NPC|45444|
T What I Do Best |QID|27371| |N|(npc:45429) (17.98, 79.35) {Death's Step}| |NPC|45429|
A A Gift For Fiona |QID|27372| |N|(npc:45429) (17.98, 79.35) {Death's Step}| |NPC|45429|
C A Gift For Fiona |QID|27372.1| |N|Collect 10 samples of (item:60986) from the plaguehounds in {Crown Guard Tower} (15, 63)| |NPC|8596|
...
C Traveling Companions |QID|27381| |N|Run inside the tower to the top and talk with (npc:45958) who is also another quest giver in {Crown Guard Tower} (35.71, 69.29)| |NPC|45958|
T Traveling Companions |QID|27381| |N|(npc:45429) (35.27, 68.76) in {Crown Guard Tower}| |NPC|45429|
N As you go... |AYG|27392| |N|Kill 13 (npc:8600) as you travel| |QID|27382| |NPC|8600|
...
N (item:12887) |N|Get (item:12887) inside the building upstairs (34.00, 85.38)| |L|12887| |QID|27384| |OBJ|4232|
N (item:12888) |N|Get (item:12888) (35.36, 85.32)| |L|12888| |QID|27384| |OBJ|4233|
N (item:12886) |N|Get (item:12886) (35.53, 85.30)| |L|12886| |QID|27384| |OBJ|4231|
U (item:12885) |N|Combine the 3 pieces to create (item:12885) (32.53, 83.78)| |U|12886| |QID|27384|
C I'm Not Supposed to Tell You This |QID|27392| |N|Collect (item:60987) from (npc:45450). {Darrowshire Hunting Grounds} (40.20, 83.78)| |NPC|45450|
...
C Rough Roads |QID|27382| |N|Kill 13 (npc:8600) along the path to {Light's Shield Tower} (40.18, 68.75)| |NPC|8600|
...
N (item:13202) |QID|27388.1| |N|Talk to (npc:11063) to collect the (item:13202) in {Crown Guard Tower} (35.56, 68.87)| |NPC|11063|
N (item:12956) |QID|27387.1| |N|Find the (item:12956) near the bottom of the hills (37.35, 60.27)| |OBJ|4173|
N (item:12957) |QID|27387.2| |N|Find the (item:12957) near the road in {Eastern Plaguelands} (39.76, 72.34)| |OBJ|4175|
N (item:12955) |QID|27388.3| |N|Collect (item:12955) in {The Marris Stead} (22.16, 68.13)| |OBJ|4172|
N (item:12954) |QID|27388.2| |N|Collect (item:12954) in the fireplace in {The Marris Stead} (22.33, 68.29)| |OBJ|430|
...
N As you go... |AYG|27421| |N|Collect 3 (item:61038) from (npc:8546) and (npc:8550) outside each necropolis, you need it to destroy 3 Plague Disseminators for (qid:27420)<br/><br/>Also loot all Skeleton NPC for (item:13157)| |QID|27420| |NPC|8529, 8546, 8550|
N Plant (item:61036) in Western necropolis |QID|27421.2| |N|Plant (item:61036) in the center of the western necropolis. {The Fungal Vale} (33.67, 44.44)| |U|61036| |NPC|8529, 8546, 8550|
N Plant (item:61036) in Southeastern necropolis |QID|27421.1| |N|Plant (item:61036) in the center of the southeastern necropolis. {The Fungal Vale} (37.56, 48.31)| |U|61036| |NPC|8529, 8546, 8550|
N Plant (item:61036) in Northeastern necropolis |QID|27421.3| |N|Plant (item:61036) in the center of the northeastern necropolis. {The Fungal Vale} (37.79, 42.46)| |U|61036| |NPC|8529, 8546, 8550|
R The Fungal Vale |QID|27421| |N|Travel to {The Fungal Vale} (37.79, 42.46)|
C Postponing the Inevitable |QID|27420| |N|Collect 3 (item:61038) from (npc:8546) and (npc:8550), then use the (item:61038) to destroy 3 (npc:45475). {The Fungal Vale} (36.89, 44.59) (35.31, 46.47)| |U|61038| |NPC|8550, 8546, 45475|
C Marauders of Darrowshire |QID|27389| |N|Kill scourge champions to collect (item:13157). Use the (item:13156) on the skulls to see which ones resonate. Collect 5 (item:13155). {The Fungal Vale} (34.92, 47.84)| |U|13156| |NPC|8529|
...
U (item:15209) |N|Place the (item:15209) at the town square to start the battle. (35.05, 84.03)| |U|15209| |QID|27390|
C The Battle of Darrowshire |QID|27390| |N|Place the (item:15209) at the town square to start the battle. You have to keep (npc:10944) alive until Horgus is dead. And you must keep Captain Redpath alive until (npc:10938) appears. Then kill (npc:10938). Redpaths spirit will then appear at the town square for you to speak with. {Darrowshire} (34.54, 82.46) (35.06, 84.03)| |U|15209| |NPC|10944, 10946, 10938|
...
C Honor and Strength |QID|27449| |N|Kill 3 (npc:45579). {Light's Shield Tower} (52.78, 51.40)| |NPC|45579|
T Honor and Strength |QID|27449| |N|(npc:45574) (52.78, 51.40) in {Light's Shield Tower}| |NPC|45574|
K Scourge and Cultist |N|Kill Scourge Ghouls for 7 (item:15447) and Human Cultist for (item:61281) and (item:61280) (53.20, 61.37) (52.98, 62.24) (54.25, 62.06) (55.14, 60.64)| |L|15447 7| |QID|27451| |NPC|8525, 8531, 8526, 8538, 8541|
C To Kill With Purpose |QID|27451| |N|Kill the Scourge found around town and collect 7 pieces of (item:15454) Use the (item:15454) to grind the living rot into (item:15448). {Corin's Crossing} (54.25, 62.06)| |U|15454| |NPC|8525, 8531, 8526, 8538, 8541|
T To Kill With Purpose |QID|27451| |N|(npc:11035) (54.25, 62.06) {Corin's Crossing}| |NPC|11035|
C Dark Garb |QID|27452| |N|Collect (item:61280) and (item:61281) from the human cultists that roam through the town. {Corin's Crossing} (55.14, 60.64)| |NPC|8548, 8551|
T Dark Garb |QID|27452| |N|(npc:11035) (55.14, 60.64) {Corin's Crossing}| |NPC|11035|
A Catalysm |QID|27453| |N|(npc:11035) (55.14, 60.64) {Corin's Crossing}| |NPC|11035|
...
C Catalysm |QID|27453| |N|Use (item:61284) on the water elementals within the lake to collect 8 (item:61285). Use the item BEFORE killing them. {Lake Mereldar} (57.34, 71.50)| |U|61284|
T Catalysm |QID|27453| |N|(npc:11035) (57.35, 71.26) {Lake Mereldar}| |NPC|11035|
A Just a Drop in the Bucket |QID|27454| |N|(npc:11035) (57.35, 71.26) {Lake Mereldar}| |NPC|11035|
U (item:61283) |N|Wear (item:61283) before your continue| |U|61283| |QID|27454|
C Just a Drop in the Bucket |QID|27454| |N|Use the (item:61283) to enter the cultist camp, then put Betina's mixture into the Mereldar Plague Cauldron found on the lake's southeastern border. {Death Cultist Base Camp} (62.51, 76.33)| |U|61283| |OBJ|4331|
...
C Argent Call: The Trial of the Crypt |QID|27464| |N|Enter the {Crypt} found behind the Chapel, and read the (item:61309). You will get a buff that helps you defeat waves of mobs for about 2 minutes. Crypt (76.89, 50.78) (77.27, 51.37)| |U|61309|
...
C Gathering Some Grub(s) |QID|27456| |N|Collect 15 (item:13853) from (npc:8603) and Devourers. The drop rate is low, the devourers can drop multiples, so best to go for them. {Eastern Plaguelands} (69.05, 66.29)| |NPC|8605, 8603|
...
N (item:61960) |QID|27614.2| |N|Find the (item:61960) inside a chest. {Tyr's Hand} (74.27, 78.25)| |OBJ|259|
N (item:61959) |QID|27614.1| |N|Find the (item:61959) inside a chest. {Tyr's Hand} (74.76, 76.76)| |OBJ|259|
N (item:61962) |QID|27614.4| |N|Find the (item:61962) inside a chest. {Tyr's Hand} (75.79, 77.50)| |OBJ|259|
N (item:61961)|QID|27614.3| |N|Find the (item:61961) inside a chest. {Tyr's Hand} (75.16, 79.00)| |OBJ|259|
C The Commander |QID|27619| |N|Go upstairs and kill Scarlet Commander Marjahn. {Tyr's Hand} (74.88, 78.14)| |NPC|46092|
C The Huntsman |QID|27616| |N|Kill (npc:46094), he's at the top of the building. {Tyr's Hand} (75.19, 78.81) (74.46, 77.50)| |NPC|46094|
C The Wrathcaster |QID|27615| |N|Kill (npc:46093), he's within the barracks' dungeon. {Tyr's Hand} (74.87, 78.39)| |NPC|46093|
...
C The Assassin |QID|27613| |N|Go all the way upstair and kill (npc:46095) (look carefully because he's in stealth) atop the abbey bell tower. {Tyr's Hand Abbey} (77.92, 72.74) (77.60, 72.75)| |NPC|46095|
...
C Like Rats |QID|27620| |N|Kill (npc:46096). {Tyr's Hand} (82.33, 79.51)| |NPC|46096|
...
C Ix'lar the Underlord |QID|27487| |N|Kill (npc:45744) and 10 of Ix'lar's minions, {Ix'lar's Domain} (60.38, 35.45)| |NPC|45744, 8544, 8527, 45743|
C The Corpulent One |QID|27477| |N|Kill (npc:11896). {Eastern Plaguelands} (58.49, 29.36)| |NPC|11896|
...
C Out of the Ziggurat |QID|27481| |N|Don't run through the center, Kill (npc:10822) and collect the (item:61315), he's atop {Zul'Mashar}'s ziggurat in Zul'Mashar (63.98, 13.67) (66.79, 9.65)| |NPC|10822|
T Out of the Ziggurat |QID|27481| |N|(npc:45574) (66.84, 9.74) {Zul'Mashar}| |NPC|45574|
...
C Impatience |QID|27488| |N|Collect (item:61318). {Northdale} (65.47, 24.47)| |OBJ|254|
...
C Nobody to Blame but Myself |QID|27489| |N|Ride (npc:45400) to {Northpass Tower}. Northpass Tower (50.52, 20.45)| |NPC|45400|
...
C Beat it Out of Them |QID|27522| |N|Beat up 6 (npc:17878) to find out Gidwin's location and captor. {Siege Vise} (53.45, 16.74) (54.79, 17.54) (54.81, 17.47)| |NPC|17878|
C Duskwing, Oh How I Hate Thee... |QID|27523| |N|Use (item:61334) to get (npc:11897) attention as he circles up in the air. Kill him and collect (item:15850). {Eastern Plaguelands} (45.88, 34.05)| |U|61334| |NPC|11897|
...
N As you go... |AYG|27526| |N|These NPCs are quite spread out so make sure you kill as you go to complete the 3 quests<br/><br/>Kill 8 (npc:45851), then use the (item:61369) to burn their corpses<br/><br/>Kill (npc:8530) and speak to 8 (npc:11064) that appear to free them from their bodies<br/><br/>Collect 16 (item:61372) from (npc:8524) or (npc:8523)| |NPC|45851, 8530, 8523, 8524|
K (npc:45868) |QID|27525.2| |N|Kill (npc:45868) in {Plaguewood} (29.49, 19.74)| |U|61369| |NPC|45868|
N (item:61378) |QID|27551| |N|Get (item:61378) from (npc:45868) (29.49, 19.74)| |L|61378| |NPC|45868|
A The Baroness' Missive |QID|27551| |N|Use (item:61378) to accept the quest, {Plaguewood}| |U|61378|
T The Baroness' Missive |QID|27551| |N|(npc:45729) (27.67, 21.06) in {Plaguewood}| |NPC|45729|
A Gidwin's Fate Revealed |QID|27526| |N|(npc:45729) (27.67, 21.06) in {Plaguewood}| |U|61369| |NPC|45729|
K (npc:45867) |QID|27525.1| |N|Kill (npc:45867) in {Plaguewood} (24.62, 20.75) (25.46, 19.73)| |U|61369| |NPC|45867|
T Guardians of Stratholme |QID|27525| |N|(npc:45729) (27.67, 21.06) in {Plaguewood}| |U|61369| |NPC|45729|
C Gidwin's Fate Revealed |QID|27526| |N|Find (npc:45730) within the slaughterhouse in {Plaguewood} (28.69, 26.06)| |U|61369| |NPC|45730|
T Gidwin's Fate Revealed |QID|27526| |N|(npc:45730) (28.40, 25.95) in {Plaguewood}| |U|61369| |NPC|45730|
A Journey's End |QID|27527| |N|(npc:45730) (28.40, 25.95) in {Plaguewood}| |U|61369| |NPC|45730|
...
C Add 'em to the Pile |QID|27539.1| |N|Collect 16 (item:61372) from (npc:8524) and (npc:8523) in {Plaguewood} (20.51, 24.39)| |NPC|8523, 8524| |PL|40|
...
T Just a Little Touched |QID|27535| |N|(npc:12384) (11.35, 28.68) {Terrordale}| |NPC|12384|
A A Fate Worse Than Butchery |QID|27533| |N|(npc:12384) (11.35, 28.68) {Terrordale}| |NPC|12384|
A Augustus' Receipt Book |QID|27534| |N|(npc:12384) (11.35, 28.68) {Terrordale}| |NPC|12384|
C Augustus' Receipt Book |QID|27534| |N|Get (item:15884) from the inn. It's in the largest building, in the upstairs room. {Terrordale} (14.23, 26.32)| |OBJ|4872|
C A Fate Worse Than Butchery |QID|27533| |N|Kill 9 (npc:16117). {Terrordale} (15.46, 29.62)| |NPC|16117|
T A Fate Worse Than Butchery |QID|27533| |N|(npc:12384) (11.35, 28.68) {Terrordale}| |NPC|12384|
T Augustus' Receipt Book |QID|27534| |N|(npc:12384) (11.35, 28.68) {Terrordale}| |NPC|12384|
...
U (item:61379) |N|Use (item:61379) to teleport back to {Light's Hope Chapel}| |U|61379| |QID|27762| 
T Journey's End |QID|27527| |N|(npc:45417) (73.71, 52.12) in {Light's Hope Chapel}| |NPC|45417|

N Guide Complete |N|Tick to continue to (guide:"17(44-46)#17(45-48)#17(46-49)")|
