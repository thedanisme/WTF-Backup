...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cffffd200Eastern Kingdoms|r ", "673(29-34)#673(30-36)#673(31-37)", "22(34-39)#22(35-41)#22(36-42)", "Horde", nil, "L", nil, function()
return [[

R Shrine of the Ox |QID|31833| |N|Travel to {Shrine of the Ox} (48.60, 42.71)| |C|Monk| |Z|809|
A Continue Your Training: Master Woo |QID|31833| |N|(npc:66260) (48.61, 42.74) in {Shrine of the Ox}| |NPC|66260| |C|Monk| |Z|809|
C Continue Your Training: Master Woo |QID|31833| |N|Speak with (npc:65960) in the {Peak of Serenity} and complete your training with her at the {Training Grounds} (48.59, 39.52)| |NPC|65960| |C|Monk| |Z|809|
T Continue Your Training: Master Woo |QID|31833| |N|(npc:66260) (48.59, 42.70) in {Shrine of the Ox}| |NPC|66260| |C|Monk| |Z|809|
...
A Above My Pay Grade |QID|26404| |N|(npc:42814) (63.24, 40.99) in {Bambala}| |Z|37| |NPC|42814| |OID|28704|

F Hardwrench Hideaway |N|Talk to (npc:43052) for a free flight to {Hardwrench Hideaway} (62.6, 39.5)| |QID|26450| |Z|37| |NPC|43052| |OID|28704|
...
A The Holy Water of Clarity |QID|26433| |N|(npc:43096) (33.66, 29.18) in {Hardwrench Hideaway}| |NPC|43096| |PRE|26404|
...
N As you go... |AYG|26433| |N|Collect 6 (item:58877) in the sand and under trees.<br/><br/>Also collect 6 (item:4029) from (npc:1907)| |QID|26450| |NPC|1907| |OBJ|4853| |PRE|26404|
...
C The Holy Water of Clarity |QID|26433| |N|Collect (item:58811) from the {Nek'mani Wellspring} (40.83, 44.57) (41.04, 50.69) (43.91, 48.98)| |OBJ|90| |PRE|26404|
...
C Akiris by the Bundle |QID|26487| |N|Collect 6 (item:4029) from (npc:1907) in {Cape of Stranglethorn} (40.83, 46.55)| |NPC|1907| |R|Tauren, Scourge, Undead, Orc, Bloof Elf, Troll, Pandaren|
C It's You!! |QID|26489| |N|Collect 6 (item:4029) from (npc:1907) in {Cape of Stranglethorn} (40.83, 46.55)| |NPC|1907| |R|Goblin|
T Akiris by the Bundle |QID|26487| |N|(npc:43095) (34.71, 29.56) in {Hardwrench Hideaway}| |NPC|43095| |R|Tauren, Scourge, Undead, Orc, Bloof Elf, Troll, Pandaren|
...
T The Holy Water of Clarity |QID|26433| |N|(npc:43096) (33.66, 29.18) in {Hardwrench Hideaway}| |NPC|43096| |PRE|26404|
...
C High Priestess Jeklik |QID|26553| |N|Destroy (npc:43257)'s body, DPS Zanzil to stop him from healing Jeklik's body then continue to DPS the Jeklik's, Zanzil will drop some potion to restore HP and Mana. {Northern Stranglethorn}, {Zul'Gurub} (78.07, 45.00)| |Z|37| |NPC|43257|
...
C Plunging Into Zul'Gurub |QID|26554| |N|Pass through Zanzil's Portal. {Northern Stranglethorn}, {Zul'Gurub} (78, 44)| |Z|37|
...
N Guide Complete |N|Tick to continue to (guide:"22(34-39)#22(35-41)#22(36-42)")|
