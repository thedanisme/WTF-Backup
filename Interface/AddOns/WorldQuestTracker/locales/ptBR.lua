...
L["S_ERROR_NOTIMELEFT"] = "Esta quest expirou." -- Needs review
...
L["S_MAPBAR_FILTERMENU_FACTIONOBJECTIVES_DESC"] = "Mostra quets de facções mesmo que elas tenham sido filtradas." -- Needs review
L["S_MAPBAR_OPTIONS"] = "Opções"
L["S_MAPBAR_OPTIONSMENU_SHARE"] = "Compartilhe Este AddOn"
L["S_MAPBAR_OPTIONSMENU_SHARE_DESC"] = "Se você deseja ser o primeiro\\na traze-lo aos seus amigos!" -- Needs review
...
L["S_SHAREPANEL_THANKS"] = "Obrigado por compartilhar World Quest Tracker!\\nEnvie este link aos seus amigos no Facebook, Twitter, Itamarati." -- Needs review
...
L["S_TUTORIAL_AUTOWORLDMAP"] = "Auto Mapa mostra Ilhas Partidas quando você estiver em Dalaran ou no Hall da Classe."
L["S_TUTORIAL_AUTOWORLDMAP2"] = "Quando ativado, mostrar o mapa em Dalaran ou no Hall da Classe mostra Ilhas Partidas."
