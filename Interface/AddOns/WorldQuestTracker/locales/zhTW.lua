...
L["S_MAPBAR_OPTIONSMENU_SHARE_DESC"] = "好東西與好朋友分享!"
...
L["S_TUTORIAL_AUTOWORLDMAP"] = "當你位於達拉然或職業大廳時，自動世界地圖會顯示整個破碎群島的地圖。"
L["S_TUTORIAL_AUTOWORLDMAP2"] = "啟用時，在達拉然或職業大廳打開地圖會顯示整個破碎群島的地圖。"
