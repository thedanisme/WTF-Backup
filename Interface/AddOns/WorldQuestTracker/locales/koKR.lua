...
L["S_APOWER_AVAILABLE"] = "수행 가능"
L["S_APOWER_NEXTLEVEL"] = "다음 단계"
L["S_ERROR_NOTIMELEFT"] = "이 퀘스트는 남은 시간이 없습니다."
...
L["S_MAPBAR_FILTERMENU_FACTIONOBJECTIVES"] = "진영 목표"
L["S_MAPBAR_FILTERMENU_FACTIONOBJECTIVES_DESC"] = "선별하지 않은 진영 퀘스트를 표시합니다."
L["S_MAPBAR_OPTIONS"] = "옵션"
L["S_MAPBAR_OPTIONSMENU_SHARE"] = "이 애드온 공유"
L["S_MAPBAR_OPTIONSMENU_SHARE_DESC"] = [=[하나가 되고 싶은 친구들에게
이 애드온을 공유하세요!]=]
...
L["S_TUTORIAL_AUTOWORLDMAP"] = "달라란이나 직업 전당에 있을 때 자동으로 부서진 섬 지도를 표시합니다."
L["S_TUTORIAL_AUTOWORLDMAP2"] = "활성화하고 달라란이나 직업 전당에서 지도를 열면 부서진 섬 지도를 표시합니다."
L["S_TUTORIAL_CLICKTOTRACK"] = "퀘스트를 추적하려면 클릭하세요."
L["S_TUTORIAL_CLOSE"] = "튜토리얼 닫기"
L["S_TUTORIAL_FACTIONBOUNTY"] = "선택한 진영의 퀘스트 갯수를 나타냅니다."
...
L["S_TUTORIAL_REWARD"] = "보상을 나타냅니다 (장비, 돈, 유물력, 자원, 재료)"
