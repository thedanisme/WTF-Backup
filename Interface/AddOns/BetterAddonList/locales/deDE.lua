...
L["... and %d more"] = "... und %d mehr"
L["Create new set"] = "Neues Set erstellen"
L["Delete"] = "Löschen"
...
L["Enabled only addons in set %q."] = "Nur Addons im Set %q aktiviert." -- Needs review
...
L["Reset addons to what was enabled at login."] = "Setze alle alle Addons auf das zurück, was beim Einloggen aktiviert war."
L["Save"] = "Speichern"
...
Please choose another name.]=] ] = [=[Es gibt bereits ein Set namens "%s".
