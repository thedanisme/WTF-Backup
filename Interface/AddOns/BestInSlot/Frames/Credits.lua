...
function Credits:Draw(container)
  ...
  label:SetFullWidth(true)
  scroll:AddChild(self:CreateTesterLabel("Beliria", "Moonglade-EU", "DEMONHUNTER", "H"))
  ...
  scroll:AddChild(self:CreateTesterLabel("Shirida","The Sha'tar-EU","ROGUE", "H"))
  ...
  scroll:AddChild(self:CreateTesterLabel("Raiment", "Defias Brotherhood-EU", "PRIEST", "A"))
