...
L["Auto accepted %d macros."] = true
L["Auto Accept Macros"] = true
...
L["Couldn't create category"] = true
L["Create"] = true
L["Create Category"] = true
L["CreateDesc"] = "Creates a new macro in the macro bank."
L["Creates a new category."] = true
L["Default"] = true
...
L["Delete Macros"] = true
L["Delete Macro %s?"] = true
L["Delete macros in %s?"] = true
...
L["Deletes all subcategories and their macros of this category."] = true
L["Deletes macros in this category."] = true
L["Delete Subcategories"] = true
L["Delete subcategories of %s?"] = true
L["Description"] = true
...
L["Loads the selected category."] = true
L["Login Group"] = true
...
L["ToMacroBank"] = "----->"
L["Unable to load macro - no macro name"] = true
