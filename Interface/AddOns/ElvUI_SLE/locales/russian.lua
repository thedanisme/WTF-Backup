...
L["Create a button in your bag frame to switch to deconstrution mode allowing you to easily disenchant/mill/prospect and pick locks."] = "Создает в сумках кнопку для переключения в режим распыления, позворяющий распылять/просеивать/перетирать, а также вскрывать замки."
