...
L["Say"] = "Sagen"
L["Scenario"] = "Szenario"
L["%s - Color Animation"] = "%s - Farbanimation" -- Needs review
...
L["%s - Rotate Animation"] = "%s - Rotationsanimation" -- Needs review
L["%s - Scale Animation"] = "%s - Skalierungsanimation" -- Needs review
