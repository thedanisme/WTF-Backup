...
ItemScore.rules = {
	...
	["DEATHKNIGHT"] = {
		...
		[3] = { --UNHOLY
			itemtypes={ TH_POLE=1, TH_AXE=1, TH_MACE=1, TH_SWORD=1, PLATE=1 },
			stats = { STRENGTH={weight=9.08}, MASTERY={weight=7.58}, HASTE={weight=6.83}, CRIT={weight=4.58}, VERSATILITY={weight=3.08} },
		}
	},
	["DRUID"] = {
		[1] = { --BALANCE
	...
	["MAGE"] = {
		[1] = { -- Arcane
			itemtypes={ TH_STAFF=2, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.05}, MASTERY={weight=7.55}, HASTE={weight=6.05}, CRIT={weight=4.55}, VERSATILITY={weight=3.05} },
		},
		[2] = { -- Fire
			itemtypes={ TH_STAFF=2, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.01}, CRIT={weight=7.51}, MASTERY={weight=6.01}, HASTE={weight=4.51}, VERSATILITY={weight=3.01} },
		},
		[3] = { -- Frost
			itemtypes={ TH_STAFF=2, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.02}, HASTE={weight=7.52}, CRIT={weight=6.02}, VERSATILITY={weight=4.52}, MASTERY={weight=3.02} },
		}
	},
	["MONK"] = {
		[1] = { --BREWMASTER-TANK
			itemtypes={ TH_POLE=1, TH_STAFF=1, FIST=1, AXE=1, SWORD=1, MACE=1, LEATHER=1 },
			stats = { STAMINA={weight=12.05}, HASTE={weight=9.05}, CRIT={weight=7.55}, VERSATILITY={weight=6.05}, AGILITY={weight=4.55}, MASTERY={weight=3.05} },
		},
		[2] = { --MISTWEAVER-HEAL
			itemtypes={ TH_POLE=1, TH_STAFF=1, FIST=1, AXE=1, SWORD=1, MACE=1, LEATHER=1 },
	...
	["PRIEST"] = {
		...
		[2] = { -- HOLY
			itemtypes={ DAGGER=1, MACE=1, TH_STAFF=2, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.08}, MASTERY={weight=7.58}, CRIT={weight=6.08}, VERSATILITY={weight=0.5}, HASTE={weight=3.08} },
		},
		[3] = { --SHADOW
			itemtypes={ DAGGER=1, MACE=1, TH_STAFF=2, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.01}, HASTE={weight=7.51}, CRIT={weight=6.01}, VERSATILITY={weight=4.51}, MASTERY={weight=3.01} },
		}
	},
	["ROGUE"] = {
		[1] = { --ASSASSINATION
			itemtypes={ DAGGER=2,LEATHER=1 },
			stats = { AGILITY={weight=9.05}, VERSATILITY={weight=7.55}, CRIT={weight=6.05}, MASTERY={weight=4.55}, HASTE={weight=3.05} },
		},
		[2] = { --COMBAT
	...
	["WARLOCK"] = {
		[1] = { --AFFLICTION
			...
			stats = { INTELLECT={weight=9.06}, HASTE={weight=7.56}, MASTERY={weight=6.06}, CRIT={weight=4.56}, VERSATILITY={weight=3.06} },
		},
		[2] = { --DEMONOLOGY
			itemtypes={ SWORD=1, DAGGER=1, TH_STAFF=1, WAND=1, MISCARM=1, CLOTH=1 },
			stats = { INTELLECT={weight=9.04}, HASTE={weight=7.54}, MASTERY={weight=6.04}, CRIT={weight=6.04}, VERSATILITY={weight=3.04} },
		},
		[3] = { --DESTRUCTION
			itemtypes={ SWORD=1, DAGGER=1, TH_STAFF=1, WAND=1, MISCARM=1, CLOTH=1 },
