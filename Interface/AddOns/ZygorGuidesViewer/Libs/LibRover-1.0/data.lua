...
--		Swamp of Sorrows 76.0,45.3 (Portal to Dungeon (in hall of masks))
	...
	{"REGION",name="sw_wizardsanctum",mapzone=301,zonematch="*/*/*/Wizard's Sanctum",nofly=1},
...
-- == SHIPS/ZEPPELINS == --
	...
	"Stormwind City 49.6,86.5 <region:sw_wizardsanctum> @sw_tp_dst",
	"Stormwind City 49.29,86.99 <region:sw_wizardsanctum> <radius:2> -x- Stormwind City 49.51,86.70 <radius:2> {template:custom} {atob:Exit Mage Tower} {btoa:Enter Mage Tower}", -- mage tower entrance
...
-- MAGE TELEPORTS:
	...
	"Stormwind City 49.6,86.5 <region:sw_wizardsanctum>	<spell:3561>   <faction:A>",
...
data.portkeys = { -- smile if you're a muggle
	...
	{spell=556, destination="HEARTH", destA="@!sw_tp_dst", destH="@!org_tp_dst", is_astral=1, cost=30}, -- Astral Recall. Usually is hearthlocation, but a glyph can change that.

	{item=110560, destination="G_HEARTH", cost=hearthcost, mode="ghearth", type="garrison_inn"}, -- Garri Hstone
