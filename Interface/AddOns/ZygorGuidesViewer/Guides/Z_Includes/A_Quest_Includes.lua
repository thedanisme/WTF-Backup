...
ZygorGuidesViewer:RegisterInclude("A_Twilight_Leveling",[[
	...
	step
		talk Anduin Wrynn##1747 |goto 85.7,31.6
	...
	step
		...
		collect 5 Missing Parts |q 27038/1 |goto 34.6,46.1
	step
	...
	step
		Enter the Cathedral |goto 52.9,51.0 < 5 |walk
		Follow the spiral ramp down |goto 51.3,44.3 < 5 
		Follow the stairs down |goto 53.2,42.6 < 5 
		kill The Black Bishop##44816 |q 27092/1 |goto 50.6,42.2
	step
	...
	step
		...
		kill Samuelson Unmasked##45014 |q 27106/2 |goto 85.1,31.0
	step
		talk King Varian Wrynn##29611
