...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dungeon Guides\\Classic Dungeons\\Shadowfang Keep (SFK) 17-23",{
mapid=764,
achieveid={631},
author="support@zygorguides.com",
...
_Follow_ the path |goto Shadowfang Keep/1 58.5,63.8 < 8 |noway |c
step
...
_Follow_ the path |goto Shadowfang Keep/1 38.3,39.0 < 5 |c |noway
step
map Shadowfang Keep/2
path follow loose; loop off; ants curved
path	61.3,11.9	54.1,14.9	45.2,35.9
path	38.8,54.7
_Follow_ the path |goto Shadowfang Keep/2 38.8,54.7 < 8 |c |noway
step
...
kill 1 Baron Silverlaine##3887 |q Armored to the Teeth##27920/1 |goto Shadowfang Keep/2 31.2,73.3 |only if havequest(27920)
...
_Go down_ the steps |goto Shadowfang Keep/7 25.0,75.2 |c |noway |or
confirm |or
step
map Shadowfang Keep/7
path follow loose; loop off; ants curved
path	28.6,74.6	39.6,79.1
_Follow_ the path |goto 39.6,79.1 |c |noway |or
confirm |or
step
talk Packleader Ivar Bloodfang##47006
...
_Follow_ the path |goto Shadowfang Keep/6 60.9,44.1 < 5 |c |noway
step
...
accept The Rise of Aku'mai##34672 |goto 48.45,12.03
...
step
label "start"
Press _I_ and queue for The Stockade or enter the dungeon with your group |goto The Stockade/1 50.1,68.1 |c |or
|confirm |or
step
...
Collect Lord Overheat's Fiery Core## |q By Fire Be Saved!##27737/1 |only if havequest(27737)
Defeat Lord Overheat |scenariogoal 24760 |goto 81.0,48.0
step
map The Stockade/1
path follow loose; loop off; ants curved
path	71.4,40.5	63.2,37.0	50.1,35.9
path	50.0,50.4
_Follow_ the path |goto 50.0,50.4 < 5 |c |noway |or
|confirm |or
step
talk Nurse Lillian##46410
...
step
talk Rifle Commander Coe##46417
turnin The Good Ol' Switcheroo##27733 |goto The Stockade 50.0,58.5
only if not completedq(27733)
step
map The Stockade/1
path follow loose; loop off; ants curved
path	50.1,36.4	35.0,35.1	25.4,29.7
_Follow_ the path |goto 25.4,29.7 < 5 |c |noway
step
kill 1 Hogger##46254 |only if default
...
kill 1 Hogger##46254 |q The Gnoll King##27739/1 |only if havequest(27739)
...
step
label	"start"
Press _I_ and queue for Gnomeregan or enter the dungeon with your group |goto Gnomeregan/1 64.3,29.0 |c |or
|confirm |or
step
talk Murd Doc##44556
