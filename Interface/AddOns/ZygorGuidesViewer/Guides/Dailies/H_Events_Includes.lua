...
ZygorGuidesViewer:RegisterInclude("H_Brewfest_Quests",[[
	...
	step
		...
		|tip You must be level 89 do complete this quest.
...
ZygorGuidesViewer:RegisterInclude("H_Brewfest_Dailies",[[
	...
	step
		...
		Earn the Down With the Dark Iron achievement |achieve 1683/4 |goto 41.5,17.7
	step
		talk Ram Master Ray##24497
...
ZygorGuidesViewer:RegisterInclude("H_Brewfest_Achievements",[[
	...
	step
		...
		achieve 1683/6 |goto 40.3,17.9
	step
		Go inside Orgrimmar |goto Orgrimmar |c
	step
		talk Ray'ma##27489
		turnin Brew of the Month Club##12306 |goto Orgrimmar 50.4,73.5
		Earn the Brew of the Month achievement |achieve 1683/2 |goto Orgrimmar 50.4,73.5
	step
