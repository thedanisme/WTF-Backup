...
ZygorGuidesViewer:RegisterInclude("A_Cenarion_Circle_Faction",[[
	...
	step
		...
		collect 4 Diseased Wolf Sample |q 26999/4 |goto 46.0,48.7
	step
		kill Plague Lurker##1824+
		collect 4 Plague Lurker Sample |q 26999/1 |goto 57.0,62.7
		kill Venom Mist Lurker##1822+
		collect 4 Venom Mist Lurker Sample |q 26999/2 |goto 57.0,62.7
	step
		talk Field Agent Kaartish##44454
...
ZygorGuidesViewer:RegisterInclude("A_Cenarion_Expedition_Faction",[[
	...
	step "unidentifiedplants"
		Kill all mobs in this area
		collect 10 Unidentified Plant Parts |q 9802/1 |goto 80.1,73.3
	step
		talk Lauranna Thar'well##17909
	...
	step
		click Winterfin Clam##261
		|tip They are on the ground underwater.
		collect 5 Winterfin Clam|q 11559/1 |goto 41.5,13.4
	step
		talk Ahlurglgr##25206
		turnin Winterfin Commerce##11559 |goto 43,13.8
	step
...
//borean//
	...
	step
		click Kaskala Supplies##644
		collect 8 Kaskala Supplies |q 11945/1 |goto 67.8,49.5
	step
		talk Utaik##26213
		turnin Preparing for the Worst##11945 |goto 64,45.7
//dragon//
...
ZygorGuidesViewer:RegisterInclude("A_Eastern_Plaguelands_Argent_Dawn_Revered",[[
	...
	step
		talk Fiona##45417
		turnin Into the Woods##27683 |only if havequest(27683) |goto Eastern Plaguelands,9.0,66.5
	...
	step
		_Enter_ the tunnel |goto 4.7,35.6 < 10 |walk
	...
	step
		_Enter_ the crypt |goto 24.2,78.5 < 10 |walk
	...
	step
		_Run up_ the path |goto 72.1,41.6 < 10 |only if walking
	...
	step
		_Run up_ the path |goto 58.9,20.4 < 10 |only if walking
	...
	step
		...
		collect The Baroness' Missive##61378 |n |goto 29.4,19.7
	...
	step
		...
		_Enter_ the Hallway and turn left |goto 20.1,59.5 < 10
		click Annals of the Silver Hand##8133
		collect Annals of the Silver Hand |q 28755/1 |repeatable |goto Stratholme,27.5,74.7
	step
		talk Lord Raymond George##49856
...
ZygorGuidesViewer:RegisterInclude("A_Zangarmarsh_Quests",[[
	...
	step
		...
		accept Escape from Umbrafen##9752 |goto 83.4,85.5
		Escort Kayra Longmane |q 9752/1 |goto 83.4,85.5
	step
		kill Kataru##18080 |q 9747/1 |goto 85.3,90.9
		|tip In the big building, all the way at the top.
	step
		...
		You can find more of them at the following location |goto Zangarmarsh 84,88.7
	step
		talk Ikeyen##17956
		turnin The Umbrafen Tribe##9747 |goto 80.4,64.2
		accept A Damp, Dark Place##9788 |goto 80.4,64.2
	...
	step
		...
		collect Ikeyen's Belongings |q 9788/1
	step
		_Follow_ the path |goto 72.5,94.0 |walk
		kill Lord Klaq##18282 |q 9894/1 
		|tip On the bottom level of the cave, in the small round room all the way in the back.
	...
	step
		talk Ikeyen##17956
		turnin A Damp, Dark Place##9788 |goto 80.4,64.2
		talk Lauranna Thar'well##17909 |goto 80.4,64.2
		turnin Plants of Zangarmarsh##9802 |goto 80.4,64.2
		turnin Saving the Sporeloks##10096 |goto 80.4,64.2
	step
		talk Warden Hamoot##17858
	...
	step
		...
		accept What's Wrong at Cenarion Thicket?##9957 |only if not completedq(9968) or not completedq(9971) |goto 78.5,63.1
	step
		talk Ysiel Windsinger##17841
		turnin Disturbance at Umbrafen Lake##9716 |goto 78.4,62
		accept As the Crow Flies##9718 |goto 78.4,62
		...
		Watch yourself fly as a crow
		Lakes of Zangarmarsh Explored |q 9718/1 |goto 78.4,62
	step
		talk Ysiel Windsinger##17841
		turnin As the Crow Flies##9718 |goto 78.4,62
		accept Balance Must Be Preserved##9720 |goto 78.4,62
	...
	step
		...
		Disable the Lagoon Pump Controls |q 9720/4 |goto 63.1,64.1
	step
		_Ride the elevator_ up to Telredor |goto 70.4,49.3 < 10 |only if walking
	...
	step
		...
		More spores and Marshfang Rippers can be found around the following location: |goto Zangarmarsh 67.6,54.1
	step
	...
	step
		Ride the elevator up to Telredor |goto 70.4,49.3 < 10
		talk Vindicator Idaar##18004
	...
	step
		...
		collect 8 Eel Filet|q 9780/1 |goto 74.2,60.7
		Lots of eels can be found in the water at theh following location |goto Zangarmarsh,74.5,73.4
	step
		_Go up_ the elevator |goto 70.4,49.3 < 10 |only if walking
		talk Vindicator Idaar##18004
	...
	step
		...
		More can be found at the following location |goto Zangarmarsh,67.8,74.7
	step
		_Go up_ the elevator |goto 70.4,49.3 < 10 |only if walking
		talk Ruam##18007
	...
	step
		_Follow_ the path |goto Zangarmarsh 44.5,66.1 < 10 |only if walking
	...
	step
		...
		collect 6 Fertile Spores##24449 |goto 36.9,58.0
		|tip Hold onto these, you will need them for a quest later.
	step
	...
	label "unfriendly"
		...
		collect 6 Bog Lord Tendril##24291 |only if rep ('Sporeggar')<=Unfriendly |goto 13.6,59.8
	step
		talk Fahssn##17923
		accept More Tendrils!##9744 |instant |only if rep('Sporeggar')<=Unfriendly |goto 19.1,63.9
		|next "routespore"
	step
	label "neutral"
		talk Msshi'fn##17924
	...
	step
		...
		You can find more at the following location |goto 31.3,37.7
		|only if rep ('Sporeggar')>=Neutral and not completedq(9808)
	step
		talk Msshi'fn##17924
	...
	step
		talk Fahssn##17923
		accept More Tendrils!##9744 |instant |goto 19.1,63.9
		|next "routespore"
	step
	label "friendly"
		talk Watcher Leesa'oh##17831
	...
	step
		...
		It can also be at the following location |goto 25.4,25.0
	step
	...
	step
		...
		You can find more Ogres at the following location |goto 36.0,32.0
	step
	...
	step
		...
		home Orebor Harborage |goto 41.9,26.2
	step
		talk Maktu##18010
		accept Natural Armor##9834 |goto 41.6,27.3
	step
	...
	step
		_Follow_ the path |goto 17.1,13.4 < 10 
	...
	step
		...
		More mobs and boxes can be found in the cave at the following location |goto Zangarmarsh,17.3,9.6
	step
		talk Puluu##18009
		turnin Stinger Venom##9830 |goto 40.8,28.7
		turnin Lines of Communication##9833 |goto 40.8,28.7
	...
	step
		Ride the elevator up to Telredor |goto 70.4,49.3 < 5 |only if walking
		talk Anchorite Ahuurn##18003
	...
	step
		...
		You can find more at the following location |goto 51.1,57.8
	step
		Ride the elevator up to Telredor |goto 70.4,49.3 < 5 |only if walking
		talk Anchorite Ahuurn##18003
	...
	step
		Drink Ahuurn's Elixir |use Ahuurn's Elixir##24428 |goto 44.6,66.1 < 5
...
ZygorGuidesViewer:RegisterInclude("A_Icecrown_Argent_Crusade_Rep",[[
	...
	step
		...
		Once you pick up a Captured Crusader, fly to the following location |goto 86.9,76.5 < 5
...
ZygorGuidesViewer:RegisterInclude("A_Cleansing_Drak_Tharon",[[
	...
	step
		...
		kill Drakkari Shaman##26639+, Drakarri Guardian##26620+, Drakarri Commander##27431+
		kill The Prophet Tharon'ja##26632 |n
		Use Drakuru's Elixir next to Drakuru's Brazier |use Drakuru's Elixir##35797 |goto Drak'Tharon Keep/2 38.2,13.2 < 5
...
ZygorGuidesViewer:RegisterInclude("A_Betrayal_Drakuru",[[
	...
	step
		kill Putrid Abominations##28564
	...
	step
		...
		Get teleported up to Overlord Drakuru |goto Zul'Drak 28.1,45.2 < 5
	...
	step
		...
		Teleport back down to the ground |goto Zul'Drak 28.1,44.9 < 5
	...
	step
		Stand on this green circle
		Get teleported up to Overlord Drakuru |goto Zul'Drak 28.4,44.9 < 5 |walk
		talk Overlord Drakuru##28503
		accept It Rolls Downhill##12673 |goto Zul'Drak 27.1,46.2
	step
		Stand on this green circle
		Teleport back down to the ground |goto Zul'Drak 28.4,44.9 < 5 |walk
	...
	step
		Use your Diluting Additive next to the big cauldron |use Diluting Additive##39154 
	...
	step
		Stand on this green circle 
		Get teleported up to Overlord Drakuru |goto Zul'Drak 28.4,44.9 < 5
		talk Overlord Drakuru##28503
	...
	step
		Stand on this green circle 
		Teleport back down to the ground |goto Zul'Drak 28.4,44.9 < 5
	...
	step
		...
		Teleport up to Drakuru's upper chamber |goto Zul'Drak 28.4,44.9 < 5 |walk
	...
	step
		...
		Stand on this green circle to go to the bottom level of Voltarus |goto Zul'Drak 28.4,44.9 < 5
		talk Overlord Drakuru##28503
	...
	step
		Stand on this blue circle
		Stand on this green circle to go to the bottom level of Voltarus |goto Zul'Drak 28.4,44.9 < 5 |walk
		talk Overlord Drakuru##28503
