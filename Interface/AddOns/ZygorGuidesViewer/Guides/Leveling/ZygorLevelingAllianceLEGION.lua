...
Havoc |confirm |or |only if not completedq(39247) |next "Havoc_Artifact"
Vengeance |confirm |or |only if not completedq(41863) |next "Vengeance_Artifact"
step
label "Havoc_Artifact"
talk Kayn Sunfury##99247
|tip You will only be able to accept one of these quests.
accept Making Arrangements##40819 |goto Dalaran L/10 75.0,49.0 |or |only if not completedq(44383)
accept Making Arrangements##41120 |goto Dalaran L/10 75.0,49.0 |or |only if not completedq(44383)
accept Making Arrangements##40819 |goto Mardum, the Shattered Abyss/1 58.62,57.81 |or |only if completedq(44383)
accept Making Arrangements##41120 |goto Mardum, the Shattered Abyss/1 58.62,57.81 |or |only if completedq(44383)
step
talk Kayn Sunfury##99247
|tip It may be Altruis the Sufferer.
turnin Making Arrangements##40819 |goto Dalaran L/10 65.65,67.30 |only if havequest(40819) or completedq(40819)
turnin Making Arrangements##41120 |goto Dalaran L/10 65.65,67.30 |only if havequest(41120) or completedq(41120)
|tip You will only be able to accept one of these quests.
...
Interrogate Taldath |q 39051/3 |goto The Violet Hold L/1 49.63,46.96 |only if havequest(39051) or completedq(39051)
Interrogate Taldath |q 41121/3 |goto The Violet Hold L/1 49.63,46.96 |only if havequest(41121) or completedq(41121)
step
talk Kayn Sunfury##99247
|tip It may be Altruis the Sufferer.
...
Destroy the First Ward |scenariogoal 3/28391 |count 1 |q 41119 |goto Suramar/0 28.16,64.48 |only if havequest(41119) or completedq(41119)
step
click Felshield Ward
|tip It's a tall object with a huge green crystal floating above it.
Destroy the Second Ward |scenariogoal 3/28391 |count 2 |q 39247 |goto Suramar/0 29.32,60.46 |only if havequest(39247) or completedq(39247)
Destroy the Second Ward |scenariogoal 3/28391 |count 2 |q 41119 |goto Suramar/0 29.32,60.46 |only if havequest(41119) or completedq(41119)
step
click Felshield Ward
|tip It's a tall object with a huge green crystal floating above it.
...
collect Twinblades of the Deceiver |q 39247/2 |goto 33.00,67.01 |only if havequest(39247) or completedq(39247)
collect Twinblades of the Deceiver |q 41119/2 |goto 33.00,67.01 |only if havequest(41119) or completedq(41119)
...
accept Asking a Favor##41803 |goto Mardum, the Shattered Abyss/1 58.62,57.81 |or |only if completedq(44383)
accept Asking a Favor##40247 |goto Mardum, the Shattered Abyss/1 58.62,57.81 |or |only if completedq(44383)
step
talk Archmage Khadgar##90417
turnin Asking a Favor##41803 |goto Dalaran L/10 28.50,48.32 |only if havequest(41803) or completedq(41803)
turnin Asking a Favor##40247 |goto Dalaran L/10 28.50,48.32 |only if havequest(40247) or completedq(40247)
...
|only if havequest(39800) or completedq(39800)
step
click Skyfire Parachute |goto 48.28,16.94 < 5
|tip Downstairs in the airship. Follow the bouncing white arrows.
kill Deathweaver Cassandra##93560
Defeat the Captain of The Banshee's Wail |scenariogoal 3/28014 |q 39800 |goto 53.93,43.55
|only if havequest(39800) or completedq(39800)
step
click Donovan |goto 52.96,43.33 > 50
kill Cauldronmaster Mills##93563
Defeat the Captain of The Black Rose |scenariogoal 3/28015 |q 39800 |goto 48.25,52.39
|only if havequest(39800) or completedq(39800)
step
click Donovan |goto 48.91,51.45 > 50
...
Remove #7# Volatile Flares |scenariogoal 4/31425 |q 39800 |goto 69.29,70.94
|only if havequest(39800) or completedq(39800)
step
...
accept An Important Mission##42814 |goto Dalaran L/10 57.57,45.75
|only Warrior
step
talk Danath Trollbane##96183
turnin An Important Mission##42814 |goto 74.60,44.97
accept Return to the Broken Shore##42815 |goto 74.60,44.97
|only Warrior
step
clicknpc Elite Gryphon##108973
Take the Flight to the Broken Shore |q 42815/1 |goto 74.50,44.16
|only Warrior
step
Begin the Second Battle of the Broken Shore Scenario |scenariostart |q 42815
|only Warrior
step
Meet up with the Vrykul |scenariostage 1 |goto 1031 50.46,28.36 |q 42815
|only Warrior
step
Kill enemies around this area
Eliminate the Legion Forces |scenariostage 2 |goto 50.73,28.91 |q 42815
|only Warrior
step
Watch the dialogue
Approach Danica |scenariostage 3 |goto 51.28,30.40 |q 42815
|only Warrior
step
kill Bezzeredes##98257
Kill enemies around this area
Defeat Bezzeredes and His Allies |scenariostage 4 |goto 50.24,31.02 |q 42815
|only Warrior
step
Watch the dialogue
kill Malgalor##92608
Defeat Malgalor |scenariostage 5 |goto 49.63,32.53 |q 42815
|only Warrior
step
Watch the dialogue
Prove your Valor on the Broken Shore |q 42815/2 |goto 49.63,32.53
|only Warrior
step
talk Danica the Reclaimer##93823
turnin Return to the Broken Shore##42815 |goto Skyhold/1 58.99,29.83
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Warrior" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Warrior"
...
accept Stormheim##39735 |or |goto 59.21,12.65 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Paladin" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Paladin"
...
accept Stormheim##39735 |or |goto 53.46,78.59 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Hunter" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Hunter"
...
accept Hunter to Hunter##41009 |goto Dalaran L/10 69.70,43.09
|only Hunter
step
talk Emmarel Shadewarden##102478
|tip Inside the building.
...
accept On Eagle's Wings##40953 |goto Dalaran L/10 60.05,53.46 |next "Hunter_Lodge"
|only Hunter
step
...
accept Stormheim##39735 |or |goto 42.5,46.8 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Rogue" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Rogue"
...
accept Stormheim##39735 |or |goto 37.11,45.04 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Priest" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Priest"
...
accept Stormheim##39735 |or |goto 48.90,48.00 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Shaman" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Shaman"
...
accept Stormheim##39735 |or |goto 33.54,59.21 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Mage" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Mage"
...
accept Stormheim##39735 |or |goto 81.38,60.95 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Warlock" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Warlock"
...
|only Warlock
step
Run down the stairs |goto 45.87,69.05 < 10
Continue down the stairs |goto 45.61,69.08 > 1000
...
|only Warlock
step
Follow the path down |goto 53.16,45.91 < 15
Follow the path |goto 45.15,38.35 < 20
...
Follow the path up |goto 39.37,47.32 < 20
Follow the path up |goto 52.75,39.60 < 15
...
accept Stormheim##39735 |or |goto 66.25,46.98 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Monk" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Monk"
...
|only Monk
step
click Barrel of Odd Smelling Brew##6478
...
accept Stormheim##39735 |or |goto 52.92,60.16 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_Druid" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_Druid"
...
click Flask of Moonwell Water##6478
...
accept Stormheim##39735 |or |goto 52.68,51.16 |only if not completedq(39735)
...
_Choose What to Do Next:_
|tip Click the line below for the activity you would like to do.
Pursue Artifact Weapons |next "Artifacts_DeathKnight" |only if level >= 102
Choose Next Leveling Zone |next "Choose_Leveling_Zone_DeathKnight"
...
accept Stormheim##39735 |or |goto 49.81,51.35 |only if not completedq(39735)
...
step
talk Aerylia##96679
Travel to Dalaran |q 39735/1 |goto Skyhold/1 58.32,24.99
|only if havequest(39735) and ZGV:RaceClassMatch("Warrior")
step
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto Eastern Plaguelands/20 37.60,64.05
|only if havequest(39735) and ZGV:RaceClassMatch("Paladin")
step
click Portal to Dalaran
|tip Upstairs.
Travel to Dalaran |q 39735/1 |goto Trueshot Lodge/0 48.6,43.4
|only if havequest(39735) and ZGV:RaceClassMatch("Hunter")
step
click Knocker |goto Dalaran L/4 39.67,21.45 |n
Leave the Hall of Shadows |goto Dalaran L/4 39.67,21.45 > 1000 |noway |c |q 39735
|only if havequest(39735) and ZGV:RaceClassMatch("Rogue")
step
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto Netherlight Temple/1 49.77,80.74
|only if havequest(39735) and ZGV:RaceClassMatch("Priest")
step
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto The Maelstrom L/0 29.82,51.97
|only if havequest(39735) and ZGV:RaceClassMatch("Shaman")
step
Run up the stairs |goto Hall of the Guardian/1 76.23,66.25 < 10
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto Hall of the Guardian/1 57.38,90.35
|only if havequest(39735) and ZGV:RaceClassMatch("Mage")
step
Follow the path |goto 1050 67.31,37.09 < 20
...
step
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto The Wandering Isle L/0 52.39,57.15
|only if havequest(39735) and ZGV:RaceClassMatch("Monk")
step
Follow the path up |goto The Dreamgrove/0 56.23,48.67 < 10
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto The Dreamgrove/0 56.53,43.10
|only if havequest(39735) and ZGV:RaceClassMatch("Druid")
step
click Portal to Dalaran
Travel to Dalaran |q 39735/1 |goto Broken Shore/2 24.71,33.69
|only if havequest(39735) and ZGV:RaceClassMatch("DeathKnight")
step
talk Sky Admiral Rogers##96644
|tip Inside the building.
turnin Stormheim##39735 |goto Dalaran L/10 29.09,46.87
...
kill Forsaken Dreadwings
|tip The guns will get frozen.  When this happens, kill the Icebound Dreadnought that appears on the ship deck.
Shoot Down 30 Forsaken Dreadwings |scenariostage 2 |goto 31.96,8.43 |q 39800
|only if havequest(39800) or completedq(39800)
step
click Skyfire Parachute |goto 48.28,16.94 < 5
|tip Downstairs in the airship. Follow the bouncing white arrows.
...
accept Retake Faronaar##36811 |goto 41.24,50.51
step
_Next to you:_
...
accept Missing Demon##42238 |goto 50.41,30.76
step
talk Marius Felbane##106915
accept Felblaze Ingress##42372
step
talk Dagrona##90556
...
click Cracked Ley Crystal##6478
...
step
click Courtship Rituals of the Skrog##6478
...
step
click Draconic Compendium, Volume III##6478
...
accept Plunder the Cove##37495 |goto 43.77,24.70 |goto Azsuna/18 43.89,24.67
...
step
accept Shipwrecked Sailors##42220 |goto 57.98,58.55
|tip You will accept this quest automatically.
...
kill 10 Queen's Reprisal Sailor##89290+ |q 42220/1 |goto 60.90,58.94
|tip They're undead enemies mixed in with the enemies around this area.
step
Click the Complete Quest Box:
turnin Shipwrecked Sailors##42220
step
...
accept Fate of the Queen's Reprisal##40794 |goto 65.69,56.93
step
talk Mr. Shackle##91419
...
Sigh Daglop's Contract |q 38460/1 |goto 61.84,51.15
step
talk Daglop##91166
|tip He walks along this road, so you may have to search for him.
...
accept Those Beyond Redemption##37963 |goto 53.37,16.25
...
accept A Tainted Vintage##37965 |goto 47.42,12.46
|tip You will accept this quest automatically.
step
...
turnin Fate of the Queen's Reprisal##40794 |goto Dalaran L/10 28.68,74.81
|next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Legion Intro & Artifacts" |only not raceclass("DemonHunter")
|next "Zygor's Alliance Leveling Guides\\Starter Guides\\Demon Hunter Intro & Artifacts" |only raceclass("DemonHunter")
]])
...
accept Moonclaw Vale##39393 |goto 61.02,73.26
...
step
Enter the cave |goto 62.01,86.00 < 20 |walk
...
step
Follow the path up |goto 59.98,83.56 < 20 |walk
Follow the path |goto 60.96,85.10 < 20 |walk
Follow the path |goto 61.97,87.22 < 20 |walk
...
accept Defend The Temple##39029 |goto 51.44,57.00
...
Meet Tyrande in Shadowfen |q 41708/1 |goto 66.93,50.13 |only if havequest(41708)
Meet Tyrande in Shadowfen |q 41890/1 |goto 66.93,50.13 |only if havequest(41890)
step
talk Tyrande Whisperwind##104739
Kill the enemies that attack in waves
Guard Tyrande During Her Vigil |q 41708/2 |goto 66.93,50.13 |only if havequest(41708)
Guard Tyrande During Her Vigil |q 41890/2 |goto 66.93,50.13 |only if havequest(41890)
step
Watch the dialogue
...
click Shadowfen Heirlooms##6478
...
Watch the dialogue
|tip Follow Tyrande Whisperwind.
Follow Malfurion's Trail |q 38675/1 |goto 66.24,44.76 |only if havequest(38675)
Follow Malfurion's Trail |q 41724/1 |goto 66.24,44.76 |only if havequest(41724)
step
...
stickystart "Corrputed_Petals"
step
Follow the path |goto 65.82,40.94 < 15 |only if walking
Enter the cave |goto 66.59,36.60 < 10 |walk
kill Varethos##92989 |q 41749/1 |goto 68.73,35.33 |only if havequest(41749)
kill Varethos##92989 |q 41893/1 |goto 68.73,35.33 |only if havequest(41893)
step
label "Corrputed_Petals"
...
step
Watch the dialogue
Follow Tyrande into Shala'nir |q 38687/1 |goto 62.74,39.01 |only if havequest(38687)
Follow Tyrande into Shala'nir |q 41763/1 |goto 62.74,39.01 |only if havequest(41763)
step
clicknpc Malfurion Stormrage##111258
|tip Inside the building.
Search for Malfurion at the Inn |q 38687/2 |goto 63.02,36.87 |only if havequest(38687)
Search for Malfurion at the Inn |q 41763/2 |goto 63.02,36.87 |only if havequest(41763)
step
Follow the path |goto 62.04,36.83 < 15 |only if walking
click Malfurion Stormrage##111260
Search for Malfurion near the Lake |q 38687/3 |goto 62.43,33.15 |only if havequest(38687)
Search for Malfurion near the Lake |q 41763/3 |goto 62.43,33.15 |only if havequest(41763)
step
click Malfurion Stormrage##111259
Search for Malfurion in the Village |q 38687/4 |goto 59.11,32.55 |only if havequest(38687)
Search for Malfurion in the Village |q 41763/4 |goto 59.11,32.55 |only if havequest(41763)
step
Find Malfurion |q 38687/5 |goto 58.38,37.84 |only if havequest(38687)
Find Malfurion |q 41763/5 |goto 58.38,37.84 |only if havequest(41763)
step
...
accept Black Rook Hold##38716 |goto 40.18,51.37
|tip You will accept this quest automatically.
step
...
step
click Tears of Elune
turnin The Tears of Elune##40890 |goto Dalaran L/12 45.86,65.15
|next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Legion Intro & Artifacts" |only not raceclass("DemonHunter")
|next "Zygor's Alliance Leveling Guides\\Starter Guides\\Demon Hunter Intro & Artifacts" |only raceclass("DemonHunter")
]])
...
accept Defend the Riverlands##39274 |goto 41.13,61.57
...
accept Echoes of Deathwing##39576 |goto 43.23,28.19
accept In Defiance of Deathwing##40219 |goto 43.23,28.19
stickystart "ExploreVault"
step
...
step
Cross the bridge |goto 58.55,64.46 < 20 |only if walking
Follow the path |goto 55.85,63.18 < 20 |only if walking
...
Sit on the Throne of Ordering Around |q 40339/1 |goto 55.33,42.53
step
...
step
click Throne of Ordering Around
Sit on the Throne of Ordering Around |q 40345/1 |goto 55.33,42.53
step
...
step
Cross the bridge |goto 51.56,38.35 < 15 |only if walking
Cross the bridge |goto 58.85,14.79 < 15 |only if walking
Follow the path |goto Highmountain/0 48.73,54.46 < 20 |only if walking
Follow the path |goto Thunder Totem/0 39.67,2.80 < 20 |only if walking
Cross the river |goto Highmountain/0 42.20,52.84 < 20 |only if walking
talk Tamara Sigmund##94973
fpath Nesingwary |goto Highmountain/0 40.23,52.71
step
talk Hemet Nesingwary##94409
turnin Rating Razik##39417 |goto 40.04,52.25
accept Amateur Hour##40170 |goto 40.04,52.25
step
...
step
Follow the path |goto 41.05,70.28 < 15 |walk
...
step
Follow the path up |goto 46.39,24.87 < 15 |only if walking
Cross the bridge |goto 47.21,25.07 < 15 |only if walking
...
step
Feed Murky |q 40049/1 |count 1 |goto 42.09,9.17
|tip Walk into the glowing plant on the ground.
step
Feed Murky |q 40049/1 |count 2 |goto 42.73,8.87
|tip Walk into the glowing plant on the ground.
step
Feed Murky |q 40049/1 |count 3 |goto 43.06,9.51
|tip Walk into the glowing plant on the ground.
step
Feed Murky |q 40049/1 |count 4 |goto 43.58,9.97
|tip Walk into the glowing plant on the ground.
step
Feed Murky |q 40049/1 |count 5 |goto 43.80,9.00
|tip Walk into the glowing plant on the ground.
step
Feed Murky |q 40049/1 |count 6 |goto 43.56,8.10
|tip Walk into the glowing plant on the ground.
step
...
Follow the path up |goto Thunder Totem/0 56.22,58.44 < 20 |only if walking
...
accept Neltharion's Lair##39781 |goto 53.20,70.02
|next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Legion Intro & Artifacts" |only not raceclass("DemonHunter")
|next "Zygor's Alliance Leveling Guides\\Starter Guides\\Demon Hunter Intro & Artifacts" |only raceclass("DemonHunter")
]])
...
step
talk Sky Admiral Rogers##90749
turnin Greymane's Gambit##39800 |goto Stormheim/0 33.71,51.02 |only if havequest(39800) or completedq(39800)
accept Boarded!##38052 |goto Stormheim/0 33.71,51.02
step
talk Tinkmaster Overspark##90866
accept Assault and Battery##38053 |goto 33.61,50.84
accept See Ya Later, Oscillator##38558 |goto 33.61,50.84
step
talk Mishka##90783
accept Supplies From the Skies##38036 |goto 33.75,50.76
step
talk Donovan##98114
fpath Skyfire Triage Camp |goto 33.59,50.65
stickystart "Forsaken"
step
click Skyfire Medical Supplies
|tip They look like wooden crates with red crosses on them in the water and on the ship.
collect 5 Skyfire First Aid Kit##123876 |q 38036/1 |goto 35.04,53.64
step
kill Dread-Rider Malwick##90902
|tip At the top of the ship.
collect Transponder Battery##122295 |q 38053/1 |goto 35.35,54.06
step
click Crystal Oscillator
collect Crystal Oscillator##123887 |q 38558/1 |goto 33.65,57.24
step
label "Forsaken"
Kill enemies around this area
Slay #8# Forsaken |q 38052/1 |goto 35.04,53.64
step
Follow the path up |goto 33.72,52.72 < 20 |only if walking
talk Sky Admiral Rogers##90749
turnin Boarded!##38052 |goto 33.71,51.02
step
talk Mishka##90783
turnin Supplies From the Skies##38036 |goto 33.75,50.76
step
talk Tinkmaster Overspark##90866
turnin Assault and Battery##38053 |goto 33.61,50.84
turnin See Ya Later, Oscillator##38558 |goto 33.61,50.84
accept Lightning Rod##38058 |goto 33.61,50.84
step
talk Mishka##90783
accept The Lost Legion##38057 |goto 33.76,50.78
step
Follow the path up |goto 32.62,51.93 < 20 |only if walking
Follow the path up |goto 31.70,54.90 < 20 |only if walking
Enter the cave |goto 31.38,57.43 > 5000 |walk
talk Knight-Captain Rhodes##92414
turnin The Lost Legion##38057 |goto Stormheim/9 77.25,48.41
accept Pins and Needles##38059 |goto Stormheim/9 77.25,48.41
stickystart "Charge_Transponder"
step
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 1 |goto 69.67,65.63
step
Follow the path |goto 62.66,66.27 < 15 |walk
Follow the path down |goto 41.22,84.02 < 15 |walk
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 2 |goto 26.70,65.47
step
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 3 |goto 25.54,47.39
step
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 4 |goto 45.19,66.97
step
Follow the path |goto 44.33,53.92 < 15 |walk
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 5 |goto 54.16,32.15
step
label "Charge_Transponder"
Kill enemies around this area
...
Charge the Transponder |q 38058/1 |goto 29.60,63.47
step
Click the Quest Complete Box:
turnin Lightning Rod##38058
accept Signal Boost##38060
step
Follow the path up |goto 56.66,29.93 < 20 |walk
Leave the cave |goto 60.05,12.80 > 2000 |walk
talk 7th Legion Dragoon##90948
Free the 7th Legion Dragoon |q 38059/1 |count 6 |goto Stormheim/0 30.26,53.01
step
Click the Quest Complete Box:
turnin Pins and Needles##38059
step
click Skyfire Propeller
Start the Distress Signal |q 38060/1 |goto 32.41,49.87
step
Kill the enemies that attack in waves
Defend the Transponder |q 38060/2 |goto 32.24,49.78
step
talk Sky Admiral Rogers##90749
turnin Signal Boost##38060 |goto 33.81,46.03
step
talk Muninn##97306
accept The Ancient Trials##38210 |goto 33.74,45.84
step
click Stormforged Grapple Launcher
accept Stormforged Grapple Launcher##39775 |goto 33.82,45.76
step
Follow the path down |goto 34.54,45.74 < 20 |only if walking
Follow the path down |goto 38.04,45.48 < 30 |only if walking
Continue down the path |goto 39.84,48.36 < 20 |only if walking
Follow the path down |goto 40.48,50.55 < 20 |only if walking
talk Havi##96254
turnin The Ancient Trials##38210 |goto 43.17,49.16
accept Havi's Test##38331 |goto 43.17,49.16
step
...
Add the Root Vegetables |q 38331/1 |goto 42.90,49.09
step
click Barrel of Crabs
|tip Aim for the Stew Pot next to the camp fire nearby, then use the ability on your action bar.
Add the Crabs |q 38331/2 |goto 42.90,49.35
step
click Hearty Vrykul Grains
|tip Aim for the Stew Pot next to the camp fire nearby, then use the ability on your action bar.
Add the Hearty Grains |q 38331/3 |goto 43.07,49.42
step
talk Havi##96254
turnin Havi's Test##38331 |goto 43.17,49.16
accept A Worthy Challenger##38442 |goto 43.17,49.16
accept Ahead of the Game##39590 |goto 43.17,49.16
stickystart "Worthy_Challenger"
step
kill Bloodtotem Skirmisher##96229
|tip You will accept the quest automatically after looting him.
accept Blood and Gold##39595 |goto 42.94,47.41
...
step
Follow the path up |goto 44.90,46.94 < 20 |only if walking
Follow the path up |goto 43.24,47.93 < 20 |only if walking
talk Havi##96254
turnin The Blessing of the Watchers##39597 |goto 43.17,49.16
accept Will of the Thorignir##38473 |goto 43.17,49.16
step
Cross the bridge |goto 42.75,59.20 < 20 |only if walking
talk Commander Lorna Crowley##91222
turnin Will of the Thorignir##38473 |goto 37.38,63.83
accept A Grapple a Day##38312 |goto 37.38,63.83
step
talk Donovan##98113
fpath Lorna's Watch |goto 37.41,63.99
step
talk Commander Lorna Crowley##91481
turnin A Grapple a Day##38312 |goto 42.01,64.49
accept No Wings Required##38318 |goto 42.01,64.49
accept To Weather the Storm##38405 |goto 42.01,64.49
step
click Grapple Point
|tip It's on top of the wall nearby, with a bouncing yellow arrow floating above it.
Grapple over the Wall |q 38318/1 |goto 42.02,64.48
step
accept Assault the Drekirjar##38374 |goto 42.88,64.85
|tip You will accept this quest automatically.
step
kill Stormwing Drake##91202
|tip You will accept the quest automatically after looting.
accept Built to Scale##38337 |goto 43.16,64.59
stickystart "Built_to_Scale"
stickystart "Assault_the_Drekirjar"
step
Follow the path up |goto 44.91,65.36 < 20 |only if walking
click Oiled Cloak##3365
collect Oiled Cloak##122686 |q 38405/3 |goto 45.68,66.63
step
kill Stormbreaker Reykir##91517
|tip Inside of the building.
collect Enchanted Lodestone##124038 |q 38405/1 |goto 43.97,66.95
step
Follow the path up |goto 42.56,66.91 < 20 |only if walking
click Climbing Treads##3365
|tip Inside the tent.
collect Climbing Treads##122685 |q 38405/2 |goto 41.85,68.42
step
label "Built_to_Scale"
kill Stormwing Drake##91202+
collect 50 Storm Drake Scale##122610 |q 38337/1 |goto 44.37,69.00
step
...
|only if havequest(38374)
step
talk Commander Lorna Crowley##91519
|tip Next to the wall, behind a big rock.
turnin No Wings Required##38318 |goto 43.77,68.23
turnin To Weather the Storm##38405 |goto 43.77,68.23
accept Impalement Insurance##38410 |goto 43.77,68.23
turnin Built to Scale##38337 |goto 43.77,68.23
step
click Tideskorn Harpoon Launcher
|tip Click the Grapple Point on top of the wall nearby to reach it.
Destroy the Harpoon Launcher |q 38410/1 |count 1 |goto 43.50,68.10
step
click Tideskorn Harpoon Launcher
Destroy the Harpoon Launcher |q 38410/1 |count 2 |goto 44.25,67.92
step
click Tideskorn Harpoon Launcher
|tip Click the Grapple Point on top of the wall nearby to reach it.
Destroy the Harpoon Launcher |q 38410/1 |count 3 |goto 44.96,68.08
step
click Tideskorn Harpoon Launcher
Destroy the Harpoon Launcher |q 38410/1 |count 4 |goto 45.62,68.57
step
click Tideskorn Harpoon Launcher
|tip Click the Grapple Point on top of the wall nearby to reach it.
Destroy the Harpoon Launcher |q 38410/1 |count 5 |goto 46.04,69.45
step
click Tideskorn Harpoon Launcher
Destroy the Harpoon Launcher |q 38410/1 |count 6 |goto 46.13,71.06
step
click Tideskorn Harpoon Launcher
|tip Click the Grapple Point on top of the wall nearby to reach it.
Destroy the Harpoon Launcher |q 38410/1 |count 7 |goto 45.95,71.63
step
Follow the path |goto 46.28,71.21 < 10 |only if walking
talk Commander Lorna Crowley##91553
turnin Impalement Insurance##38410 |goto 46.25,70.38
accept Another Way##38342 |goto 46.25,70.38
step
kill Gunnlaug Scaleheart##91240 |q 38342/1 |goto 46.34,72.27
step
Climb the Tower |q 38342/2 |goto 45.68,72.96
|tip Go to the top of the tower.
step
_Next to you:_
talk Commander Lorna Crowley##91558
turnin Another Way##38342
accept Above the Winter Moonlight##38412
step
click Grapple Point
|tip It's on the cliff ledge nearby.
Grapple to the Mountain Path |q 38412/1 |goto 45.95,73.30
step
...
Grapple across the Chasm |goto 48.78,75.97 < 5 |noway |c |q 38412
step
click Grapple Point |goto 48.07,76.83 |n
|tip It's across the chasm.
Grapple across the Chasm |goto 47.28,76.60 < 5 |noway |c |q 38412
step
click Grapple Point |goto 46.45,76.64 |n
|tip It's on top of the huge rock if you're looking west from here.
Grapple onto the Rock |goto 45.89,76.35 < 5 |noway |c |q 38412
step
click Grapple Point |goto 45.89,76.35 |n
|tip It's to the northwest on the rocks.
Grapple Further up the Mountain |goto 45.23,75.59 < 5 |noway |c |q 38412
step
click Grapple Point |goto 45.23,75.59 |n
|tip It's further up the rocks.
Grapple Further up the Mountain |goto 44.86,75.55 < 5 |noway |c |q 38412
step
click Grapple Point |goto 44.86,75.55 |n
|tip It's to the southwest.
Grapple across the Path |goto 44.34,76.37 < 5 |noway |c |q 38412
step
click Grapple Point |goto 44.34,76.37 |n
|tip It's up on the wooden bridge.
Grapple onto the Bridge |goto 43.70,76.72 < 5 |noway |c |q 38412
step
Reach the Top of the Path |q 38412/2 |goto 44.51,77.58
step
talk Vethir##91249
turnin Above the Winter Moonlight##38412 |goto 44.79,77.43
...
Cross the bridge |goto 45.16,53.04 < 20 |only if walking
Follow the path |goto 43.94,46.11 < 20 |only if walking
Follow the path up |goto 42.09,42.49 < 20 |only if walking
Follow the path |goto 41.58,39.33 < 10 |only if walking
...
step
Jump down the waterfall |goto 47.67,62.37 < 15 |only if walking
Follow the path |goto 49.50,63.47 < 20 |only if walking
Follow the path |goto 55.47,67.87 < 20 |only if walking
Follow the path |goto 56.79,71.53 < 20 |only if walking
kill Stout Highlands Runehorn##107852+
|tip Watch out for the Highlands Ettins that patrols around this area.
...
step
talk Ensign Ward##94346
accept To Catch a Banshee##39059 |goto 59.97,51.36
step
...
accept Piercing the Mists##43596 |goto 58.95,42.84
step
...
Follow the path up |goto 70.97,61.74 < 15 |only if walking
click Forsaken Battle Plans
accept Cut Out the Heart##39472 |goto 72.40,61.05
step
Use your Blazing Torch |use Blazing Torch##127295
Burn the Western Plague Cache |q 39060/3 |goto 72.64,60.78
step
Use your Blazing Torch |use Blazing Torch##127295
Burn the Eastern Plague Cache |q 39060/2 |goto 73.49,63.13
step
Use your Blazing Torch |use Blazing Torch##127295
Burn the Northern Plague Cache |q 39060/1 |goto 74.46,58.33
step
Follow the path |goto 75.17,60.54 < 20 |only if walking
kill Apothecary Curseheart##93987 |q 39472/1 |goto 75.05,61.98
step
label "Forsaken_Scouting_Orders"
Kill enemies around this area
collect Forsaken Scouting Orders##127285 |q 39061/1 |goto 74.67,60.20
step
Follow the path |goto 72.19,59.30 < 15 |only if walking
talk Genn Greymane##94318
turnin Combustible Contagion##39060 |goto 71.53,59.83
turnin Whispers from the Dark##39061 |goto 71.53,59.83
turnin Cut Out the Heart##39472 |goto 71.53,59.83
accept To Skold-Ashil##39062 |goto 71.53,59.83
step
Follow the path |goto 69.62,61.31 < 20 |only if walking
Follow the path |goto 65.21,62.33 < 20 |only if walking
talk Commander Lorna Crowley##93779
turnin To Skold-Ashil##39062 |goto 63.56,61.73
accept Assault on Skold-Ashil##39119 |goto 63.56,61.73 |only if level < 110
accept Shielded Secrets##39063 |goto 63.56,61.73
stickystart "Skold-Ashil"
step
Follow the path down |goto 63.14,61.68 < 10 |only if walking
click Engraved Shield
|tip Inside the building.
Examine the Engraved Shield |q 39063/1 |count 1 |goto 63.39,64.65
step
click Ashilvara. Verse 1
accept Stories of Battle##39405 |goto 63.45,64.74
stickystart "Verses_of_Ashilvara"
step
click Engraved Shield
Examine the Engraved Shield |q 39063/1 |count 2 |goto 62.16,65.10
step
click Engraved Shield
Examine the Engraved Shield |q 39063/1 |count 3 |goto 61.48,63.31
step
click Engraved Shield
Examine the Engraved Shield |q 39063/1 |count 4 |goto 61.29,61.87
step
click Engraved Shield
|tip Inside the building.
Examine the Engraved Shield |q 39063/1 |count 5 |goto 60.48,60.04
step
Follow the path |goto 59.69,61.68 < 15 |only if walking
click Engraved Shield
|tip Inside the building.
Examine the Engraved Shield |q 39063/1 |count 6 |goto 58.48,63.68
step
...
step
talk Commander Lorna Crowley##95921
turnin Shielded Secrets##39063 |goto 60.58,65.10
accept Becoming the Ascendant##39092 |goto 60.58,65.10
step
click Eyir's Shield##6478
Collect Eyir's Shield |q 39092/3 |goto 60.46,66.73
step
click Eyir's Spear##6478
Collect Eyir's Spear |q 39092/4 |goto 61.34,66.72
step
click Eyir's Helm##6478
Collect Eyir's Helm |q 39092/1 |goto 61.34,69.51
step
click Eyir's Pauldron##6478
Collect Eyir's Pauldron |q 39092/2 |goto 60.47,69.51
step
click Statue
Watch the dialogue
Commune with the Statue |q 39092/5 |goto 61.82,68.11
step
label "Skold-Ashil"
Kill enemies around this area
...
Complete the Assault on Skold-Ashil |q 39119/1 |goto 61.25,64.58
|only if level < 110
step
talk Genn Greymane##95804
turnin Becoming the Ascendant##39092 |goto 62.30,68.10
accept Ending the New Beginning##39122 |goto 62.30,68.10
step
Enter the building |goto 63.21,68.11 > 1000 |walk
Follow Greymane |q 39122/1 |goto Stormheim/28 43.87,50.86
step
talk Commander Lorna Crowley##95932
turnin Ending the New Beginning##39122 |goto Stormheim/0 71.46,60.58
step
talk Sir Finley Mrrgglton##108072
accept The Mystery of Dreyrgrot##42635 |goto Stormheim/0 74.91,55.58
accept A Stone of Blood##42639 |goto Stormheim/0 74.91,55.58
step
...
turnin Put It All on Red##42483 |goto 51.42,57.35
|next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Legion Intro & Artifacts" |only not raceclass("DemonHunter")
|next "Zygor's Alliance Leveling Guides\\Starter Guides\\Demon Hunter Intro & Artifacts" |only raceclass("DemonHunter")
]])
...
kill Fal'dorei Reaver##107853 |q 42226/3 |goto 17.70,38.11
...
|tip Wait until the guard with the red circle around it walks away a bit, so you don't get detected.
...
step
talk Hymdall##107987
turnin To the Summit!##42110 |goto 55.93,84.43
|only Warrior
step
...
|only Warrior
stickystart "Preparing_For_War_Warrior"
step
...
|only Warrior
step
label "Preparing_For_War_Warrior"
click Eye of Odyn
...
|only Paladin
stickystop "World_Quests_Paladin"
stickystop "Lumenstones_Paladin"
step
Follow the path |goto Val'sharah/0 54.96,53.43 < 20 |only if walking
Follow the path |goto Val'sharah/0 52.81,50.41 < 20 |only if walking
Cross the bridge |goto Val'sharah/0 46.98,50.23 < 20 |only if walking
...
|only Paladin
step
Run up the stairs |goto Dalaran L/10 35.07,62.49 < 10 |walk
Follow the path |goto Dalaran L/10 36.71,57.55 < 10 |walk
click Portal to Netherlight Temple
Take the Portal to Netherlight Temple in Dalaran |q 43700/1 |goto Dalaran L/10 39.54,57.28
|only Paladin
step
...
Click Here After You Begin the Mission |confirm |goto 42.50,46.63 |q 42402
|only Hunter
step
Use the Call to Xe'ra ability
|tip It appears as a button on the screen.
...
step
talk Advisor Sevel##96746
turnin Worldmender##42988 |goto 33.03,60.42
|only Shaman
step
...
|only Mage
step
Run up the stairs |goto 76.22,66.78 < 15 |walk
...
|only Mage
step
Run down the stairs |goto 58.18,64.74 < 15 |walk
Run down the stairs |goto 57.68,71.47 > 10000 |walk
...
|tip She appears next to you in Dalaran.
|tip You will only be able to accept one of these quests.
accept Return to the Fel Hammer##44087 |goto Dalaran L/10 58.18,45.37
accept Return to the Fel Hammer##42666 |goto Dalaran L/10 58.18,45.37
|only DemonHunter
step
Glide to the floating island nearby |goto 77.58,47.92 < 10 |only if walking
click Illidari Gateway
Take the Illidari Gateway |q 44087/1 |goto 98.04,69.35
Take the Illidari Gateway |q 42666/1 |goto 98.04,69.35
|only DemonHunter
step
...
click Theryssia
|tip It looks like a silver name palte on the side of the gravestone.
...
step
click Light's Heart
turnin Awakenings##44464 |goto 58.68,43.64
|only DemonHunter
step
talk Aludane Whitecloud##96813
...
|only DemonHunter
step
Follow the path up |goto 49.32,53.74 > 10000 |walk
Follow the path |goto Mardum, the Shattered Abyss/1 48.99,41.49 < 15 |walk
click Light's Heart
accept An Unclear Path##44466 |goto Mardum, the Shattered Abyss/1 58.65,43.40
|only DemonHunter
step
Follow the path |goto Val'sharah/0 54.96,53.43 < 20 |only if walking
Follow the path |goto Val'sharah/0 53.29,49.94 < 20 |only if walking
...
Begin the "Troops in Training" Mission
|tip This mission will take 4 hours to complete.
Click Here to Continue while the You Wait on the Mission |confirm |goto 66.26,46.95 |q 42602
|only Warlock
step
talk Archmage Khadgar##90417
|tip Inside the building.
...
step
talk Ritssyn Flamescowl##105018
turnin An Unclaimed Soul##42098 |goto 55.27,37.13
...
accept Champion: Hamuul Runetotem##42047 |instant |goto The Dreamgrove/0 47.98,55.57
|only Druid
step
talk Mylune##107026
...
step
talk Rensar Greathoof##101195
turnin The Emerald Nightmare##42432 |goto 44.66,51.97
|only Druid
step
talk Highlord Darion Mograine##93437
