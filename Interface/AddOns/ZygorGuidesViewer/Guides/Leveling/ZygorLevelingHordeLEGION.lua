...
Complete Greymane's Mission |q 39800/1 |goto 70.70,76.23 |next Zygor's Horde Leveling Guides\\Legion (100-110)\\Stormheim (100-)
...
step
click Portal to Dalaran
Travel to Dalaran |q 39718/1 |goto 1057 29.82,51.97
...
step
click Portal to Dalaran
Travel to Dalaran |q 39731/1 |goto 1057 29.82,51.97
...
step
talk Aludane Whitecloud##96813
Tell him _"Aludance, I have urgent business in Val'sharah. Can you secure a flight for me?"_
...
Follow the path |goto 1050 67.31,37.09 < 20
click Portal to Dalaran
Travel to Dalaran |q 39864/1 |goto 1050 74.39,38.17
|only if havequest(39864) and ZGV:RaceClassMatch("Warlock")
step
click Portal to Dalaran
...
collect Dim Ley Crsytal##122188 |q 37859/1 |goto 49.67,15.36
...
|tip Inside the building.
turnin Fate of the Queen's Reprisal##42244 |goto Dalaran L/10 61.11,16.99
|next "Zygor's Horde Leveling Guides\\Legion (100-110)\\Legion Intro & Artifacts" |only not raceclass("DemonHunter")
|next "Zygor's Horde Leveling Guides\\Starter Guides\\Demon Hunter Intro & Artifacts" |only raceclass("DemonHunter")
]])
...
step
talk Elothir##92783
accept Reading the Leaves##38684 |goto 66.09,44.13
|tip You will only be able to accept one of these quests.
accept Given to Corruption##41749 |or |goto 66.09,44.13
accept Given to Corruption##41893 |or |goto 66.09,44.13
step
Kill enemies around this area
click Bloodflowers
...
Follow the path |goto 65.82,40.94 < 15 |only if walking
talk Elothir##92783
turnin Reading the Leaves##38684 |goto 66.09,44.13
turnin Given to Corruption##41749 |goto 66.09,44.13 |only if havequest(41749) or completedq(41749)
turnin Given to Corruption##41893 |goto 66.09,44.13 |only if havequest(41893) or completedq(41893)
step
talk Tyrande Whisperwind##104728
...
accept Illidari Freedom##38719 |goto 42.97,81.91
step
...
accept A Worthy Challenger##38442 |goto 41.84,43.06
...
Follow the path up |goto 551.68,76.53 < 10 |only if walking
...
accept Raze Hel##38343 |goto Helheim/0 65.53,47.07
...
accept Assault on Skold-Ashil##38939 |goto 56.78,66.31
...
step
Watch the dialogue
talk Vethir##97979 |goto 70.46,69.49 |n
Fly with Vethir |goto 70.46,69.49 > 70 |noway |c |q 40005
step
talk Havi##97988
