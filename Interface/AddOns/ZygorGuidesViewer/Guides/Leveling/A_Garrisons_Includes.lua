...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Aenir",[[ --Alchemy Lab
		talk Aenir##82466 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Aenir##82466 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Aenir##82466 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Aerun",[[ --Tailoring Emporium
		talk Aerun##84776 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Aerun##84776 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Aerun##84776 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Longstitch",[[ --Tannery
		talk Anders Longstitch##77383 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Anders Longstitch##77383 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Anders Longstitch##77383 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Kern",[[ --Mage Tower
		talk Archmage Kern##77367 |goto Lunarfall/0 45.2,42.2 |only if garrisonlvl(1)
		talk Archmage Kern##77367 |goto Lunarfall/0 45.6,40.5 |only if garrisonlvl(2)
		talk Archmage Kern##77367 |goto Lunarfall/0 42.3,48.7 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Auria",[[ --The Forge
		talk Auria Irondreamer##77359 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Auria Irondreamer##77359 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Auria Irondreamer##77359 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Ayada",[[ --Enchanter's Study
		talk Ayada the White##77354 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Ayada the White##77354 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Ayada the White##77354 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Budd",[[ --Lunarfall Inn
		--Starts daily dungeon "Budd's Gambit"
		talk Budd##88017 |goto Lunarfall/0 34.9,49.5 |only if garrisonlvl(2)
		talk Budd##88017 |goto Lunarfall/0 42.3,48.7 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_MacD",[[ --Tailoring Emporium
		--Tailoring recipe vendor
		talk Christopher Macdonald##77382 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Christopher Macdonald##77382 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Christopher Macdonald##77382 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Highwall",[[ --Gem Boutique
		--Jewelcrafting recipe vendor
		talk Costan Highwall##77356 |goto Lunarfall/0 50.9,57.4 |only if garrisonlvl(1)
		talk Costan Highwall##77356 |goto Lunarfall/0 48.5,58.6 |only if garrisonlvl(2)
		talk Costan Highwall##77356 |goto Lunarfall/0 49.1,60.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Budd",[[ --Lunarfall Inn
		--Starts daily dungeon "The Huntress" and "Fate of the Fallen"
		talk Cowled Ranger##88003 |goto Lunarfall/0 34.9,49.5 |only if garrisonlvl(2)
		talk Cowled Ranger##88003 |goto Lunarfall/0 42.3,48.7 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Eileese",[[
		--Only appears if player is an enchanter. Ends "Enchanted Highmaul Bracer" and starts "The Arakkoan Enchanter"
		talk Eileese Shadowsong##83491 |goto Lunarfall/0 49.6,42.6 |only if garrisonlvl(1)
		talk Eileese Shadowsong##83491 |goto Lunarfall/0 45.99,54.0 |only if garrisonlvl(2)
		talk Eileese Shadowsong##83491 |goto Lunarfall/0 45.99,54.0 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Muradin",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Lioness",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Nixxie",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Morthis",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Mailbox",[[
		click Mailbox |goto Lunarfall/0 42.3,52.2 |only if garrisonlvl(1)
		click Mailbox |goto Lunarfall/0 36.2,37.1 |only if garrisonlvl(2)
		click Mailbox |goto Lunarfall/0 36.9,36.1 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Cache",[[
		click Garrison Cache |goto Lunarfall/0 49.2,43.7 |only if garrisonlvl(1)
		click Garrison Cache |goto Lunarfall/0 37.9,31.4 |only if garrisonlvl(2)
		click Garrison Cache |goto Lunarfall/0 36.9,36.1 |only if garrisonlvl(3)-------
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Maraad",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Brightstone",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Zipfizzle",[[
		talk Foreman Zipfizzle##81912 |goto Lunarfall/0 44.3,51.1 |only if garrisonlvl(1)
		talk Foreman Zipfizzle##81912 |goto Lunarfall/0 42.3,48.9 |only if garrisonlvl(2)
		talk Foreman Zipfizzle##81912 |goto Lunarfall/0 42.1,48.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Tilnia",[[
		talk Watchman Tilnia##86589 |goto Lunarfall/0 45.9,46.2 |only if garrisonlvl(1)
		talk Watchman Tilnia##86589 |goto Lunarfall/0 42.3,48.9 |only if garrisonlvl(2)--
		talk Watchman Tilnia##86589 |goto Lunarfall/0 46.1,45.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_LtThorn",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_PGrounds",[[
		|goto Lunarfall/0 40.2,53.6 < 80 |c |noway |only if garrisonlvl(1)
		|goto Lunarfall/0 31.1,32.9 < 80 |c |noway |only if garrisonlvl(2)
		|goto Lunarfall/0 28.7,35.1 < 80 |c |noway |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Inkeeper",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_BAlexston",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Shelly",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Akama",[[
		talk Exarch Akama##80078 |goto Lunarfall/0 44.3,49.9 |only if garrisonlvl(1)
		talk Exarch Akama##80078 |goto Lunarfall/0 42.2,49.6 |only if garrisonlvl(2)
		talk Exarch Akama##80078 |goto Lunarfall/0 42.0,49.5 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_QMoonshadow",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_DonjonRade",[[
		talk Nexus-Lord Donjon Rade##84970 |goto Lunarfall/0 47.9,52.4 |only if garrisonlvl(1)
		talk Nexus-Lord Donjon Rade##84970 |goto Lunarfall/0 48.5,48.3 |only if garrisonlvl(2)
		talk Nexus-Lord Donjon Rade##84970 |goto Lunarfall/0 48.4,48.4 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_KenLoggin",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_BGrey",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_DLongdrink",[[ --Flight Master
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_AZerep",[[
		talk Arsenio Zerep##801593 |goto Lunarfall/0 48.91,41.10 |only if garrisonlvl(1)
		talk Arsenio Zerep##80159 |goto Lunarfall/0 37.4,63.7 |only if garrisonlvl(2)
		talk Arsenio Zerep##80159 |goto Lunarfall/0 37.4,63.7 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Yrel",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_CFelsong",[[
		talk Cordana Felsong##80645 |goto Lunarfall/0 43.8,44.3 |only if garrisonlvl(1)
		talk Cordana Felsong##80645 |goto Lunarfall/0 43.1,44.7 |only if garrisonlvl(2)
		talk Cordana Felsong##80645 |goto Lunarfall/0 43.2,44.6 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_BBoard",[[
		click Bounty Board## |goto Lunarfall/0 42.9,44.5 |only if garrisonlvl(1)
		click Bounty Board## |goto Lunarfall/0 42.7,44.8 |only if garrisonlvl(2)
		click Bounty Board## |goto Lunarfall/0 42.7,44.8 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_BlueprintVendor",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Warplans",[[
		_You don't have access to Garrison dailies until Garrison level 2!_ |only if garrisonlvl(1)
		click War Planning Map |goto Lunarfall/0 30.7,31.8 |only if garrisonlvl(2)
		click War Planning Map |goto Lunarfall/0 31.5,31.0 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_ScoutValdez",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Crowler",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Dorn",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Valdez",[[
...
-----------------------------------------------
---------GARRISON BUILDING COORDINATES---------
-----------------------------------------------

ZygorGuidesViewer:RegisterInclude("A_Garrison_Small_Building",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Finalize_Small",[[
		click Finalize Garrison Plot |goto Lunarfall/0 47.6,59.0 |only if ZGV.Garrison_GetBuildingLocation("%building%")==18
		click Finalize Garrison Plot |goto Lunarfall/0 49.2,58.2 |only if ZGV.Garrison_GetBuildingLocation("%building%")==19
		click Finalize Garrison Plot |goto Lunarfall/0 50.5,64.0 |only if ZGV.Garrison_GetBuildingLocation("%building%")==20
		click Finalize Garrison Plot |goto Lunarfall/0 47.6,59.0 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])



ZygorGuidesViewer:RegisterInclude("A_Garrison_Medium_Building",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Finalize_Medium",[[
		click Finalize Garrison Plot |goto Lunarfall/0 36.4,49.3 |only if ZGV.Garrison_GetBuildingLocation("%building%")==22
		click Finalize Garrison Plot |goto Lunarfall/0 50.9,47.6 |only if ZGV.Garrison_GetBuildingLocation("%building%")==25
		click Finalize Garrison Plot |goto Lunarfall/0 50.9,47.6 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])



ZygorGuidesViewer:RegisterInclude("A_Garrison_Large_Building",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Finalize_Large",[[
		click Finalize Garrison Plot |goto Lunarfall/0 44.4,45.2 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		click Finalize Garrison Plot |goto Lunarfall/0 44.9,43.9 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		click Finalize Garrison Plot |goto Lunarfall/0 40.6,55.7 |only if ZGV.Garrison_GetBuildingLocation("%building%")==24
		click Finalize Garrison Plot |goto Lunarfall/0 44.4,45.2 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_ListofIngredients",[[
		click List of Ingredients |goto Lunarfall/0 48.39,40.97 |only if garrisonlvl(1)
		click List of Ingredients|goto Lunarfall/0 44.3,53.9 |only if garrisonlvl(2)
		click List of Ingredients|goto Lunarfall/0 44.3,53.9 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Hearthstone",[[
		|goto Lunarfall/0 42.6,52.8 < 50 |only if garrisonlvl(1)
		|goto Lunarfall/0 32.3,31.7 < 175 |only if garrisonlvl(2)
		|goto Lunarfall/0 29.9,33.9 < 200 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_HerbGarden",[[
		|goto Lunarfall/0 65.2,41.9 |only if garrisonlvl(2)
		|goto Lunarfall/0 58.9,53.5 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Menagerie",[[
		|goto Lunarfall/0 65.2,41.9 |only if garrisonlvl(2)
		|goto Lunarfall/0 28.7,39.1 |only if garrisonlvl(3)
]])



ZygorGuidesViewer:RegisterInclude("A_Garrison_LunarfallExcavation_Talk",[[
		talk %npc% |goto Lunarfall/0 65.2,41.9 |only if garrisonlvl(2)
		talk %npc% |goto Lunarfall/0 65.0,42.0 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_LunarfallExcavation_Finalize",[[
		click Finalize Garrison Plot |goto Lunarfall/0 66.3,40.5 
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_LunarfallExcavation_EnterMine",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_LunarfallExcavation_LeaveMine",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Fishing_Talk",[[
		talk %npc% |goto Lunarfall/0 54.6,14.9 |only if garrisonlvl() >= 2
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_Fishing_Finalize",[[
		click Finalize Garrison Plot |goto Lunarfall/0 54.4,15.5 
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])



ZygorGuidesViewer:RegisterInclude("A_Garrison_HerbGarden_Talk",[[
		talk %npc% |goto Lunarfall/0 58.9,53.4 |only if garrisonlvl() >= 2
]])

ZygorGuidesViewer:RegisterInclude("A_Garrison_HerbGarden_Finalize",[[
		click Finalize Garrison Plot |goto Lunarfall/0 58.7,52.2 
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])
...
---GARRISON FOLLOWERS---
------------------------
ZygorGuidesViewer:RegisterInclude("A_Follower_Weldon_Barov",[[
...
ZygorGuidesViewer:RegisterInclude("A_Garrison_Campaign",[[
	step
	label "Menu"
...
---//Garrison Campaign: Seismic Matters\\--
	...
	step "Siegework"
		...
		click Secret Warplans |tip They look like paper maps on the ground with daggers stabbed into them all around this area.
	...
	step
		click Prototype Mole Machine |goto Frostfire Ridge/0 86.4,49.0 
...
---//Garrison Campaign: Bloodmaul Compound\\--
	...
	step
		click Owynn's Noggenknocker##3365
	...
	step
		click Borgal's Spiritbinder Totems 
...
ZygorGuidesViewer:RegisterInclude("A_Brawler's_Guild",[[
	--Rank 1--
	step
...
ZygorGuidesViewer:RegisterInclude("A_Inn_Quests",[[
--- Auchindoun ---
	...
	step
		...
		collect Nightmare Bell##118648 |q Go Fetch##37146/1 |goto Auchindoun/0 65.0,55.0
	step
	...
	step
		...
		|only if havequest(37146) or havequest(37156) or havequest(37154)
	step
		#include "A_Garrison_Medium_Building", action="talk Johnny Awesome##88022", building="Inn"
	...
	step
		#include "A_Garrison_Medium_Building", action="talk Lilian Voss##87996", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin The Soulcutter##37156
	step
		#include "A_Garrison_Medium_Building", action="talk Leonid Barthalomew the Revered##87997", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Bloodmaul Slag Mines ---
	...
	step
		...
		|only if havequest(37152) or havequest(37153)
	step
		#include "A_Garrison_Medium_Building", action="talk Cro Threadstrong##87991", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Cro's Revenge##37152
	step
		#include "A_Garrison_Medium_Building", action="talk Olaf##87992", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Grimrail Depot ---	
	...
	step
		...
		|only if havequest(37167) or havequest(37160) or havequest(37151)
	step
		#include "A_Garrison_Medium_Building", action="talk Lonika Stillblade##88006", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin And No Maces!##37167
	step
		#include "A_Garrison_Medium_Building", action="talk Gamon##88007", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Cleaving Time##37160
	step
		#include "A_Garrison_Medium_Building", action="talk John J. Keeshan##88026", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Iron Docks ---
	...
	step
		...
		|only if havequest(37155) or havequest(37157)
	step
		#include "A_Garrison_Medium_Building", action="talk Fleet Master Seahorn##87995", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin The Brass Compass##37155
	step
		#include "A_Garrison_Medium_Building", action="talk Moroes##87994", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Shadowmoon Burial Grounds ---
	...
	step
		...
		|only if havequest(37149) or havequest(37164) or havequest(37163)
	step
		#include "A_Garrison_Medium_Building", action="talk Impsy##88027", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin The Void-Gate##37149
	step
		#include "A_Garrison_Medium_Building", action="talk Highlord Darion Mograine##88002", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Shadowy Secrets##37163
	step
		#include "A_Garrison_Medium_Building", action="talk Cowled Ranger##88003", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Skyreach ---
	...
	step
		...
		|only if havequest(37147) or havequest(37159) or havequest(37158)
	step
		#include "A_Garrison_Medium_Building", action="talk Taoshi##88023", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Sky Dancers##37147
	step
		#include "A_Garrison_Medium_Building", action="talk Skylord Omnuron##87999", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Aviana's Request##37159
	step
		#include "A_Garrison_Medium_Building", action="talk Sunwalker Dezco##87998", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- The Everbloom ---
	...
	step
		...
		|only if havequest(37166) or havequest(37165) or havequest(37150)
	step
		#include "A_Garrison_Medium_Building", action="talk Mylune##88025", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin For the Birds##37150
	step
		#include "A_Garrison_Medium_Building", action="talk Lorewalker Cho##88005", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Titanic Evolution##37166
	step
		#include "A_Garrison_Medium_Building", action="talk Zen'kiki##88004", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
...
--- Upper Blackrock Spire ---
	...
	step
		...
		|only if havequest(37161) or havequest(37162) or havequest(37148) or havequest(37179)
	step
		#include "A_Garrison_Medium_Building", action="talk Finkle Einhorn##88000", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Family Traditions##37161
	step
		#include "A_Garrison_Medium_Building", action="talk Maximillian of Northshire##88001", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
		turnin Damsels and Dragons##37162
	step
		#include "A_Garrison_Medium_Building", action="talk Oralius##88024", building="Inn"
		|tip If you can't find them, check upstairs and in the basement of the inn. The door to the basement is in the kitchen of the Lunarfall Inn.
