...
do
	local function __genOrderedIndex( t )
		...
		if key~="__orderedIndex" then table.insert( orderedIndex, key ) end
	    end
	...
	local function orderedNext(t, state)
		...
		-- OH NO WE DON'T. This abomination dies, NOW. -- sinus 2015-08-24
		...
		if state == nil then
			...
			__orderindices[t] = __genOrderedIndex( t )
...
do
	local function __genOrderedIndexClean(t,orderedIndex)
	...
	function ZGV.OrderedPairsClean(t,indextemp)
		__orderindices[t] = __genOrderedIndexClean(t,indextemp)
		return orderedNext, t, nil
	end
