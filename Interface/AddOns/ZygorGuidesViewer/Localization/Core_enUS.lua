...
--]]
	...
	["opt_group_display_desc"] = "Main window display preferences and behaviour.",
		...
		['opt_hideinlinetravel'] = "Hide detailed walking directions",
		['opt_hideinlinetravel_desc'] = "Don't show walking directions in the step, to keep it compact.\nThe arrow and map markers will guide you instead.",
...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	--['opt_group_mapinternal'] = "Internal waypointer",
		...
		['opt_poienabled'] = "Enable Points of Interest System",
		...
		['opt_poishow'] = "Select POI types",
		['opt_poishow__desc'] = "",
		['opt_poishow_rare'] = "Show rare spawns",
		['opt_poishow_rare_desc'] = "",
		['opt_poishow_treasure'] = "Show treasures",
		['opt_poishow_treasure_desc'] = "",
		['opt_poishow_battlepet'] = "Show battle pets",
		['opt_poishow_battlepet_desc'] = "",
		['opt_poishow_achievement'] = "Show achievements",
		...
		['opt_poitype'] = "POI Display Type",
		['opt_poitype_desc'] = "",
		['opt_poitype_quick'] = "Quick Access Mode",
	...
	--['opt_group_gold_desc'] = "These options control the behaviour of Zygor Gold Guides.",
		...
		["opt_gold_tooltips_show"] = "Enable Zygor item tooltips",
		...
		["opt_gold_tooltips_out"] = "General display mode",
		["opt_gold_tooltips_out_desc"] = "Zygor item tooltips when not using Auction House",
	...
	['opt_group_gear'] = "Gear Suggestions",
	...
	['opt_autogear'] = "Enable Gear Suggestions",
	['opt_autogear_desc'] = "Reminds you to upgrade your gear as new items are acquired.\nNote: enabling this requires a reload.",
	['opt_autogearauto'] = "Auto-equip gear upgrades",
	['opt_autogearauto_desc'] = "Upgrades are equipped without confirmation.",
	['opt_gear_advanced'] = "Suggest gear from:",
	['opt_autogear_protectheirlooms'] = "Do not replace valid heirlooms",
	['opt_autogear_protectheirlooms_desc'] = "If player is within level range of equipped heirloom, that heirloom will not be replaced.",	
	...
	['opt_questitemselector'] = "Highlight suggested quest rewards",
	...
	['opt_gearshowallstats'] = "Show all stats, including unused",

	['opt_gearimport'] = "Import",
	['opt_gearexport'] = "Export",

	["gear_score_header"] = "Item Scoring",
	...
	['frame_hideinlinetravel_on'] = "Precise travel directons: on",
	['frame_hideinlinetravel_gooff'] = "<<Click>> to disable.",
	['frame_hideinlinetravel_off'] = "Precise travel directons: off",
	['frame_hideinlinetravel_goon'] = "<<Click>> to enable.",
