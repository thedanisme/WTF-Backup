...
function Menu:CreateFrame()
	...
	FR.VersionNum = CHAIN(FR:CreateFontString())
		...
		:SetJustifyV("CENTER")
		:SetFont(FONT,12)
		:SetText(ZGV.version)	.__END
	FR.PoweredBy = CHAIN(FR:CreateFontString())
		:SetPoint("LEFT",FR.VersionNum,"RIGHT",3,0)
		:SetJustifyH("LEFT")
		:SetJustifyV("CENTER")
		:SetFont(FONT,12)
		:SetText("- Powered by")
	.__END
	FR.GFU = CHAIN(FR:CreateFontString())
		:SetPoint("LEFT",FR.PoweredBy,"RIGHT",3,0)
		:SetJustifyH("LEFT")
		:SetJustifyV("CENTER")
		:SetFont(FONT,12) :SetTextColor(0,1,0)
		:SetText("Guidesfrom.us")
