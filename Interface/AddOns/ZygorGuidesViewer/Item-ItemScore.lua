...
local function ItemScore_SetTooltipData(tooltip, ...)
	if not ItemScore.TooltipPatched then
		...
		if score>0 and (equippedscore>0 or equippedscore2>0) then
			tooltip:AddLine("|cfffe6100Zygor ItemScore:|r "..score.." ("..equippedscore..(equippedscore2>0 and ","..equippedscore2 or "")..") "..color..diffscore..(equippedscore2>0 and ","..diffscore2 or ""))
		elseif score>0 then
