...
function Popup:AdjustSize()
	...
	local height = offsets + self.text:GetStringHeight() + self.text2:GetStringHeight() + self.text3checkbox:GetStringHeight() + self.logo:GetHeight() + self.acceptbutton:GetHeight()
