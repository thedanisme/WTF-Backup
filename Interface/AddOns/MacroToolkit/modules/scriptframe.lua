...
function MT:CreateScriptFrame()
	local mtsf = CreateFrame("Frame", "MacroToolkitScriptFrame", UIParent, "ButtonFrameTemplate")
	...
	local mtsexit = CreateFrame("Button", "MacroToolkitScriptExit", mtsf, "UIPanelButtonTemplate")
	mtsexit:SetText(_G.EXIT)
	mtsexit:SetSize(80, 22)
	mtsexit:SetPoint("BOTTOMRIGHT", -5, 4)
	mtsexit:SetScript("OnClick", HideParentPanel)
	
	local mtsdel = CreateFrame("Button", "MacroToolkitScriptDelete", mtsf, "UIPanelButtonTemplate")
	...
	local mtsscrollbg = CreateFrame("Frame", "MacroToolkitScriptScrollBg", mtsf)
	...
	local mtsscroll = CreateFrame("ScrollFrame", "MacroToolkitScriptScroll", mtsf, "UIPanelScrollFrameTemplate")
	mtsscroll:SetSize(589, 230)
	mtsscroll:SetPoint("TOPLEFT", mtsscrollbg, 6, -8)
	
	local mtsscrollchild = CreateFrame("EditBox", "MacroToolkitScriptText", mtsf)
	...
	local mtserrorbg = CreateFrame("Frame", "MacroToolkitScriptErrorBg", mtsf)
	...
	local mtserrorscroll = CreateFrame("ScrollFrame", "MacroToolkitScriptErrors", mtsf, "UIPanelScrollFrameTemplate")
	mtserrorscroll:SetSize(589, 76)
	mtserrorscroll:SetPoint("TOPLEFT", mtserrorbg, 6, -8)
	
	local mtsescrollchild = CreateFrame("EditBox", "MacroToolkitScrollErrorText", mtsf)
	...
	local mtstextbutton = CreateFrame("Button", "MacroToolkitScriptFocus", mtsf)
	...
	local mtssave = CreateFrame("Button", "MacroToolkitScriptSave", mtsf, "UIPanelButtonTemplate")
