...
function MT:CreateBindingFrame()
	local frame = CreateFrame("Button", "MacroToolkitBindingFrame", UIParent)
	...
	local button1 = CreateFrame("Button", "MacroToolkitBindButton1", frame, "UIPanelButtonTemplate")
	...
	local button2 = CreateFrame("Button", "MacroToolkitBindButton2", frame, "UIPanelButtonTemplate")
	...
	frame.profile = CreateFrame("CheckButton", "MacroToolkitBindingProfile", frame, "UICheckButtonTemplate")
	...
	local cancel = CreateFrame("Button", "MacroToolkitBindingCancel", frame, "UIPanelButtonTemplate")
	...
	local ok = CreateFrame("Button", "MacroToolkitBindingOk", frame, "UIPanelButtonTemplate")
	ok:SetText(_G.OKAY)
	ok:SetSize(80, 22)
	...
	frame.unbindbutton = CreateFrame("Button", "MacroToolkitUnbind", frame, "UIPanelButtonTemplate")
