...
function MT:CreateRestoreFrame()
	...
	local mtrfrestore = CreateFrame("Button", "MacroToolkitRestoreRestore", mtrf, "UIPanelButtonTemplate")
	...
	local mtrfcancel = CreateFrame("Button", "MacroToolkitRestoreCancel", mtrf, "UIPanelButtonTemplate")
	...
	local mtrfdelete = CreateFrame("Button", "MacroToolkitRestoreDelete", mtrf, "UIPanelButtonTemplate")
