...
function MT:CreateMTFrame()
	...
	local mtcustomflyout = CreateFrame("Button", "MacroToolkitFlyout", mtframe)
	...
	local mtscrollchild = CreateFrame("Frame", "MacroToolkitButtonContainer", MacroToolkitButtonScroll)
