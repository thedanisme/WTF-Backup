local L = LibStub("AceLocale-3.0"):NewLocale("MacroToolkit", "itIT")
...
L["Enhanced macro frame with additional tools"] = "Maggiore frame macro con strumenti aggiuntivi" -- Needs review
