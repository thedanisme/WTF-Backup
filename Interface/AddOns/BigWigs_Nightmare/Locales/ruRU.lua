...
if L then
	L.custom_off_gaze_assist = "Помощник Пристального взгляда"
	L.custom_off_gaze_assist_desc = "Отображать рейдовые метки на полосах таймера и сообщениях для Пристального взгляда. Используются {rt4} для нечетных и {rt6} для четных взглядов. Требуется быть помощником или лидером рейда."
end
