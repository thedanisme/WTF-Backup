...
hopAddon.hostFrame.buttonHost:SetScript("OnClick", function(self)
...
local function Hosting_OnZoneEvent(newZone)
	...
	if hopAddon.var.hosting then
		...
		and (lastTimeSuggestedZone[hopAddon.var.currentZone] == nil or GetTime() - lastTimeSuggestedZone[hopAddon.var.currentZone] > 900) then
