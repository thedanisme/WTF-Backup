...
L.BossmodsGorefiendWithClicking = "<开关-允许点选目标>"
...
L.TimerSpecTimerDefault = "重置特殊计时"
L.TimerSpecTimerHeader = "特殊计时器:"
PH.TimerUseDptInstead = "使用动态计时器代替默认 (输入命令 \"/rt pull\" 或点击标记助手)"
...
L.AttendanceHelpNames = "2 和 3 在任何副本团队列显示出席人数, 4 and 5 在第一个团队列显示出席人数 (4 代表史诗难度, 6 代表其他难度)"
L.ProfilesIntro = "你可以通过选择配置方案,为每个角色设定不同的配置"
L.ProfilesDefault = "默认"
L.ProfilesChooseDesc = "在框架内创建一个新的配置方案或选择一个配置方案"
