...
PH.BossmodsMalkorokSkadaTooltip = "스카다 애드온을 위한 모듈입니다. 실제 치유량 표시 (녹색 방패 |TInterface\\Icons\\ability_malkorok_blightofyshaarj_green:0|t\|cff00ff00강력한 고대의 방벽|r 대상에게 준 모든 치유량은 초과치유가 됩니다)"
...
PH.BossWatcherOptionNoBuffsTooltip = "버프와 디버프 - 많은 양의 메모리 소모의 주된 요인"
