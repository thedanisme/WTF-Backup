...
-- L["STRING_MEDIA"] = ""
-- L["STRING_MELEE"] = ""
L["STRING_MEMORY_ALERT_BUTTON"] = "Ho capito" -- Needs review
L["STRING_MEMORY_ALERT_TEXT1"] = "Details! utilizza un sacco di memoria, ma, |cFFFF8800contrariamente alla credenza popolare|r, l'utilizzo della memoria da addons |cFFFF8800non influisce|r nel nulla le prestazioni del gioco o il vostro FPS." -- Needs review
L["STRING_MEMORY_ALERT_TEXT2"] = "Quindi, se vedete Details! utilizzando grandi quantità di memoria, non fatevi prendere dal panico :D |cFFFF8800Va tutto bene|r, e, una parte di questa memoria è anche |cFFFF8800utilizzato in cache|r per rendere l'addon ancora più veloce." -- Needs review
L["STRING_MEMORY_ALERT_TEXT3"] = "Tuttavia, se è il vostro desiderio di conoscere |cFFFF8800che addons sono piu 'pesanti'|r o che sono in diminuzione più il vostro FPS, installare l'addon: '|cFFFFFF00AddOns Cpu Usage|r'." -- Needs review
L["STRING_MEMORY_ALERT_TITLE"] = "Si prega di leggere con attenzione!" -- Needs review
...
L["STRING_MINITUTORIAL_BOOKMARK1"] = "Tasto destro del mouse in un punto qualsiasi al di sopra della finestra per aprire i segnalibri!" -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK2"] = "Preferiti consente di accedere rapidamente alle schermate preferite." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK3"] = "asto destro del mouse per chiudere il pannello dei segnalibri." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK4"] = "Non mostrarlo più." -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL1"] = "|cFFFFFF00Ctrl + Right Click |r chiude la finestra!" -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL2"] = "Se si vuole riaprirla, andare a finestra di controllo nessun menu di modalità o Pannello Opzioni." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL1"] = "Quale finestra è in fase di modifica." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL2"] = "Se selezionata, tutte le finestre del gruppo vengono anche cambiati." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL3"] = [=[Per creare una finestra di gruppo, trascinare # 2 vicino alla finestra # 1.

Rompere un clic sul pulsante di gruppo separare.]=] -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Metti alla prova le tue barre di prova di configurazione creazione." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL5"] = "Durante la modifica di gruppo è attivata, tutte le finestre di un gruppo vengono modificati." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Selezionare qui che finestra che si desidera modificare l'aspetto." -- Needs review
