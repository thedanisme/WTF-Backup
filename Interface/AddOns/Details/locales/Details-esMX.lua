...
L["STRING_ACTORFRAME_NOTHING"] = "nada para informar" -- Needs review
...
L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Daño de Enemigo Recibido" -- Needs review
...
L["STRING_ATTRIBUTE_ENERGY"] = "Energía" -- Needs review
...
L["STRING_ATTRIBUTE_HEAL_ENEMY"] = "Curación de Enemigos" -- Needs review
...
L["STRING_MEMORY_ALERT_BUTTON"] = "Entendí" -- Needs review
L["STRING_MEMORY_ALERT_TEXT1"] = "Details! utiliza una gran cantidad de memoria, pero, |cFFFF8800contrariamente a la creencia popular de|r, el uso de memoria por los complementos |cFFFF8800no afecta|r en nada el rendimiento del juego o el FPS." -- Needs review
L["STRING_MEMORY_ALERT_TEXT2"] = "Por lo tanto, si usted ve Details! usando mucha memoria, no se asuste :D! |cFFFF8800Está todo bien|r y, una parte de esta memoria está aun |cFFFF8800utilizado en cachés|r para hacer el addon aún más rápido." -- Needs review
L["STRING_MEMORY_ALERT_TEXT3"] = "Sin embargo, si es su deseo de saber |cFFFF8800addons que son más 'pesado'|r o que están disminuyendo más su FPS, instale el complemento: '|cFFFFFF00AddOns Cpu Usage|r'." -- Needs review
L["STRING_MEMORY_ALERT_TITLE"] = "¡Por favor lea cuidadosamente!" -- Needs review
...
L["STRING_MINITUTORIAL_BOOKMARK1"] = "Haga clic derecho en cualquier punto sobre la ventana para abrir los marcadores!" -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK2"] = "Marcadores da acceso rápido a pantallas favoritas." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK3"] = "right click to close the bookmark panel." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK4"] = "No mostrar esto de nuevo." -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL1"] = "|cFFFFFF00Ctrl + Haga clic derecho |r cierra la ventana!" -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL2"] = "Si quieres volver a abrirlo, vaya a la ventana Control de ningún menú Mode o Panel de opciones." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL1"] = "Qué ventana se está editando." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL2"] = "Cuando está marcada, también se cambian todas las ventanas en el grupo." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL3"] = [=[Para crear una ventana de grupo, arrastre # 2 cerca de la ventana # 1.

Romper un clic en el botón de grupo desagrupar.]=] -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Pon a prueba tu configuración creando barras de ensayo." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL5"] = "Cuando Edición de grupo está habilitada, se cambian todas las ventanas en un grupo." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Seleccione aquí qué ventana desea cambiar la apariencia." -- Needs review
...
L["STRING_MODE_GROUP"] = "Grupo & Banda" -- Needs review
...
L["STRING_OPTIONS_BARS"] = "Configuración de barras" -- Needs review
...
L["STRING_OPTIONS_MENU_ATTRIBUTE_SIDE"] = "Ancla del texto" -- Needs review
...
L["STRING_OPTIONSMENU_ROWSETTINGS"] = "Configuración de filas" -- Needs review
...
L["STRING_OPTIONSMENU_WINDOW"] = "Configuración de ventana" -- Needs review
...
L["STRING_OPTIONS_PROFILE_POSSIZE_DESC"] = "Guardar la posición y el tamaño de las ventanas en el perfil." -- Needs review
...
L["STRING_OPTIONS_PROFILES_SELECT_DESC"] = "Cargar un otro perfil. Se sobrescriba toda la configuración con los valores del perfil seleccionado." -- Needs review
...
L["STRING_OPTIONS_ROW_SETTING_ANCHOR"] = "General:" -- Needs review
...
Para eliminar una ventana permanenemente, usar las opciones en la sección miscelánea.]=] -- Needs review
...
L["STRING_OPTIONS_WINDOW_TITLE"] = "Configuración de ventana" -- Needs review
...
-- L["STRING_WELCOME_1"] = ""
-- L["STRING_WELCOME_11"] = ""
L["STRING_WELCOME_12"] = "Cambiar la velocidad de acutalizaciones y animaciones. Si su computadora tiene menos de 2GB de memoria, se recomienda para reducir la cantidad de segmentos también." -- Needs review
L["STRING_WELCOME_13"] = ""
...
L["STRING_WELCOME_41"] = "Cambios de interfaz y memoria:" -- Needs review
