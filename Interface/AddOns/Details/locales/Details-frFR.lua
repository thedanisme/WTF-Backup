...
L["STRING_ACTORFRAME_NOTHING"] = "rien à rapporter" -- Needs review
...
-- L["STRING_ASCENDING"] = ""
L["STRING_ATACH_DESC"] = "La fenêtre #%d  fait le groupe avec la fenêtre #%d." -- Needs review
L["STRING_ATTRIBUTE_CUSTOM"] = "Personnalisé"
L["STRING_ATTRIBUTE_DAMAGE"] = "Dégat" -- Needs review
-- L["STRING_ATTRIBUTE_DAMAGE_BYSPELL"] = ""
L["STRING_ATTRIBUTE_DAMAGE_DEBUFFS"] = "Auras & Voidzones" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_DEBUFFS_REPORT"] = "Dégâts et Uptime des débuffs" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_DONE"] = "Dégâts infligés" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_DPS"] = "DPS" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Dégâts subis (ennemis)" -- Needs review
-- L["STRING_ATTRIBUTE_DAMAGE_ENEMIES_DONE"] = ""
L["STRING_ATTRIBUTE_DAMAGE_FRAGS"] = "Frags" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_FRIENDLYFIRE"] = "Dégâts aux alliés" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_TAKEN"] = "Dégâts Subis" -- Needs review
L["STRING_ATTRIBUTE_ENERGY"] = "Énergie" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_ENERGY"] = "Énergie Générée" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_MANA"] = "Mana Restaurée" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_RAGE"] = "Rage Générée" -- Needs review
-- L["STRING_ATTRIBUTE_ENERGY_RESOURCES"] = ""
L["STRING_ATTRIBUTE_ENERGY_RUNEPOWER"] = "Puissance Runique Générée" -- Needs review
L["STRING_ATTRIBUTE_HEAL"] = "Soin" -- Needs review
L["STRING_ATTRIBUTE_HEAL_DONE"] = "Soins Effectués" -- Needs review
L["STRING_ATTRIBUTE_HEAL_ENEMY"] = "Soins Prodigués (ennemis)" -- Needs review
L["STRING_ATTRIBUTE_HEAL_HPS"] = "HPS" -- Needs review
L["STRING_ATTRIBUTE_HEAL_OVERHEAL"] = "Excès de soin" -- Needs review
L["STRING_ATTRIBUTE_HEAL_PREVENT"] = "Dégâts Empêchés" -- Needs review
L["STRING_ATTRIBUTE_HEAL_TAKEN"] = "Soins Reçus" -- Needs review
L["STRING_ATTRIBUTE_MISC"] = "Divers" -- Needs review
L["STRING_ATTRIBUTE_MISC_BUFF_UPTIME"] = "Uptime des Buffs" -- Needs review
L["STRING_ATTRIBUTE_MISC_CCBREAK"] = "CC Cassés" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEAD"] = "Morts" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEBUFF_UPTIME"] = "Uptime des Débuffs" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEFENSIVE_COOLDOWNS"] = "Cooldowns" -- Needs review
L["STRING_ATTRIBUTE_MISC_DISPELL"] = "Dissipations" -- Needs review
L["STRING_ATTRIBUTE_MISC_INTERRUPT"] = "Interruptions" -- Needs review
-- L["STRING_ATTRIBUTE_MISC_RESS"] = ""
-- L["STRING_AUTO"] = ""
-- L["STRING_AUTOSHOT"] = ""
-- L["STRING_AVERAGE"] = ""
L["STRING_BLOCKED"] = "Bloqué" -- Needs review
L["STRING_BOTTOM"] = "bas" -- Needs review
-- L["STRING_BOTTOM_TO_TOP"] = ""
-- L["STRING_CAST"] = ""
-- L["STRING_CAUGHT"] = ""
L["STRING_CCBROKE"] = "CC Brisés" -- Needs review
L["STRING_CENTER"] = "centre" -- Needs review
-- L["STRING_CENTER_UPPER"] = ""
L["STRING_CHANGED_TO_CURRENT"] = "Segment changé: |cFFFFFF00Présent|r" -- Needs review
...
L["STRING_CLOSEALL"] = "Toutes les fenêtres de Details sont fermées. Tapez «/details show» pour rouvrir." -- Needs review
-- L["STRING_COLOR"] = ""
L["STRING_COMMAND_LIST"] = "liste de commande" -- Needs review
L["STRING_COOLTIP_NOOPTIONS"] = "aucune option" -- Needs review
L["STRING_CRITICAL_HITS"] = "Coups Critiques" -- Needs review
-- L["STRING_CRITICAL_ONLY"] = ""
L["STRING_CURRENT"] = "Présent" -- Needs review
L["STRING_CURRENTFIGHT"] = "Segment Présent" -- Needs review
...
L["STRING_CUSTOM_ATTRIBUTE_DAMAGE"] = "Dégâts" -- Needs review
L["STRING_CUSTOM_ATTRIBUTE_HEAL"] = "Soins" -- Needs review
L["STRING_CUSTOM_ATTRIBUTE_SCRIPT"] = "Script personalisé" -- Needs review
L["STRING_CUSTOM_AUTHOR"] = "Auteur:" -- Needs review
L["STRING_CUSTOM_AUTHOR_DESC"] = "La personne ayant créé cet affichage." -- Needs review
L["STRING_CUSTOM_CANCEL"] = "Annuler" -- Needs review
-- L["STRING_CUSTOM_CC_DONE"] = ""
-- L["STRING_CUSTOM_CC_RECEIVED"] = ""
L["STRING_CUSTOM_CREATE"] = "Créer" -- Needs review
L["STRING_CUSTOM_CREATED"] = "Nouvel affichage créé." -- Needs review
...
L["STRING_CUSTOM_DESCRIPTION"] = "Desc:" -- Needs review
L["STRING_CUSTOM_DESCRIPTION_DESC"] = "Description de ce qu'effectue cet affichage." -- Needs review
L["STRING_CUSTOM_DONE"] = "Terminé" -- Needs review
-- L["STRING_CUSTOM_DTBS"] = ""
-- L["STRING_CUSTOM_DTBS_DESC"] = ""
L["STRING_CUSTOM_EDIT"] = "Modifier" -- Needs review
L["STRING_CUSTOM_EDITCODE_DESC"] = "Ceci est une fonction avancée permettant à l'utilisateur de créer son propre code d'affichage." -- Needs review
L["STRING_CUSTOM_EDIT_SEARCH_CODE"] = "Modifier Code de Recherche." -- Needs review
L["STRING_CUSTOM_EDIT_TOOLTIP_CODE"] = "Modifier le Code du tooltip" -- Needs review
L["STRING_CUSTOM_EDITTOOLTIP_DESC"] = "Ceci est le code du tooltip, appelé lorsque l'utilisateur passe sur une barre." -- Needs review
L["STRING_CUSTOM_ENEMY_DT"] = "Dégâts Pris" -- Needs review
L["STRING_CUSTOM_EXPORT"] = "Exporter" -- Needs review
-- L["STRING_CUSTOM_FUNC_INVALID"] = ""
L["STRING_CUSTOM_HEALTHSTONE_DEFAULT"] = "Potions de Vie et Pierre" -- Needs review
L["STRING_CUSTOM_HEALTHSTONE_DEFAULT_DESC"] = "Affiche les membres de votre groupe de raid ayant utilisé une potion ou une pierre de vie." -- Needs review
L["STRING_CUSTOM_ICON"] = "Icône:" -- Needs review
L["STRING_CUSTOM_IMPORT"] = "Importer" -- Needs review
L["STRING_CUSTOM_IMPORT_ALERT"] = "Affichage chargé, pesez sur «Importer» pour confirmer." -- Needs review
L["STRING_CUSTOM_IMPORT_BUTTON"] = "Importer" -- Needs review
L["STRING_CUSTOM_IMPORTED"] = "Affichage importé avec succès." -- Needs review
L["STRING_CUSTOM_IMPORT_ERROR"] = "Échec de l'importation, string invalide." -- Needs review
L["STRING_CUSTOM_LONGNAME"] = "Ce nom est trop long, 32 caractères alloués." -- Needs review
-- L["STRING_CUSTOM_MYSPELLS"] = ""
-- L["STRING_CUSTOM_MYSPELLS_DESC"] = ""
L["STRING_CUSTOM_NAME"] = "Nom:" -- Needs review
L["STRING_CUSTOM_NAME_DESC"] = "Écrivez le nom de votre affichage personalisé." -- Needs review
L["STRING_CUSTOM_NEW"] = "Gestion des Affichages Personalisés" -- Needs review
L["STRING_CUSTOM_PASTE"] = "Coller Ici:" -- Needs review
L["STRING_CUSTOM_POT_DEFAULT"] = "Potion Utilisée" -- Needs review
L["STRING_CUSTOM_POT_DEFAULT_DESC"] = "Affiche qui, dans votre raid, a utilisé une potion lors de la rencontre." -- Needs review
L["STRING_CUSTOM_REMOVE"] = "Enlever" -- Needs review
L["STRING_CUSTOM_REPORT"] = "(personalisé)" -- Needs review
...
-- L["STRING_MEDIA"] = ""
-- L["STRING_MELEE"] = ""
L["STRING_MEMORY_ALERT_BUTTON"] = "J'ai compris" -- Needs review
L["STRING_MEMORY_ALERT_TEXT1"] = "Details! utilise beaucoup de mémoire, mais, |cFFFF8800contrairement à la croyance populaire|r, utilisation de la mémoire par extension |cFFFF8800n'a pas d'incidence|r en rien les performances du jeu ou de votre FPS." -- Needs review
L["STRING_MEMORY_ALERT_TEXT2"] = "Donc, si vous voyez Details! en utilisant beaucoup de mémoire, ne paniquez pas :D! |cFFFF8800Tout va bien|r, et une partie de cette mémoire est encore |cFFFF8800utilisé dans caches|r pour l'addon encore plus vite." -- Needs review
L["STRING_MEMORY_ALERT_TEXT3"] = "Toutefois, si votre souhait est de savoir |cFFFF8800addons qui sont plus 'lourd'|r ou qui sont en baisse plus vos FPS, installer l'addon: '|cFFFFFF00AddOns Cpu Usage|r'." -- Needs review
L["STRING_MEMORY_ALERT_TITLE"] = "S'il vous plaît lire attentivement!" -- Needs review
...
L["STRING_MINITUTORIAL_BOOKMARK1"] = "Faites un clic droit à tout moment au cours de la fenêtre pour ouvrir les signets!" -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK2"] = "Signets donne un accès rapide aux écrans favoris." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK3"] = "cliquez à droite pour fermer le panneau de signets." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK4"] = "Ne montre plus cela." -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL1"] = "|cFFFFFF00Ctrl + Clic droit |r ferme la fenêtre!" -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL2"] = "Si vous voulez rouvrir, aller à fenêtre Contrôle aucun menu Mode ou panneau Options." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL1"] = "Quels fenêtre est en cours de modification." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL2"] = "Quand elle est cochée, toutes les fenêtres dans le groupe sont également modifiés." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL3"] = [=[Pour créer une fenêtre groupe, faites glisser # 2, près de la fenêtre # 1.

Casser un groupe cliquant sur le bouton de dissocier.]=] -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Testez vos configuration créant des barreaux d'essai." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL5"] = "Lorsque Groupe Édition est activé, toutes les fenêtres dans un groupe sont modifiés." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Sélectionnez ici quelle fenêtre vous voulez changer l'apparence." -- Needs review
