...
L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Daño de Enemigos Recibido" -- Needs review
...
L["STRING_MINITUTORIAL_BOOKMARK1"] = "¡Haga clic derecho en cualquier lugar de la ventana para abrir los marcadores!" -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK2"] = "Marcadores da acceso rápido a pantallas favoritas." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK3"] = "Haga clic derecho para cerrar el panel de marcadores." -- Needs review
...
L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Pon a prueba tu configuración creando barras de prueba." -- Needs review
...
L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Seleccione aquí de qué ventana desea cambiar la apariencia." -- Needs review
