...
L["STRING_ACTORFRAME_NOTHING"] = "Нечего включить в отчет" -- Needs review
L["STRING_ACTORFRAME_REPORTAT"] = "на" -- Needs review
L["STRING_ACTORFRAME_REPORTOF"] = "из" -- Needs review
L["STRING_ACTORFRAME_REPORTTARGETS"] = "отчет для целей из" -- Needs review
L["STRING_ACTORFRAME_REPORTTO"] = "отчет для"
L["STRING_ACTORFRAME_SPELLDETAILS"] = "Подробнее о заклинании" -- Needs review
...
-- L["STRING_ALPHA"] = ""
L["STRING_ANCHOR_BOTTOM"] = "Снизу" -- Needs review
L["STRING_ANCHOR_BOTTOMLEFT"] = "Снизу Слева" -- Needs review
L["STRING_ANCHOR_BOTTOMRIGHT"] = "Снизу Справа" -- Needs review
L["STRING_ANCHOR_LEFT"] = "Слева" -- Needs review
L["STRING_ANCHOR_RIGHT"] = "Справа" -- Needs review
L["STRING_ANCHOR_TOP"] = "Сверху" -- Needs review
L["STRING_ANCHOR_TOPLEFT"] = "Сверху Слева" -- Needs review
L["STRING_ANCHOR_TOPRIGHT"] = "Сверху Справа" -- Needs review
-- L["STRING_ASCENDING"] = ""
...
L["STRING_ATTRIBUTE_DAMAGE_DONE"] = "Нанесенный урон" -- Needs review
L["STRING_ATTRIBUTE_DAMAGE_DPS"] = "УВС"
L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Получено урона врагом" -- Needs review
...
L["STRING_ATTRIBUTE_DAMAGE_TAKEN"] = "Получено урона" -- Needs review
L["STRING_ATTRIBUTE_ENERGY"] = "Энергия" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_ENERGY"] = "Энергии получено" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_MANA"] = "Восстановлено маны" -- Needs review
L["STRING_ATTRIBUTE_ENERGY_RAGE"] = "Ярости Получено" -- Needs review
-- L["STRING_ATTRIBUTE_ENERGY_RESOURCES"] = ""
L["STRING_ATTRIBUTE_ENERGY_RUNEPOWER"] = "Получено Силы Рун"
L["STRING_ATTRIBUTE_HEAL"] = "Исцеление" -- Needs review
L["STRING_ATTRIBUTE_HEAL_DONE"] = "Исцеление" -- Needs review
L["STRING_ATTRIBUTE_HEAL_ENEMY"] = "Произведено исцеления врагом" -- Needs review
L["STRING_ATTRIBUTE_HEAL_HPS"] = "ИВС" -- Needs review
L["STRING_ATTRIBUTE_HEAL_OVERHEAL"] = "Излишнее Исцеление" -- Needs review
L["STRING_ATTRIBUTE_HEAL_PREVENT"] = "Предотвращенный Урон" -- Needs review
L["STRING_ATTRIBUTE_HEAL_TAKEN"] = "Исцеления Получено" -- Needs review
L["STRING_ATTRIBUTE_MISC"] = "Разное" -- Needs review
L["STRING_ATTRIBUTE_MISC_BUFF_UPTIME"] = "Время Действия Баффов" -- Needs review
L["STRING_ATTRIBUTE_MISC_CCBREAK"] = "СС Прерывания" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEAD"] = "Смерти" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEBUFF_UPTIME"] = "Время Действия Дебаффов" -- Needs review
L["STRING_ATTRIBUTE_MISC_DEFENSIVE_COOLDOWNS"] = "Откаты" -- Needs review
L["STRING_ATTRIBUTE_MISC_DISPELL"] = "Рассеивания" -- Needs review
L["STRING_ATTRIBUTE_MISC_INTERRUPT"] = "Прерывания" -- Needs review
L["STRING_ATTRIBUTE_MISC_RESS"] = "Воскрешения" -- Needs review
L["STRING_AUTO"] = "авто" -- Needs review
L["STRING_AUTOSHOT"] = "Авто-Атака" -- Needs review
-- L["STRING_AVERAGE"] = ""
L["STRING_BLOCKED"] = "Заблокированно" -- Needs review
L["STRING_BOTTOM"] = "Снизу" -- Needs review
-- L["STRING_BOTTOM_TO_TOP"] = ""
-- L["STRING_CAST"] = ""
-- L["STRING_CAUGHT"] = ""
L["STRING_CCBROKE"] = "Спадение Контроля" -- Needs review
L["STRING_CENTER"] = "центр" -- Needs review
-- L["STRING_CENTER_UPPER"] = ""
L["STRING_CHANGED_TO_CURRENT"] = "Сегмент изменен на текущий" -- Needs review
...
L["STRING_CLOSEALL"] = "Все окна аддона закрыты. Напечатайте '/details new' для переоткрытия." -- Needs review
-- L["STRING_COLOR"] = ""
L["STRING_COMMAND_LIST"] = "список команд" -- Needs review
L["STRING_COOLTIP_NOOPTIONS"] = "нет опций" -- Needs review
L["STRING_CRITICAL_HITS"] = "Критические попадания" -- Needs review
-- L["STRING_CRITICAL_ONLY"] = ""
L["STRING_CURRENT"] = "Текущий" -- Needs review
L["STRING_CURRENTFIGHT"] = "Текущий бой" -- Needs review
L["STRING_CUSTOM_ACTIVITY_ALL"] = "Время Активности" -- Needs review
L["STRING_CUSTOM_ACTIVITY_ALL_DESC"] = "Показывает время активности каждого в рейде." -- Needs review
...
L["STRING_CUSTOM_ATTRIBUTE_DAMAGE"] = "Урон" -- Needs review
L["STRING_CUSTOM_ATTRIBUTE_HEAL"] = "Исцеление" -- Needs review
L["STRING_CUSTOM_ATTRIBUTE_SCRIPT"] = "Пользовательский скрипт" -- Needs review
L["STRING_CUSTOM_AUTHOR"] = "Автор:" -- Needs review
L["STRING_CUSTOM_AUTHOR_DESC"] = "Кто создал это отображение." -- Needs review
L["STRING_CUSTOM_CANCEL"] = "Отменить" -- Needs review
-- L["STRING_CUSTOM_CC_DONE"] = ""
-- L["STRING_CUSTOM_CC_RECEIVED"] = ""
L["STRING_CUSTOM_CREATE"] = "Создать" -- Needs review
L["STRING_CUSTOM_CREATED"] = "Новое отображение создано" -- Needs review
...
L["STRING_CUSTOM_DESCRIPTION"] = "Описание:" -- Needs review
L["STRING_CUSTOM_DESCRIPTION_DESC"] = "Описание того, что делает данное отображение" -- Needs review
L["STRING_CUSTOM_DONE"] = "Готово" -- Needs review
-- L["STRING_CUSTOM_DTBS"] = ""
-- L["STRING_CUSTOM_DTBS_DESC"] = ""
L["STRING_CUSTOM_EDIT"] = "Редактировать" -- Needs review
L["STRING_CUSTOM_EDITCODE_DESC"] = "Это специальная функция, позволяющая пользователю создавать свой код отображения." -- Needs review
L["STRING_CUSTOM_EDIT_SEARCH_CODE"] = "Изменить код поиска" -- Needs review
L["STRING_CUSTOM_EDIT_TOOLTIP_CODE"] = "Редактировать код тултипа" -- Needs review
L["STRING_CUSTOM_EDITTOOLTIP_DESC"] = "Этот код исполняется после наведения на строку в этом отображении." -- Needs review
L["STRING_CUSTOM_ENEMY_DT"] = "Получено урона" -- Needs review
L["STRING_CUSTOM_EXPORT"] = "Экспортировать" -- Needs review
-- L["STRING_CUSTOM_FUNC_INVALID"] = ""
L["STRING_CUSTOM_HEALTHSTONE_DEFAULT"] = "Использован камень возвращения" -- Needs review
L["STRING_CUSTOM_HEALTHSTONE_DEFAULT_DESC"] = "Показать игроков из рейда, кто использовал камень возвращения" -- Needs review
L["STRING_CUSTOM_ICON"] = "Иконка:" -- Needs review
L["STRING_CUSTOM_IMPORT"] = "Импортировать" -- Needs review
L["STRING_CUSTOM_IMPORT_ALERT"] = "Отображение загружено - нажмите Импортировать для подтверждения" -- Needs review
L["STRING_CUSTOM_IMPORT_BUTTON"] = "Импортировать" -- Needs review
L["STRING_CUSTOM_IMPORTED"] = "Это отображение успешно импортировано" -- Needs review
L["STRING_CUSTOM_IMPORT_ERROR"] = "Импорт не удался - неверная строка" -- Needs review
L["STRING_CUSTOM_LONGNAME"] = "Слишком длинное название - максимум 32 символа" -- Needs review
-- L["STRING_CUSTOM_MYSPELLS"] = ""
-- L["STRING_CUSTOM_MYSPELLS_DESC"] = ""
L["STRING_CUSTOM_NAME"] = "Название:" -- Needs review
L["STRING_CUSTOM_NAME_DESC"] = "Введите название для Вашего нового отображения." -- Needs review
L["STRING_CUSTOM_NEW"] = "Управлять пользовательскими отображениями" -- Needs review
L["STRING_CUSTOM_PASTE"] = "Вставить здесь:" -- Needs review
L["STRING_CUSTOM_POT_DEFAULT"] = "Использовано зелий" -- Needs review
L["STRING_CUSTOM_POT_DEFAULT_DESC"] = "Показать, кто из рейда использовал зелья во время боя" -- Needs review
L["STRING_CUSTOM_REMOVE"] = "Удалить" -- Needs review
L["STRING_CUSTOM_REPORT"] = "(пользовательский)" -- Needs review
...
-- L["STRING_MEDIA"] = ""
-- L["STRING_MELEE"] = ""
L["STRING_MEMORY_ALERT_BUTTON"] = "Я понял" -- Needs review
L["STRING_MEMORY_ALERT_TEXT1"] = "Details! использует очень много памяти, |cFFFF8800вопреки распространенному мнению|r, использование памати аддоном |cFFFF8800не влияет|r на производительность игры или FPS." -- Needs review
L["STRING_MEMORY_ALERT_TEXT2"] = "Если вы видите, что Details! использует очень много памяти, не паникуйте :D - |cFFFF8800все впорядке!|r. Часть этой памяти |cFFFF8800используется в кэше|r, чтобы сделать аддон еще быстрее!" -- Needs review
L["STRING_MEMORY_ALERT_TEXT3"] = "Однако, если вы хотите узнать, |cFFFF8800какой аддон самый 'тяжелый'|r, или какие уменьшают ваш FPS больше всего, установите аддон:'|cFFFFFF00AddOns Cpu Usage|r'." -- Needs review
L["STRING_MEMORY_ALERT_TITLE"] = "Внимательно прочитайте!" -- Needs review
...
L["STRING_MINITUTORIAL_BOOKMARK1"] = "Щелкните правой кнопкой мыши в любой точке над окном, чтобы открыть закладки!" -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK2"] = "Закладки дает быстрый доступ к любимым дисплеев." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK3"] = "щелкните правой кнопкой мыши, чтобы закрыть закладку панели." -- Needs review
L["STRING_MINITUTORIAL_BOOKMARK4"] = "Не показывай это снова." -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL1"] = "|cFFFFFF00Ctrl + Right Click |r закрывает окно!" -- Needs review
L["STRING_MINITUTORIAL_CLOSECTRL2"] = "Если вы хотите открыть его, перейдите в окно ДУ нет меню Mode или опции панель." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL1"] = "Какие окна редактирования." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL2"] = "Когда проверили, все окна в группе также будут изменены." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL3"] = [=[Чтобы создать группу, перетащите окно # 2 возле окна # 1.

Перерыв группы, нажав на кнопку разгруппировать.]=] -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL4"] = "Проверьте свои настройки создания тестовых баров." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL5"] = "Когда Редактирование Группа включена, все окна в группе изменилось." -- Needs review
L["STRING_MINITUTORIAL_OPTIONS_PANEL6"] = "Выберите здесь, какое окно вы хотите изменить внешний вид." -- Needs review
...
L["STRING_OPTIONS_TEXT"] = "Настройки Заголовка" -- Needs review
