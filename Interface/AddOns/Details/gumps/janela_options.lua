...
function window:CreateFrame1()
	...
	--> numerical system
		...
		local numeralSystems = {
			...
			{value = 2, label = Loc ["STRING_NUMERALSYSTEM_MYRIAD_EASTASIA"], desc = "1ì²œ = 1.000 \n1ë§Œ = 10.000 \n10ë§Œ = 100.000 \n100ë§Œ = 1.000.000", onclick = onSelectNumeralSystem, icon = icon, iconcolor = iconcolor, iconsize = iconsize},
		}
