...
--> global name declaration
		...
		_detalhes.build_counter = 2961
		_detalhes.userversion = "v7.0.3." .. _detalhes.build_counter
		_detalhes.realversion = 113 --core version
