...
L["Use: "] = "Utilizar: "
L["Spell:"] = "Hechizo:"
L["|cFFFF00FFPernametly blacklisted items:"] = "|cFFFF00FFObjetos Añadidos de forma permante a la lista negra:"
L["|cFFFF00FFPernament blacklist is empty"] = "|cFFFF00FFLa lista negra esta vacía"
L["Pernamently Blacklisted:|cFF00FF00"] = "Añadidos a la lista negra permanentemente:|cFF00FF00"
...
L["Reset pernament blacklist."] = "Reinicia la lista negra"
...
L["Swap"] = "Swap"
L["Swap location of numbers for count and cooldown timer"] = "Swap location of numbers for count and cooldown timer"
L["Script"] = "Script"
L["Let button on use close unwanted windows like NPC trader, bank etc. You need enable custom scripts to run!"] = "Let button on use close unwanted windows like NPC trader, bank etc. You need enable custom scripts to run!"
...
L["Above or bellow last one"] = "Encima o debajo de la última"
