...
L["Use: "] = "使用:"
L["Spell:"] = "施法:"
L["|cFFFF00FFPernametly blacklisted items:"] = "|cFFFF00FF永遠黑名單物品:"
L["|cFFFF00FFPernament blacklist is empty"] = "|cFFFF00FF永遠黑名單是空的"
L["Pernamently Blacklisted:|cFF00FF00"] = "永遠黑名單:|cFF00FF00"
...
L["Reset pernament blacklist."] = "重置永遠黑名單。"
L["Zone unlock"] = "區域解鎖"
...
L["Right"] = "右"
L["Add new row"] = "增加新行"
L["Above or bellow last one"] = "最後一個以上或以下"
L["Hot-Key"] = "熱鍵"
