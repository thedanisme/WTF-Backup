...
L["Use: "] = "使用:"
L["Spell:"] = "施法:"
L["|cFFFF00FFPernametly blacklisted items:"] = "|cFFFF00FF永久黑名单物品:"
L["|cFFFF00FFPernament blacklist is empty"] = "|cFFFF00FF永久黑名单是空的"
L["Pernamently Blacklisted:|cFF00FF00"] = "永久黑名单:|cFF00FF00"
...
L["Reset pernament blacklist."] = "重置永久黑名单。"
L["Zone unlock"] = "区域解锁"
...
L["Right"] = "右"
L["Add new row"] = "增加新行"
L["Above or bellow last one"] = "最后一个以上或以下"
L["Hot-Key"] = "快捷键"
