...
L["Fade"] = "Verblassen"
L["Fade In"] = "Einblenden" -- Needs review
L["Fade Out"] = "Ausblenden" -- Needs review
...
L["Shows a spell icon with an optional cooldown overlay"] = "Zeigt ein Zauber Symbol mit optionaler Abklingzeit-Anzeige."
