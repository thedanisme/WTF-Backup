	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Shhbbyisok|Stormrage|Alliance|110|DEATHKNIGHT", -- [26]
		...
		["Emmarosa - Stormrage"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Druidann|Stormrage|Alliance", -- [3]
					"Gavrey|Stormrage|Alliance", -- [4]
					"Malversion-Stormrage|Stormrage|Alliance", -- [5]
					"Cereastor|Stormrage|Alliance", -- [6]
					"Youngma|Stormrage|Alliance", -- [7]
					"Dhaniel|Stormrage|Alliance", -- [8]
					"Primalsfury|Stormrage|Alliance", -- [9]
					"Paulaira|Stormrage|Alliance", -- [10]
					"Shaneequa-Turalyon|Stormrage|Alliance", -- [11]
					"Lackteight-Turalyon|Stormrage|Alliance", -- [12]
					"Dosnutz|Stormrage|Alliance", -- [13]
					"Talthalador|Stormrage|Alliance", -- [14]
					"Danoh|Stormrage|Alliance", -- [15]
					"Dalban|Stormrage|Alliance", -- [16]
				},
			},
		},
		["Druidann - Stormrage"] = {
