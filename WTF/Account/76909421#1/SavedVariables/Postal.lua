	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Shamadan|Stormrage|Neutral|1|SHAMAN", -- [24]
				"Shaneequa|Turalyon|Horde|100|SHAMAN", -- [25]
				"Shhbbyisok|Stormrage|Alliance|100|DEATHKNIGHT", -- [26]
		...
		["Emmarosa - Stormrage"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Gavrey|Stormrage|Alliance", -- [2]
					"Malversion-Stormrage|Stormrage|Alliance", -- [3]
					"Cereastor|Stormrage|Alliance", -- [4]
					"Youngma|Stormrage|Alliance", -- [5]
					"Dhaniel|Stormrage|Alliance", -- [6]
					"Primalsfury|Stormrage|Alliance", -- [7]
					"Paulaira|Stormrage|Alliance", -- [8]
					"Shaneequa-Turalyon|Stormrage|Alliance", -- [9]
					"Lackteight-Turalyon|Stormrage|Alliance", -- [10]
					"Dosnutz|Stormrage|Alliance", -- [11]
					"Shhbbyisok|Stormrage|Alliance", -- [12]
					"Talthalador|Stormrage|Alliance", -- [13]
					"Danoh|Stormrage|Alliance", -- [14]
					"Dalban|Stormrage|Alliance", -- [15]
				},
			},
		},
		["Druidann - Stormrage"] = {
