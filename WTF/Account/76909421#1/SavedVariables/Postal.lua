		...
		["Emmarosa - Stormrage"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Oenta|Stormrage|Alliance", -- [2]
					"Shhbbyisok|Stormrage|Alliance", -- [3]
					"Malversion|Stormrage|Alliance", -- [4]
					"Gavrey|Stormrage|Alliance", -- [5]
					"Malversion-Stormrage|Stormrage|Alliance", -- [6]
					"Cereastor|Stormrage|Alliance", -- [7]
					"Youngma|Stormrage|Alliance", -- [8]
					"Dhaniel|Stormrage|Alliance", -- [9]
					"Primalsfury|Stormrage|Alliance", -- [10]
					"Paulaira|Stormrage|Alliance", -- [11]
					"Shaneequa-Turalyon|Stormrage|Alliance", -- [12]
					"Lackteight-Turalyon|Stormrage|Alliance", -- [13]
