	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				...
				"Emmarosa|Stormrage|Alliance|109|ROGUE", -- [14]
		...
		["Emmarosa - Stormrage"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Malversion-Stormrage|Stormrage|Alliance", -- [2]
					"Cereastor|Stormrage|Alliance", -- [3]
					"Youngma|Stormrage|Alliance", -- [4]
					"Dhaniel|Stormrage|Alliance", -- [5]
					"Primalsfury|Stormrage|Alliance", -- [6]
					"Paulaira|Stormrage|Alliance", -- [7]
					"Shaneequa-Turalyon|Stormrage|Alliance", -- [8]
					"Lackteight-Turalyon|Stormrage|Alliance", -- [9]
					"Dosnutz|Stormrage|Alliance", -- [10]
					"Shhbbyisok|Stormrage|Alliance", -- [11]
					"Talthalador|Stormrage|Alliance", -- [12]
					"Danoh|Stormrage|Alliance", -- [13]
					"Dalban|Stormrage|Alliance", -- [14]
				},
			},
		},
		["Druidann - Stormrage"] = {
